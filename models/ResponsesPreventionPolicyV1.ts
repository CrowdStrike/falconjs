...
import {
    ...
    ResponsesIOARuleGroupV1FromJSON,
    ResponsesIOARuleGroupV1FromJSONTyped,
    ResponsesIOARuleGroupV1ToJSON,
} from './ResponsesIOARuleGroupV1';
import {
...
* @enum {string}
*/
export enum ResponsesPreventionPolicyV1PlatformNameEnum {
    Windows = 'Windows',
    Mac = 'Mac',
    Linux = 'Linux'
}
