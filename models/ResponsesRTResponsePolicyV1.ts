...
import {
    ...
    ResponsesPreventionCategoryV1FromJSON,
    ResponsesPreventionCategoryV1FromJSONTyped,
    ResponsesPreventionCategoryV1ToJSON,
} from './ResponsesPreventionCategoryV1';

/**
 * A fully formed RTR policy
 * @export
 * @interface ResponsesRTResponsePolicyV1
 */
export interface ResponsesRTResponsePolicyV1 {
    /**
     * The email of the user which created the policy
     * @type {string}
     * @memberof ResponsesRTResponsePolicyV1
     */
    createdBy: string;
    /**
     ...
     * @memberof ResponsesRTResponsePolicyV1
     */
    platformName: ResponsesRTResponsePolicyV1PlatformNameEnum;
    /**
     * A category of settings in a RTR policy
     * @type {Array<ResponsesPreventionCategoryV1>}
     * @memberof ResponsesRTResponsePolicyV1
     */
    settings: Array<ResponsesPreventionCategoryV1>;
}
...
* @enum {string}
*/
export enum ResponsesRTResponsePolicyV1PlatformNameEnum {
    Windows = 'Windows',
    Mac = 'Mac',
    Linux = 'Linux'
}
...
export function ResponsesRTResponsePolicyV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponsesRTResponsePolicyV1 {
    ...
    return {
        ...
        'settings': ((json['settings'] as Array<any>).map(ResponsesPreventionCategoryV1FromJSON)),
    };
}

export function ResponsesRTResponsePolicyV1ToJSON(value?: ResponsesRTResponsePolicyV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'settings': ((value.settings as Array<any>).map(ResponsesPreventionCategoryV1ToJSON)),
    };
}
