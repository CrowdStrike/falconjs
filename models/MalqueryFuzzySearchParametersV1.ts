...
import {
    ...
    MalqueryFuzzyOptionsFromJSON,
    MalqueryFuzzyOptionsFromJSONTyped,
    MalqueryFuzzyOptionsToJSON,
} from './MalqueryFuzzyOptions';
import {
...
export function MalqueryFuzzySearchParametersV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): MalqueryFuzzySearchParametersV1 {
    ...
    return {
        ...
        'options': !exists(json, 'options') ? undefined : MalqueryFuzzyOptionsFromJSON(json['options']),
