...
export function ApiPaginationMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiPaginationMeta {
...
export function ApiPaginationMetaToJSON(value?: ApiPaginationMeta | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
