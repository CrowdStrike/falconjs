...
export class ContainerDetectionsApi extends runtime.BaseAPI {
     ...
     */
    async readCombinedDetectionsRaw(requestParameters: ReadCombinedDetectionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DetectionsApiCombinedDetections>> {
     ...
     * Retrieve image assessment detections identified by the provided filter criteria
     */
    async readCombinedDetections(filter?: string, limit?: number, offset?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DetectionsApiCombinedDetections> {
     ...
     */
    async readDetectionsCountRaw(requestParameters: ReadDetectionsCountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DetectionsApiDetectionsCount>> {
        const queryParameters: any = {};
     ...
     */
    async readDetectionsCountBySeverityRaw(requestParameters: ReadDetectionsCountBySeverityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DetectionsApiDetectionsBySeverity>> {
        const queryParameters: any = {};
     ...
     */
    async readDetectionsCountByTypeRaw(requestParameters: ReadDetectionsCountByTypeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DetectionsApiDetectionsByType>> {
        const queryParameters: any = {};
