...
export class SampleUploadsApi extends runtime.BaseAPI {
    ...
    async archiveDeleteV1Raw(requestParameters: ArchiveDeleteV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling archiveDeleteV1().'
            );
        }
    ...
    async archiveGetV1Raw(requestParameters: ArchiveGetV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientArchiveCreateResponseV1>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling archiveGetV1().'
            );
        }
    ...
    async archiveListV1Raw(requestParameters: ArchiveListV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientArchiveListFilesResponseV1>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling archiveListV1().'
            );
        }
    ...
    async archiveUploadV1Raw(requestParameters: ArchiveUploadV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientArchiveCreateResponseV1>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling archiveUploadV1().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling archiveUploadV1().'
            );
        }
     ...
     * @deprecated
     */
    async archiveUploadV1(name: string, body: Array<number>, password?: string, isConfidential?: boolean, comment?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ClientArchiveCreateResponseV1> {
    ...
    async archiveUploadV2Raw(requestParameters: ArchiveUploadV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientArchiveCreateResponseV1>> {
        if (requestParameters['file'] == null) {
            throw new runtime.RequiredError(
                'file',
                'Required parameter "file" was null or undefined when calling archiveUploadV2().'
            );
        }
        ...
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling archiveUploadV2().'
            );
        }
     ...
     * Uploads an archive and extracts files list from it. Operation is asynchronous use `/archives/entities/archives/v1` to check the status. After uploading, use `/archives/entities/extractions/v1` to copy the file to internal storage making it available for content analysis.
     */
    async archiveUploadV2(file: Blob, name: string, password?: string, isConfidential?: boolean, comment?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ClientArchiveCreateResponseV1> {
    ...
    async deleteSampleV3Raw(requestParameters: DeleteSampleV3Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling deleteSampleV3().'
            );
        }
     ...
     */
    async extractionCreateV1Raw(requestParameters: ExtractionCreateV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientExtractionCreateResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling extractionCreateV1().'
            );
        }
    ...
    async extractionGetV1Raw(requestParameters: ExtractionGetV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientExtractionCreateResponseV1>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling extractionGetV1().'
            );
        }
     ...
     */
    async extractionListV1Raw(requestParameters: ExtractionListV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientExtractionListFilesResponseV1>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling extractionListV1().'
            );
        }
    ...
    async getSampleV3Raw(requestParameters: GetSampleV3Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getSampleV3().'
            );
        }
    ...
    async uploadSampleV3Raw(requestParameters: UploadSampleV3Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientSampleMetadataResponseV2>> {
        if (requestParameters['sample'] == null) {
            throw new runtime.RequiredError(
                'sample',
                'Required parameter "sample" was null or undefined when calling uploadSampleV3().'
            );
        }
        ...
        if (requestParameters['fileName'] == null) {
            throw new runtime.RequiredError(
                'fileName',
                'Required parameter "fileName" was null or undefined when calling uploadSampleV3().'
            );
        }
     ...
     * Upload a file for further cloud analysis. After uploading, call the specific analysis API endpoint.
     */
    async uploadSampleV3(sample: Blob, fileName: string, comment?: string, isConfidential?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ClientSampleMetadataResponseV2> {
