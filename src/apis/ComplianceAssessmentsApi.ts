...
export interface ComplianceAssessmentsApiExtAggregateClusterAssessmentsRequest {
    filter?: string;
}

export interface ComplianceAssessmentsApiExtAggregateFailedContainersByRulesPathRequest {
    filter?: string;
}

export interface ComplianceAssessmentsApiExtAggregateFailedContainersCountBySeverityRequest {
    filter?: string;
}

export interface ComplianceAssessmentsApiExtAggregateFailedImagesByRulesPathRequest {
    filter?: string;
}

export interface ComplianceAssessmentsApiExtAggregateFailedImagesCountBySeverityRequest {
    filter?: string;
}

export interface ComplianceAssessmentsApiExtAggregateFailedRulesByClustersRequest {
    filter?: string;
}

export interface ComplianceAssessmentsApiExtAggregateFailedRulesByImagesRequest {
    filter?: string;
}

export interface ComplianceAssessmentsApiExtAggregateFailedRulesCountBySeverityRequest {
    filter?: string;
}

export interface ComplianceAssessmentsApiExtAggregateImageAssessmentsRequest {
    filter?: string;
    after?: string;
    limit?: string;
}

export interface ComplianceAssessmentsApiExtAggregateRulesAssessmentsRequest {
    filter?: string;
}

export interface ComplianceAssessmentsApiExtAggregateRulesByStatusRequest {
    filter?: string;
}
