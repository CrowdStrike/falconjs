...
export class SensorVisibilityExclusionsApi extends runtime.BaseAPI {
     ...
     */
    async createSVExclusionsV1Raw(requestParameters: CreateSVExclusionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExclusionsRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createSVExclusionsV1().'
            );
        }
     ...
     */
    async deleteSensorVisibilityExclusionsV1Raw(requestParameters: DeleteSensorVisibilityExclusionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling deleteSensorVisibilityExclusionsV1().'
            );
        }
     ...
     */
    async getSensorVisibilityExclusionsV1Raw(requestParameters: GetSensorVisibilityExclusionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SvExclusionsRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getSensorVisibilityExclusionsV1().'
            );
        }
     ...
     */
    async querySensorVisibilityExclusionsV1Raw(requestParameters: QuerySensorVisibilityExclusionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Search for sensor visibility exclusions.
     */
    async querySensorVisibilityExclusionsV1(filter?: string, offset?: number, limit?: number, sort?: QuerySensorVisibilityExclusionsV1SortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async updateSensorVisibilityExclusionsV1Raw(requestParameters: UpdateSensorVisibilityExclusionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SvExclusionsRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateSensorVisibilityExclusionsV1().'
            );
        }
