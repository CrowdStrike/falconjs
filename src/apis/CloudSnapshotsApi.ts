...
export interface CreateDeploymentEntityRequest {
...
export interface ReadDeploymentsCombinedRequest {
    filter?: string;
    limit?: number;
    offset?: number;
    sort?: string;
...
export interface ReadDeploymentsEntitiesRequest {
    ids?: Array<string>;
}
...
export class CloudSnapshotsApi extends runtime.BaseAPI {
     ...
     */
    async createDeploymentEntityRaw(requestParameters: CreateDeploymentEntityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeploymentsEntityResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createDeploymentEntity().'
            );
        }
     ...
     */
    async getScanReportRaw(requestParameters: GetScanReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScanreportsEntitiesResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getScanReport().'
            );
        }
     ...
     */
    async readDeploymentsCombinedRaw(requestParameters: ReadDeploymentsCombinedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeploymentsEntityResponse>> {
        const queryParameters: any = {};
     ...
     * Retrieve snapshot jobs identified by the provided IDs
     */
    async readDeploymentsEntitiesRaw(requestParameters: ReadDeploymentsEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeploymentsEntityResponse>> {
        const queryParameters: any = {};
     ...
     */
    async registerRaw(requestParameters: RegisterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsAccountStatusResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
