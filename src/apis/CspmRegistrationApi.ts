...
export interface ConnectCSPMGCPAccountRequest {
...
export interface CreateCSPMAzureManagementGroupRequest {
...
export interface DeleteCSPMAzureManagementGroupRequest {
    tenantIds?: Array<string>;
}

export interface DeleteCSPMGCPAccountRequest {
    ids?: Array<string>;
}
...
export interface GetCSPMAzureManagementGroupRequest {
    tenantIds?: Array<string>;
    limit?: number;
    offset?: number;
}
...
export interface GetCSPMGCPServiceAccountsExtRequest {
    id?: string;
}

export interface GetCSPMGCPUserScriptsAttachmentRequest {
    parentType?: GetCSPMGCPUserScriptsAttachmentParentTypeEnum;
    ids?: Array<string>;
}

export interface GetCSPMGCPValidateAccountsExtRequest {
...
export interface UpdateCSPMAzureAccountRequest {
...
export interface UpdateCSPMGCPAccountRequest {
    body: RegistrationGCPAccountPatchRequestV1;
}

export interface UpdateCSPMGCPServiceAccountsExtRequest {
...
export interface ValidateCSPMGCPServiceAccountExtRequest {
...
export class CspmRegistrationApi extends runtime.BaseAPI {
     ...
     */
    async azureDownloadCertificateRaw(requestParameters: AzureDownloadCertificateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureDownloadCertificateResponseV1>> {
        if (requestParameters['tenantId'] == null) {
            throw new runtime.RequiredError(
                'tenantId',
                'Required parameter "tenantId" was null or undefined when calling azureDownloadCertificate().'
            );
        }
     ...
     * Returns JSON object(s) that contain the base64 encoded certificate for a service principal.
     */
    async azureDownloadCertificate(tenantId: Array<string>, refresh?: boolean, yearsValid?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureDownloadCertificateResponseV1> {
     ...
     */
    async connectCSPMGCPAccountRaw(requestParameters: ConnectCSPMGCPAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPAccountResponseExtV2>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling connectCSPMGCPAccount().'
            );
        }
     ...
     */
    async createCSPMAwsAccountRaw(requestParameters: CreateCSPMAwsAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAWSAccountResponseV2>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createCSPMAwsAccount().'
            );
        }
     ...
     */
    async createCSPMAzureAccountRaw(requestParameters: CreateCSPMAzureAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureAccountResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createCSPMAzureAccount().'
            );
        }
     ...
     */
    async createCSPMAzureManagementGroupRaw(requestParameters: CreateCSPMAzureManagementGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureAccountResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createCSPMAzureManagementGroup().'
            );
        }
     ...
     * Creates a new management group in our system for a customer.
     */
    async createCSPMAzureManagementGroup(body: RegistrationAzureManagementGroupCreateRequestExternalV1, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureAccountResponseV1> {
     ...
     */
    async createCSPMGCPAccountRaw(requestParameters: CreateCSPMGCPAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPAccountResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createCSPMGCPAccount().'
            );
        }
     ...
     */
    async deleteCSPMAzureAccountRaw(requestParameters: DeleteCSPMAzureAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaBaseEntitiesResponse>> {
        const queryParameters: any = {};
     ...
     */
    async deleteCSPMAzureManagementGroupRaw(requestParameters: DeleteCSPMAzureManagementGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecResponseFields>> {
        const queryParameters: any = {};
     ...
     */
    async deleteCSPMGCPAccountRaw(requestParameters: DeleteCSPMGCPAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaBaseEntitiesResponse>> {
        const queryParameters: any = {};
     ...
     */
    async getBehaviorDetectionsRaw(requestParameters: GetBehaviorDetectionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationExternalIOAEventResponse>> {
        const queryParameters: any = {};
     ...
     * Get list of detected behaviors
     */
    async getBehaviorDetections(cloudProvider?: GetBehaviorDetectionsCloudProviderEnum, service?: GetBehaviorDetectionsServiceEnum, accountId?: string, awsAccountId?: string, azureSubscriptionId?: string, azureTenantId?: string, state?: GetBehaviorDetectionsStateEnum, dateTimeSince?: string, since?: string, severity?: GetBehaviorDetectionsSeverityEnum, nextToken?: string, limit?: number, resourceId?: Array<string>, resourceUuid?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationExternalIOAEventResponse> {
        const response = await this.getBehaviorDetectionsRaw({ cloudProvider: cloudProvider, service: service, accountId: accountId, awsAccountId: awsAccountId, azureSubscriptionId: azureSubscriptionId, azureTenantId: azureTenantId, state: state, dateTimeSince: dateTimeSince, since: since, severity: severity, nextToken: nextToken, limit: limit, resourceId: resourceId, resourceUuid: resourceUuid }, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCSPMAwsAccountRaw(requestParameters: GetCSPMAwsAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAWSAccountResponseV2>> {
        const queryParameters: any = {};
     ...
     * Returns information about the current status of an AWS account.
     */
    async getCSPMAwsAccount(scanType?: GetCSPMAwsAccountScanTypeEnum, ids?: Array<string>, iamRoleArns?: Array<string>, organizationIds?: Array<string>, status?: GetCSPMAwsAccountStatusEnum, limit?: number, cspmLite?: GetCSPMAwsAccountCspmLiteEnum, migrated?: GetCSPMAwsAccountMigratedEnum, offset?: number, groupBy?: GetCSPMAwsAccountGroupByEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAWSAccountResponseV2> {
        const response = await this.getCSPMAwsAccountRaw({ scanType: scanType, ids: ids, iamRoleArns: iamRoleArns, organizationIds: organizationIds, status: status, limit: limit, cspmLite: cspmLite, migrated: migrated, offset: offset, groupBy: groupBy }, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCSPMAwsAccountScriptsAttachmentRaw(requestParameters: GetCSPMAwsAccountScriptsAttachmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAWSProvisionGetAccountScriptResponseV2>> {
        const queryParameters: any = {};
     ...
     * Return a script for customer to run in their cloud environment to grant us access to their AWS environment as a downloadable attachment.
     */
    async getCSPMAwsAccountScriptsAttachment(ids?: Array<string>, template?: GetCSPMAwsAccountScriptsAttachmentTemplateEnum, accountType?: GetCSPMAwsAccountScriptsAttachmentAccountTypeEnum, accounts?: Array<string>, behaviorAssessmentEnabled?: GetCSPMAwsAccountScriptsAttachmentBehaviorAssessmentEnabledEnum, sensorManagementEnabled?: GetCSPMAwsAccountScriptsAttachmentSensorManagementEnabledEnum, useExistingCloudtrail?: GetCSPMAwsAccountScriptsAttachmentUseExistingCloudtrailEnum, organizationId?: string, awsProfile?: string, customRoleName?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAWSProvisionGetAccountScriptResponseV2> {
        const response = await this.getCSPMAwsAccountScriptsAttachmentRaw({ ids: ids, template: template, accountType: accountType, accounts: accounts, behaviorAssessmentEnabled: behaviorAssessmentEnabled, sensorManagementEnabled: sensorManagementEnabled, useExistingCloudtrail: useExistingCloudtrail, organizationId: organizationId, awsProfile: awsProfile, customRoleName: customRoleName }, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCSPMAwsConsoleSetupURLsRaw(requestParameters: GetCSPMAwsConsoleSetupURLsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAWSConsoleURLResponseV2>> {
        const queryParameters: any = {};
     ...
     * Return a URL for customer to visit in their cloud environment to grant us access to their AWS environment.
     */
    async getCSPMAwsConsoleSetupURLs(ids?: Array<string>, useExistingCloudtrail?: GetCSPMAwsConsoleSetupURLsUseExistingCloudtrailEnum, region?: string, template?: GetCSPMAwsConsoleSetupURLsTemplateEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAWSConsoleURLResponseV2> {
     ...
     */
    async getCSPMAzureAccountRaw(requestParameters: GetCSPMAzureAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureAccountResponseV1>> {
        const queryParameters: any = {};
     ...
     * Return information about Azure account registration
     */
    async getCSPMAzureAccount(ids?: Array<string>, tenantIds?: Array<string>, scanType?: string, status?: string, cspmLite?: GetCSPMAzureAccountCspmLiteEnum, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureAccountResponseV1> {
     ...
     */
    async getCSPMAzureManagementGroupRaw(requestParameters: GetCSPMAzureManagementGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureManagementGroupResponseV1>> {
        const queryParameters: any = {};
     ...
     * Return information about Azure management group registration
     */
    async getCSPMAzureManagementGroup(tenantIds?: Array<string>, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureManagementGroupResponseV1> {
     ...
     */
    async getCSPMAzureUserScriptsAttachmentRaw(requestParameters: GetCSPMAzureUserScriptsAttachmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureProvisionGetUserScriptResponseV1>> {
        const queryParameters: any = {};
     ...
     * Return a script for customer to run in their cloud environment to grant us access to their Azure environment as a downloadable attachment
     */
    async getCSPMAzureUserScriptsAttachment(tenantId?: string, subscriptionIds?: Array<string>, accountType?: GetCSPMAzureUserScriptsAttachmentAccountTypeEnum, template?: string, azureManagementGroup?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureProvisionGetUserScriptResponseV1> {
        const response = await this.getCSPMAzureUserScriptsAttachmentRaw({ tenantId: tenantId, subscriptionIds: subscriptionIds, accountType: accountType, template: template, azureManagementGroup: azureManagementGroup }, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCSPMCGPAccountRaw(requestParameters: GetCSPMCGPAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPAccountResponseV1>> {
        const queryParameters: any = {};
     ...
     * Returns information about the current status of an GCP account.
     */
    async getCSPMCGPAccount(parentType?: GetCSPMCGPAccountParentTypeEnum, ids?: Array<string>, scanType?: GetCSPMCGPAccountScanTypeEnum, status?: GetCSPMCGPAccountStatusEnum, limit?: number, offset?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationGCPAccountResponseV1> {
     ...
     */
    async getCSPMGCPServiceAccountsExtRaw(requestParameters: GetCSPMGCPServiceAccountsExtRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPServiceAccountResponseExtV1>> {
        const queryParameters: any = {};
     ...
     */
    async getCSPMGCPUserScriptsAttachmentRaw(requestParameters: GetCSPMGCPUserScriptsAttachmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPProvisionGetUserScriptResponseV1>> {
        const queryParameters: any = {};
     ...
     * Return a script for customer to run in their cloud environment to grant us access to their GCP environment as a downloadable attachment
     */
    async getCSPMGCPUserScriptsAttachment(parentType?: GetCSPMGCPUserScriptsAttachmentParentTypeEnum, ids?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationGCPProvisionGetUserScriptResponseV1> {
     ...
     */
    async getCSPMGCPValidateAccountsExtRaw(requestParameters: GetCSPMGCPValidateAccountsExtRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPAccountValidationResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getCSPMGCPValidateAccountsExt().'
            );
        }
     ...
     * Run a synchronous health check.
     */
    async getCSPMGCPValidateAccountsExt(body: RegistrationGCPAccountValidationRequestV1, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationGCPAccountValidationResponseV1> {
     ...
     */
    async getCSPMPoliciesDetailsRaw(requestParameters: GetCSPMPoliciesDetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationPolicyResponseV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getCSPMPoliciesDetails().'
            );
        }
    ...
    async getCSPMPolicyRaw(requestParameters: GetCSPMPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationPolicyResponseV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getCSPMPolicy().'
            );
        }
     ...
     */
    async getCSPMPolicySettingsRaw(requestParameters: GetCSPMPolicySettingsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationPolicySettingsResponseV1>> {
        const queryParameters: any = {};
     ...
     * Returns information about current policy settings.
     */
    async getCSPMPolicySettings(service?: GetCSPMPolicySettingsServiceEnum, policyId?: string, cloudPlatform?: GetCSPMPolicySettingsCloudPlatformEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationPolicySettingsResponseV1> {
     ...
     */
    async getCSPMScanScheduleRaw(requestParameters: GetCSPMScanScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationScanScheduleResponseV1>> {
        const queryParameters: any = {};
     ...
     */
    async getConfigurationDetectionEntitiesRaw(requestParameters: GetConfigurationDetectionEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationExternalIOMEventResponseV2>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getConfigurationDetectionEntities().'
            );
        }
     ...
     */
    async getConfigurationDetectionIDsV2Raw(requestParameters: GetConfigurationDetectionIDsV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationIOMEventIDsResponseV2>> {
        const queryParameters: any = {};
     ...
     * Get list of active misconfiguration ids - including custom policy detections in addition to default policy detections.
     */
    async getConfigurationDetectionIDsV2(filter?: string, sort?: string, limit?: number, offset?: number, nextToken?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationIOMEventIDsResponseV2> {
     ...
     * @deprecated
     */
    async getConfigurationDetectionsRaw(requestParameters: GetConfigurationDetectionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationExternalIOMEventResponse>> {
        const queryParameters: any = {};
     ...
     * @deprecated
     */
    async getConfigurationDetections(cloudProvider?: GetConfigurationDetectionsCloudProviderEnum, accountId?: string, azureSubscriptionId?: string, azureTenantId?: string, status?: GetConfigurationDetectionsStatusEnum, region?: string, severity?: GetConfigurationDetectionsSeverityEnum, service?: GetConfigurationDetectionsServiceEnum, nextToken?: string, limit?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationExternalIOMEventResponse> {
        const response = await this.getConfigurationDetectionsRaw({ cloudProvider: cloudProvider, accountId: accountId, azureSubscriptionId: azureSubscriptionId, azureTenantId: azureTenantId, status: status, region: region, severity: severity, service: service, nextToken: nextToken, limit: limit }, initOverrides);
        return await response.value();
    }
     ...
     */
    async patchCSPMAwsAccountRaw(requestParameters: PatchCSPMAwsAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAWSAccountResponseV2>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling patchCSPMAwsAccount().'
            );
        }
     ...
     * Patches a existing account in our system for a customer.
     */
    async updateCSPMAzureAccountRaw(requestParameters: UpdateCSPMAzureAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureAccountResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateCSPMAzureAccount().'
            );
        }
     ...
     */
    async updateCSPMAzureAccountClientIDRaw(requestParameters: UpdateCSPMAzureAccountClientIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureTenantConfigurationResponseV1>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling updateCSPMAzureAccountClientID().'
            );
        }
     ...
     */
    async updateCSPMAzureTenantDefaultSubscriptionIDRaw(requestParameters: UpdateCSPMAzureTenantDefaultSubscriptionIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureTenantDefaultSubscriptionIDResponseV1>> {
        if (requestParameters['subscriptionId'] == null) {
            throw new runtime.RequiredError(
                'subscriptionId',
                'Required parameter "subscriptionId" was null or undefined when calling updateCSPMAzureTenantDefaultSubscriptionID().'
            );
        }
     ...
     * Update an Azure default subscription_id in our system for given tenant_id
     */
    async updateCSPMAzureTenantDefaultSubscriptionID(subscriptionId: string, tenantId?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureTenantDefaultSubscriptionIDResponseV1> {
     ...
     * Patches a existing account in our system for a customer.
     */
    async updateCSPMGCPAccountRaw(requestParameters: UpdateCSPMGCPAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPAccountResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateCSPMGCPAccount().'
            );
        }
     ...
     */
    async updateCSPMGCPServiceAccountsExtRaw(requestParameters: UpdateCSPMGCPServiceAccountsExtRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPServiceAccountResponseExtV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateCSPMGCPServiceAccountsExt().'
            );
        }
     ...
     * Patches the service account key for external clients.
     */
    async updateCSPMGCPServiceAccountsExt(body: RegistrationGCPServiceAccountPatchRequestV1, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationGCPServiceAccountResponseExtV1> {
     ...
     */
    async updateCSPMPolicySettingsRaw(requestParameters: UpdateCSPMPolicySettingsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationPolicySettingsResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateCSPMPolicySettings().'
            );
        }
     ...
     */
    async updateCSPMScanScheduleRaw(requestParameters: UpdateCSPMScanScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationScanScheduleResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateCSPMScanSchedule().'
            );
        }
     ...
     */
    async validateCSPMGCPServiceAccountExtRaw(requestParameters: ValidateCSPMGCPServiceAccountExtRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPServiceAccountValidationResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling validateCSPMGCPServiceAccountExt().'
            );
        }
     ...
     * Validates credentials for a service account
     */
    async validateCSPMGCPServiceAccountExt(body: RegistrationGCPServiceAccountValidationRequestV1, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationGCPServiceAccountValidationResponseV1> {
...
export type GetCSPMAwsAccountScriptsAttachmentBehaviorAssessmentEnabledEnum = typeof GetCSPMAwsAccountScriptsAttachmentBehaviorAssessmentEnabledEnum[keyof typeof GetCSPMAwsAccountScriptsAttachmentBehaviorAssessmentEnabledEnum];
/**
 * @export
 */
...
export type GetCSPMAwsAccountScriptsAttachmentSensorManagementEnabledEnum = typeof GetCSPMAwsAccountScriptsAttachmentSensorManagementEnabledEnum[keyof typeof GetCSPMAwsAccountScriptsAttachmentSensorManagementEnabledEnum];
/**
 * @export
 */
...
export type GetCSPMAwsAccountScriptsAttachmentUseExistingCloudtrailEnum = typeof GetCSPMAwsAccountScriptsAttachmentUseExistingCloudtrailEnum[keyof typeof GetCSPMAwsAccountScriptsAttachmentUseExistingCloudtrailEnum];
/**
 * @export
 */
