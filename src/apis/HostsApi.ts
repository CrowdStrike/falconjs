...
export class HostsApi extends runtime.BaseAPI {
     ...
     */
    async entitiesPerformActionRaw(requestParameters: EntitiesPerformActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceapiGroupsResponseV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling entitiesPerformAction().'
            );
        }
        ...
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling entitiesPerformAction().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling entitiesPerformAction().'
            );
        }
     ...
     * Performs the specified action on the provided group IDs.
     */
    async entitiesPerformAction(ids: Array<string>, actionName: EntitiesPerformActionActionNameEnum, body: MsaEntityActionRequest, disableHostnameCheck?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeviceapiGroupsResponseV1> {
     ...
     */
    async getDeviceDetailsV2Raw(requestParameters: GetDeviceDetailsV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceapiDeviceDetailsResponseSwagger>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getDeviceDetailsV2().'
            );
        }
    ...
    async getOnlineStateV1Raw(requestParameters: GetOnlineStateV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StateOnlineStateRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getOnlineStateV1().'
            );
        }
    ...
    async performActionV2Raw(requestParameters: PerformActionV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyAffectedEntities>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling performActionV2().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling performActionV2().'
            );
        }
     ...
     */
    async postDeviceDetailsV2Raw(requestParameters: PostDeviceDetailsV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceapiDeviceDetailsResponseSwagger>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling postDeviceDetailsV2().'
            );
        }
     ...
     */
    async queryDeviceLoginHistoryRaw(requestParameters: QueryDeviceLoginHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceapiLoginHistoryResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling queryDeviceLoginHistory().'
            );
        }
     ...
     */
    async queryDeviceLoginHistoryV2Raw(requestParameters: QueryDeviceLoginHistoryV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceapiLoginHistoryResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling queryDeviceLoginHistoryV2().'
            );
        }
     ...
     */
    async queryDevicesByFilterScrollRaw(requestParameters: QueryDevicesByFilterScrollRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceapiDeviceResponse>> {
        const queryParameters: any = {};
     ...
     */
    async queryGetNetworkAddressHistoryV1Raw(requestParameters: QueryGetNetworkAddressHistoryV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceapiNetworkAddressHistoryResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling queryGetNetworkAddressHistoryV1().'
            );
        }
     ...
     */
    async updateDeviceTagsRaw(requestParameters: UpdateDeviceTagsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceapiUpdateDeviceTagsSwaggerV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateDeviceTags().'
            );
        }
