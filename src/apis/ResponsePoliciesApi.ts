...
export class ResponsePoliciesApi extends runtime.BaseAPI {
     ...
     */
    async createRTResponsePoliciesRaw(requestParameters: CreateRTResponsePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RemoteResponseRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createRTResponsePolicies().'
            );
        }
    ...
    async deleteRTResponsePoliciesRaw(requestParameters: DeleteRTResponsePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling deleteRTResponsePolicies().'
            );
        }
    ...
    async getRTResponsePoliciesRaw(requestParameters: GetRTResponsePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RemoteResponseRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getRTResponsePolicies().'
            );
        }
     ...
     */
    async performRTResponsePoliciesActionRaw(requestParameters: PerformRTResponsePoliciesActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RemoteResponseRespV1>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling performRTResponsePoliciesAction().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling performRTResponsePoliciesAction().'
            );
        }
     ...
     * Perform the specified action on the Response Policies specified in the request
     */
    async performRTResponsePoliciesAction(actionName: PerformRTResponsePoliciesActionActionNameEnum, body: MsaEntityActionRequestV2, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RemoteResponseRespV1> {
     ...
     */
    async queryCombinedRTResponsePoliciesRaw(requestParameters: QueryCombinedRTResponsePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RemoteResponseRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for Response Policies in your environment by providing an FQL filter and paging details. Returns a set of Response Policies which match the filter criteria
     */
    async queryCombinedRTResponsePolicies(filter?: string, offset?: number, limit?: number, sort?: QueryCombinedRTResponsePoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RemoteResponseRespV1> {
     ...
     */
    async queryCombinedRTResponsePolicyMembersRaw(requestParameters: QueryCombinedRTResponsePolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BasePolicyMembersRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Response policy in your environment by providing an FQL filter and paging details. Returns a set of host details which match the filter criteria
     */
    async queryCombinedRTResponsePolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BasePolicyMembersRespV1> {
     ...
     * Search for Response Policies in your environment by providing an FQL filter with sort and/or paging details. This returns a set of Response Policy IDs that match the given criteria.
     */
    async queryRTResponsePolicies(filter?: string, offset?: number, limit?: number, sort?: QueryRTResponsePoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async queryRTResponsePolicyMembersRaw(requestParameters: QueryRTResponsePolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Response policy in your environment by providing an FQL filter and paging details. Returns a set of Agent IDs which match the filter criteria
     */
    async queryRTResponsePolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async setRTResponsePoliciesPrecedenceRaw(requestParameters: SetRTResponsePoliciesPrecedenceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling setRTResponsePoliciesPrecedence().'
            );
        }
     ...
     */
    async updateRTResponsePoliciesRaw(requestParameters: UpdateRTResponsePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RemoteResponseRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateRTResponsePolicies().'
            );
        }
