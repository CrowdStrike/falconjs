...
export interface GetMalwareEntitiesRequest {
    ids: Array<string>;
}
...
export interface QueryMalwareRequest {
    offset?: number;
    limit?: number;
    sort?: string;
    filter?: string;
...
export interface QueryMitreAttacksForMalwareRequest {
    ids: Array<string>;
}
...
export class IntelApi extends runtime.BaseAPI {
    ...
    async getIntelActorEntitiesRaw(requestParameters: GetIntelActorEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainActorsResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getIntelActorEntities().'
            );
        }
     ...
     */
    async getIntelIndicatorEntitiesRaw(requestParameters: GetIntelIndicatorEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainPublicIndicatorsV3Response>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getIntelIndicatorEntities().'
            );
        }
    ...
    async getIntelReportEntitiesRaw(requestParameters: GetIntelReportEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainNewsResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getIntelReportEntities().'
            );
        }
    ...
    async getIntelRuleEntitiesRaw(requestParameters: GetIntelRuleEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainRulesResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getIntelRuleEntities().'
            );
        }
    ...
    async getIntelRuleFileRaw(requestParameters: GetIntelRuleFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getIntelRuleFile().'
            );
        }
    ...
    async getLatestIntelRuleFileRaw(requestParameters: GetLatestIntelRuleFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters['type'] == null) {
            throw new runtime.RequiredError(
                'type',
                'Required parameter "type" was null or undefined when calling getLatestIntelRuleFile().'
            );
        }
     ...
     * Download the latest rule set.
     */
    async getLatestIntelRuleFile(type: string, accept?: string, ifNoneMatch?: string, ifModifiedSince?: string, format?: string, ifModifiedSince2?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
        const response = await this.getLatestIntelRuleFileRaw({ type: type, accept: accept, ifNoneMatch: ifNoneMatch, ifModifiedSince: ifModifiedSince, format: format, ifModifiedSince2: ifModifiedSince2 }, initOverrides);
        return await response.value();
    }
     ...
     */
    async getMalwareEntitiesRaw(requestParameters: GetMalwareEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainMalwareResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getMalwareEntities().'
            );
        }
    ...
    async getMitreReportRaw(requestParameters: GetMitreReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['actorId'] == null) {
            throw new runtime.RequiredError(
                'actorId',
                'Required parameter "actorId" was null or undefined when calling getMitreReport().'
            );
        }
        ...
        if (requestParameters['format'] == null) {
            throw new runtime.RequiredError(
                'format',
                'Required parameter "format" was null or undefined when calling getMitreReport().'
            );
        }
    ...
    async getVulnerabilitiesRaw(requestParameters: GetVulnerabilitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainVulnerabilityResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getVulnerabilities().'
            );
        }
    ...
    async postMitreAttacksRaw(requestParameters: PostMitreAttacksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling postMitreAttacks().'
            );
        }
     ...
     */
    async queryIntelActorEntitiesRaw(requestParameters: QueryIntelActorEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainActorsResponse>> {
        const queryParameters: any = {};
     ...
     * Get info about actors that match provided FQL filters.
     */
    async queryIntelActorEntities(offset?: number, limit?: number, sort?: string, filter?: string, q?: string, fields?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainActorsResponse> {
     ...
     */
    async queryIntelIndicatorEntitiesRaw(requestParameters: QueryIntelIndicatorEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainPublicIndicatorsV3Response>> {
        const queryParameters: any = {};
     ...
     * Get info about indicators that match provided FQL filters.
     */
    async queryIntelIndicatorEntities(offset?: number, limit?: number, sort?: string, filter?: string, q?: string, includeDeleted?: boolean, includeRelations?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainPublicIndicatorsV3Response> {
        const response = await this.queryIntelIndicatorEntitiesRaw({ offset: offset, limit: limit, sort: sort, filter: filter, q: q, includeDeleted: includeDeleted, includeRelations: includeRelations }, initOverrides);
        return await response.value();
    }
     ...
     * Get indicators IDs that match provided FQL filters.
     */
    async queryIntelIndicatorIds(offset?: number, limit?: number, sort?: string, filter?: string, q?: string, includeDeleted?: boolean, includeRelations?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
        const response = await this.queryIntelIndicatorIdsRaw({ offset: offset, limit: limit, sort: sort, filter: filter, q: q, includeDeleted: includeDeleted, includeRelations: includeRelations }, initOverrides);
        return await response.value();
    }
     ...
     */
    async queryIntelReportEntitiesRaw(requestParameters: QueryIntelReportEntitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainNewsResponse>> {
        const queryParameters: any = {};
     ...
     * Get info about reports that match provided FQL filters.
     */
    async queryIntelReportEntities(offset?: number, limit?: number, sort?: string, filter?: string, q?: string, fields?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainNewsResponse> {
    ...
    async queryIntelRuleIdsRaw(requestParameters: QueryIntelRuleIdsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['type'] == null) {
            throw new runtime.RequiredError(
                'type',
                'Required parameter "type" was null or undefined when calling queryIntelRuleIds().'
            );
        }
     ...
     * Search for rule IDs that match provided filter criteria.
     */
    async queryIntelRuleIds(type: string, offset?: number, limit?: number, sort?: string, name?: Array<string>, description?: Array<string>, tags?: Array<string>, minCreatedDate?: number, maxCreatedDate?: string, q?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
        const response = await this.queryIntelRuleIdsRaw({ type: type, offset: offset, limit: limit, sort: sort, name: name, description: description, tags: tags, minCreatedDate: minCreatedDate, maxCreatedDate: maxCreatedDate, q: q }, initOverrides);
        return await response.value();
    }
     ...
     */
    async queryMalwareRaw(requestParameters: QueryMalwareRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainQueryResponse>> {
        const queryParameters: any = {};
     ...
     */
    async queryMitreAttacksForMalwareRaw(requestParameters: QueryMitreAttacksForMalwareRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling queryMitreAttacksForMalware().'
            );
        }
