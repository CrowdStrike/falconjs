...
export const CombinedEdgesGetEdgeTypeEnum = {
    ...
    AccessedByProcess: "accessed_by_process",
    ...
    AccessedWeb: "accessed_web",
    AgentToSelfDiagnostic: "agent_to_self_diagnostic",
    AiAgentUsedBy: "ai_agent_used_by",
    AiRunsOn: "ai_runs_on",
    ...
    AssociatedVmwareCluster: "associated_vmware_cluster",
    AssociatedVmwareSensor: "associated_vmware_sensor",
    ...
    ProtectedByShield: "protected_by_shield",
    ...
    RunsSession: "runs_session",
    Script: "script",
    SelfDiagnosticToAgent: "self_diagnostic_to_agent",
    SessionProcess: "session_process",
    SessionRunBy: "session_run_by",
    SetByProcess: "set_by_process",
    SetFirewallRule: "set_firewall_rule",
    SetRule: "set_rule",
    ShellIoRedirect: "shell_io_redirect",
    ShieldActivatedOnHost: "shield_activated_on_host",
    SpawnsAgent: "spawns_agent",
    ToolSpawnedProcess: "tool_spawned_process",
    ...
    TriggeredCustomIoa: "triggered_custom_ioa",
...
export const CombinedSummaryGetVertexTypeEnum = {
    ...
    CustomIoa: "custom_ioa",
    CustomIoas: "custom_ioas",
    Ipv4: "ipv4",
    Ipv6: "ipv6",
    ...
    VmwareClusters: "vmware_clusters",
