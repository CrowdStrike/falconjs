...
export interface CountByDateRangeRequest {
    filter?: string;
}
...
export class UnidentifiedContainersApi extends runtime.BaseAPI {
     ...
     */
    async countRaw(requestParameters: CountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UnidentifiedcontainersUnidentifiedContainersCountValue>> {
     ...
     */
    async countByDateRangeRaw(requestParameters: CountByDateRangeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsAggregateValuesByFieldResponse>> {
        const queryParameters: any = {};
     ...
     */
    async searchRaw(requestParameters: SearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UnidentifiedcontainersUnidentifiedContainerAPIResponse>> {
        const queryParameters: any = {};
     ...
     * Search Unidentified Containers by the provided search criteria
     */
    async search(filter?: string, limit?: number, offset?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UnidentifiedcontainersUnidentifiedContainerAPIResponse> {
