...
export interface ConnectD4CGCPAccountRequest {
...
export interface DeleteD4CGCPAccountRequest {
    ids?: Array<string>;
}
...
export interface GetD4CGCPServiceAccountsExtRequest {
    id?: string;
}

export interface GetD4CGCPUserScriptsAttachmentRequest {
...
export interface UpdateD4CGCPServiceAccountsExtRequest {
...
export class D4cRegistrationApi extends runtime.BaseAPI {
     ...
     */
    async connectD4CGCPAccountRaw(requestParameters: ConnectD4CGCPAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPAccountResponseExtV2>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling connectD4CGCPAccount().'
            );
        }
     ...
     */
    async createD4CAwsAccountRaw(requestParameters: CreateD4CAwsAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAWSAccountResponseV2>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createD4CAwsAccount().'
            );
        }
     ...
     */
    async createD4CGcpAccountRaw(requestParameters: CreateD4CGcpAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPAccountResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createD4CGcpAccount().'
            );
        }
     ...
     */
    async createDiscoverCloudAzureAccountRaw(requestParameters: CreateDiscoverCloudAzureAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureAccountResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createDiscoverCloudAzureAccount().'
            );
        }
     ...
     * Creates a new account in our system for a customer and generates a script for them to run in their cloud environment to grant us access.
     */
    async createDiscoverCloudAzureAccount(body: RegistrationAzureAccountCreateRequestExternalV1, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureAccountResponseV1> {
     ...
     */
    async deleteD4CGCPAccountRaw(requestParameters: DeleteD4CGCPAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaBaseEntitiesResponse>> {
        const queryParameters: any = {};
     ...
     */
    async discoverCloudAzureDownloadCertificateRaw(requestParameters: DiscoverCloudAzureDownloadCertificateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureDownloadCertificateResponseV1>> {
        if (requestParameters['tenantId'] == null) {
            throw new runtime.RequiredError(
                'tenantId',
                'Required parameter "tenantId" was null or undefined when calling discoverCloudAzureDownloadCertificate().'
            );
        }
     ...
     * Returns JSON object(s) that contain the base64 encoded certificate for a service principal.
     */
    async discoverCloudAzureDownloadCertificate(tenantId: Array<string>, refresh?: boolean, yearsValid?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureDownloadCertificateResponseV1> {
     ...
     */
    async getD4CAWSAccountScriptsAttachmentRaw(requestParameters: GetD4CAWSAccountScriptsAttachmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAWSProvisionGetAccountScriptResponseV2>> {
        const queryParameters: any = {};
     ...
     * Return a script for customer to run in their cloud environment to grant us access to their AWS environment as a downloadable attachment.
     */
    async getD4CAWSAccountScriptsAttachment(ids?: Array<string>, template?: GetD4CAWSAccountScriptsAttachmentTemplateEnum, accounts?: Array<string>, behaviorAssessmentEnabled?: GetD4CAWSAccountScriptsAttachmentBehaviorAssessmentEnabledEnum, sensorManagementEnabled?: GetD4CAWSAccountScriptsAttachmentSensorManagementEnabledEnum, useExistingCloudtrail?: GetD4CAWSAccountScriptsAttachmentUseExistingCloudtrailEnum, organizationId?: string, awsProfile?: string, customRoleName?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAWSProvisionGetAccountScriptResponseV2> {
        const response = await this.getD4CAWSAccountScriptsAttachmentRaw({ ids: ids, template: template, accounts: accounts, behaviorAssessmentEnabled: behaviorAssessmentEnabled, sensorManagementEnabled: sensorManagementEnabled, useExistingCloudtrail: useExistingCloudtrail, organizationId: organizationId, awsProfile: awsProfile, customRoleName: customRoleName }, initOverrides);
        return await response.value();
    }
     ...
     * Returns information about the current status of an AWS account.
     */
    async getD4CAwsAccount(scanType?: string, ids?: Array<string>, organizationIds?: Array<string>, status?: string, limit?: number, offset?: number, migrated?: GetD4CAwsAccountMigratedEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAWSAccountResponseV2> {
        const response = await this.getD4CAwsAccountRaw({ scanType: scanType, ids: ids, organizationIds: organizationIds, status: status, limit: limit, offset: offset, migrated: migrated }, initOverrides);
        return await response.value();
    }
     ...
     */
    async getD4CAwsConsoleSetupURLsRaw(requestParameters: GetD4CAwsConsoleSetupURLsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAWSConsoleURLResponseV2>> {
        const queryParameters: any = {};
     ...
     */
    async getD4CGCPServiceAccountsExtRaw(requestParameters: GetD4CGCPServiceAccountsExtRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPServiceAccountResponseExtV1>> {
        const queryParameters: any = {};
     ...
     */
    async getD4CGCPUserScriptsAttachmentRaw(requestParameters: GetD4CGCPUserScriptsAttachmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPProvisionGetUserScriptResponseV1>> {
        const queryParameters: any = {};
     ...
     * Return a script for customer to run in their cloud environment to grant us access to their GCP environment as a downloadable attachment
     */
    async getD4CGCPUserScriptsAttachment(parentType?: GetD4CGCPUserScriptsAttachmentParentTypeEnum, ids?: Array<string>, status?: GetD4CGCPUserScriptsAttachmentStatusEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationGCPProvisionGetUserScriptResponseV1> {
     ...
     * Returns information about the current status of an GCP account.
     */
    async getD4CGcpAccount(parentType?: GetD4CGcpAccountParentTypeEnum, ids?: Array<string>, scanType?: GetD4CGcpAccountScanTypeEnum, status?: GetD4CGcpAccountStatusEnum, limit?: number, offset?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationGCPAccountResponseV1> {
     ...
     */
    async getD4CGcpUserScriptsRaw(requestParameters: GetD4CGcpUserScriptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPProvisionGetUserScriptResponseV1>> {
        const queryParameters: any = {};
     ...
     */
    async getDiscoverCloudAzureAccountRaw(requestParameters: GetDiscoverCloudAzureAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureAccountResponseV1>> {
        const queryParameters: any = {};
     ...
     * Return information about Azure account registration
     */
    async getDiscoverCloudAzureAccount(ids?: Array<string>, tenantIds?: Array<string>, scanType?: string, status?: string, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureAccountResponseV1> {
     ...
     */
    async getDiscoverCloudAzureUserScriptsAttachmentRaw(requestParameters: GetDiscoverCloudAzureUserScriptsAttachmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureProvisionGetUserScriptResponseV1>> {
        if (requestParameters['tenantId'] == null) {
            throw new runtime.RequiredError(
                'tenantId',
                'Required parameter "tenantId" was null or undefined when calling getDiscoverCloudAzureUserScriptsAttachment().'
            );
        }
     ...
     * Return a script for customer to run in their cloud environment to grant us access to their Azure environment as a downloadable attachment
     */
    async getDiscoverCloudAzureUserScriptsAttachment(tenantId: Array<string>, subscriptionIds?: Array<string>, template?: string, azureManagementGroup?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureProvisionGetUserScriptResponseV1> {
        const response = await this.getDiscoverCloudAzureUserScriptsAttachmentRaw({ tenantId: tenantId, subscriptionIds: subscriptionIds, template: template, azureManagementGroup: azureManagementGroup }, initOverrides);
        return await response.value();
    }
     ...
     */
    async getHorizonD4CScriptsRaw(requestParameters: GetHorizonD4CScriptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationStaticScriptsResponse>> {
        const queryParameters: any = {};
     ...
     * Returns static install scripts for Horizon.
     */
    async getHorizonD4CScripts(singleAccount?: GetHorizonD4CScriptsSingleAccountEnum, organizationId?: string, _delete?: GetHorizonD4CScriptsDeleteEnum, accountType?: GetHorizonD4CScriptsAccountTypeEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationStaticScriptsResponse> {
     ...
     */
    async updateD4CGCPServiceAccountsExtRaw(requestParameters: UpdateD4CGCPServiceAccountsExtRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationGCPServiceAccountResponseExtV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateD4CGCPServiceAccountsExt().'
            );
        }
     ...
     * Patches the service account key for external clients.
     */
    async updateD4CGCPServiceAccountsExt(body: RegistrationGCPServiceAccountPatchRequestV1, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationGCPServiceAccountResponseExtV1> {
     ...
     */
    async updateDiscoverCloudAzureAccountClientIDRaw(requestParameters: UpdateDiscoverCloudAzureAccountClientIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationAzureTenantConfigurationResponseV1>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling updateDiscoverCloudAzureAccountClientID().'
            );
        }
     ...
     * Update an Azure service account in our system by with the user-created client_id created with the public key we\'ve provided
     */
    async updateDiscoverCloudAzureAccountClientID(id: string, objectId?: string, tenantId?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationAzureTenantConfigurationResponseV1> {
...
export type GetD4CAWSAccountScriptsAttachmentBehaviorAssessmentEnabledEnum = typeof GetD4CAWSAccountScriptsAttachmentBehaviorAssessmentEnabledEnum[keyof typeof GetD4CAWSAccountScriptsAttachmentBehaviorAssessmentEnabledEnum];
/**
 * @export
 */
...
export type GetD4CAWSAccountScriptsAttachmentSensorManagementEnabledEnum = typeof GetD4CAWSAccountScriptsAttachmentSensorManagementEnabledEnum[keyof typeof GetD4CAWSAccountScriptsAttachmentSensorManagementEnabledEnum];
/**
 * @export
 */
...
export type GetD4CAWSAccountScriptsAttachmentUseExistingCloudtrailEnum = typeof GetD4CAWSAccountScriptsAttachmentUseExistingCloudtrailEnum[keyof typeof GetD4CAWSAccountScriptsAttachmentUseExistingCloudtrailEnum];
/**
 * @export
 */
