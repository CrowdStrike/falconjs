...
export interface CreatePolicyGroupsRequest {
...
export interface UpdatePolicyExclusionsRequest {
    body: ModelsUpdateExclusionsRequest;
}

export interface UpdatePolicyGroupsRequest {
    id: string;
...
export class ImageAssessmentPoliciesApi extends runtime.BaseAPI {
     ...
     */
    async createPoliciesRaw(requestParameters: CreatePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsPolicyEntityResponse>> {
     ...
     */
    async createPolicyGroupsRaw(requestParameters: CreatePolicyGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsPolicyGroupEntityResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createPolicyGroups().'
            );
        }
     ...
     */
    async deletePolicyRaw(requestParameters: DeletePolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CoreEntitiesResponse>> {
     ...
     */
    async deletePolicyGroupRaw(requestParameters: DeletePolicyGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CoreEntitiesResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling deletePolicyGroup().'
            );
        }
     ...
     */
    async updatePoliciesRaw(requestParameters: UpdatePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsPolicyEntityResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling updatePolicies().'
            );
        }
     ...
     */
    async updatePolicyExclusionsRaw(requestParameters: UpdatePolicyExclusionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsPolicyExclusionEntityResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updatePolicyExclusions().'
            );
        }
     ...
     */
    async updatePolicyGroupsRaw(requestParameters: UpdatePolicyGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsPolicyGroupEntityResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling updatePolicyGroups().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updatePolicyGroups().'
            );
        }
     ...
     */
    async updatePolicyPrecedenceRaw(requestParameters: UpdatePolicyPrecedenceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsPolicyEntityResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updatePolicyPrecedence().'
            );
        }
