...
export class ContainerVulnerabilitiesApi extends runtime.BaseAPI {
     ...
     */
    async readCombinedVulnerabilitiesRaw(requestParameters: ReadCombinedVulnerabilitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiCombinedVulnerability>> {
     ...
     * Retrieve vulnerability and aggregate data filtered by the provided FQL
     */
    async readCombinedVulnerabilities(filter?: string, limit?: number, offset?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VulnerabilitiesApiCombinedVulnerability> {
     ...
     */
    async readCombinedVulnerabilitiesDetailsRaw(requestParameters: ReadCombinedVulnerabilitiesDetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiCombinedVulnerabilityDetails>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling readCombinedVulnerabilitiesDetails().'
            );
        }
     ...
     * Retrieve vulnerability details related to an image
     */
    async readCombinedVulnerabilitiesDetails(id: string, filter?: string, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VulnerabilitiesApiCombinedVulnerabilityDetails> {
     ...
     */
    async readCombinedVulnerabilitiesInfoRaw(requestParameters: ReadCombinedVulnerabilitiesInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiCombinedVulnerabilityInfo>> {
        if (requestParameters['cveId'] == null) {
            throw new runtime.RequiredError(
                'cveId',
                'Required parameter "cveId" was null or undefined when calling readCombinedVulnerabilitiesInfo().'
            );
        }
     ...
     * Retrieve vulnerability and package related info for this customer
     */
    async readCombinedVulnerabilitiesInfo(cveId: string, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VulnerabilitiesApiCombinedVulnerabilityInfo> {
     ...
     */
    async readVulnerabilitiesByImageCountRaw(requestParameters: ReadVulnerabilitiesByImageCountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiVulnByImageCount>> {
        const queryParameters: any = {};
     ...
     */
    async readVulnerabilitiesPublicationDateRaw(requestParameters: ReadVulnerabilitiesPublicationDateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiVulnByPublication>> {
        const queryParameters: any = {};
     ...
     * Retrieve top x vulnerabilities with the most recent publication date
     */
    async readVulnerabilitiesPublicationDate(filter?: string, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VulnerabilitiesApiVulnByPublication> {
     ...
     */
    async readVulnerabilityCountRaw(requestParameters: ReadVulnerabilityCountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiVulnCount>> {
        const queryParameters: any = {};
     ...
     */
    async readVulnerabilityCountByActivelyExploitedRaw(requestParameters: ReadVulnerabilityCountByActivelyExploitedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiVulnCountByActivelyExploited>> {
        const queryParameters: any = {};
     ...
     * Aggregate count of vulnerabilities grouped by actively exploited
     */
    async readVulnerabilityCountByActivelyExploited(filter?: string, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VulnerabilitiesApiVulnCountByActivelyExploited> {
     ...
     */
    async readVulnerabilityCountByCPSRatingRaw(requestParameters: ReadVulnerabilityCountByCPSRatingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiVulnCountByCSPRating>> {
        const queryParameters: any = {};
     ...
     * Aggregate count of vulnerabilities grouped by csp_rating
     */
    async readVulnerabilityCountByCPSRating(filter?: string, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VulnerabilitiesApiVulnCountByCSPRating> {
     ...
     */
    async readVulnerabilityCountByCVSSScoreRaw(requestParameters: ReadVulnerabilityCountByCVSSScoreRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiVulnCountByCVSSScore>> {
        const queryParameters: any = {};
     ...
     * Aggregate count of vulnerabilities grouped by cvss score
     */
    async readVulnerabilityCountByCVSSScore(filter?: string, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VulnerabilitiesApiVulnCountByCVSSScore> {
     ...
     */
    async readVulnerabilityCountBySeverityRaw(requestParameters: ReadVulnerabilityCountBySeverityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VulnerabilitiesApiVulnCountBySeverity>> {
        const queryParameters: any = {};
     ...
     * Aggregate count of vulnerabilities grouped by severity
     */
    async readVulnerabilityCountBySeverity(filter?: string, limit?: number, offset?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VulnerabilitiesApiVulnCountBySeverity> {
