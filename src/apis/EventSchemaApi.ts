...
export class EventSchemaApi extends runtime.BaseAPI {
     ...
     */
    async fdrschemaEntitiesEventGetRaw(requestParameters: FdrschemaEntitiesEventGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SchemaSensorEventResponseV1>> {
        const queryParameters: any = {};
     ...
     */
    async fdrschemaQueriesEventGetRaw(requestParameters: FdrschemaQueriesEventGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecQueryResponse>> {
        const queryParameters: any = {};
