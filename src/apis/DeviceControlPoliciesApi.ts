...
export class DeviceControlPoliciesApi extends runtime.BaseAPI {
     ...
     */
    async createDeviceControlPoliciesRaw(requestParameters: CreateDeviceControlPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceControlRespV2>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createDeviceControlPolicies().'
            );
        }
     ...
     */
    async deleteDeviceControlPoliciesRaw(requestParameters: DeleteDeviceControlPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling deleteDeviceControlPolicies().'
            );
        }
     ...
     */
    async getDeviceControlPoliciesRaw(requestParameters: GetDeviceControlPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceControlRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getDeviceControlPolicies().'
            );
        }
     ...
     */
    async performDeviceControlPoliciesActionRaw(requestParameters: PerformDeviceControlPoliciesActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceControlRespV1>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling performDeviceControlPoliciesAction().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling performDeviceControlPoliciesAction().'
            );
        }
     ...
     * Perform the specified action on the Device Control Policies specified in the request
     */
    async performDeviceControlPoliciesAction(actionName: PerformDeviceControlPoliciesActionActionNameEnum, body: MsaEntityActionRequestV2, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeviceControlRespV1> {
     ...
     */
    async queryCombinedDeviceControlPoliciesRaw(requestParameters: QueryCombinedDeviceControlPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceControlRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for Device Control Policies in your environment by providing an FQL filter and paging details. Returns a set of Device Control Policies which match the filter criteria
     */
    async queryCombinedDeviceControlPolicies(filter?: string, offset?: number, limit?: number, sort?: QueryCombinedDeviceControlPoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeviceControlRespV1> {
     ...
     */
    async queryCombinedDeviceControlPolicyMembersRaw(requestParameters: QueryCombinedDeviceControlPolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BasePolicyMembersRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Device Control Policy in your environment by providing an FQL filter and paging details. Returns a set of host details which match the filter criteria
     */
    async queryCombinedDeviceControlPolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BasePolicyMembersRespV1> {
     ...
     */
    async queryDeviceControlPoliciesRaw(requestParameters: QueryDeviceControlPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Search for Device Control Policies in your environment by providing an FQL filter and paging details. Returns a set of Device Control Policy IDs which match the filter criteria
     */
    async queryDeviceControlPolicies(filter?: string, offset?: number, limit?: number, sort?: QueryDeviceControlPoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async queryDeviceControlPolicyMembersRaw(requestParameters: QueryDeviceControlPolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Device Control Policy in your environment by providing an FQL filter and paging details. Returns a set of Agent IDs which match the filter criteria
     */
    async queryDeviceControlPolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async setDeviceControlPoliciesPrecedenceRaw(requestParameters: SetDeviceControlPoliciesPrecedenceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling setDeviceControlPoliciesPrecedence().'
            );
        }
     ...
     */
    async updateDefaultDeviceControlPoliciesRaw(requestParameters: UpdateDefaultDeviceControlPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceControlRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateDefaultDeviceControlPolicies().'
            );
        }
     ...
     */
    async updateDeviceControlPoliciesRaw(requestParameters: UpdateDeviceControlPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceControlRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateDeviceControlPolicies().'
            );
        }
