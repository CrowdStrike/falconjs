...
export class FirewallPoliciesApi extends runtime.BaseAPI {
    ...
    async createFirewallPoliciesRaw(requestParameters: CreateFirewallPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FirewallRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createFirewallPolicies().'
            );
        }
    ...
    async deleteFirewallPoliciesRaw(requestParameters: DeleteFirewallPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling deleteFirewallPolicies().'
            );
        }
    ...
    async getFirewallPoliciesRaw(requestParameters: GetFirewallPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FirewallRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getFirewallPolicies().'
            );
        }
     ...
     */
    async performFirewallPoliciesActionRaw(requestParameters: PerformFirewallPoliciesActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FirewallRespV1>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling performFirewallPoliciesAction().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling performFirewallPoliciesAction().'
            );
        }
     ...
     * Perform the specified action on the Firewall Policies specified in the request
     */
    async performFirewallPoliciesAction(actionName: PerformFirewallPoliciesActionActionNameEnum, body: MsaEntityActionRequestV2, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FirewallRespV1> {
     ...
     */
    async queryCombinedFirewallPoliciesRaw(requestParameters: QueryCombinedFirewallPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FirewallRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for Firewall Policies in your environment by providing an FQL filter and paging details. Returns a set of Firewall Policies which match the filter criteria
     */
    async queryCombinedFirewallPolicies(filter?: string, offset?: number, limit?: number, sort?: QueryCombinedFirewallPoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FirewallRespV1> {
     ...
     */
    async queryCombinedFirewallPolicyMembersRaw(requestParameters: QueryCombinedFirewallPolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BasePolicyMembersRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Firewall Policy in your environment by providing an FQL filter and paging details. Returns a set of host details which match the filter criteria
     */
    async queryCombinedFirewallPolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BasePolicyMembersRespV1> {
     ...
     * Search for Firewall Policies in your environment by providing an FQL filter and paging details. Returns a set of Firewall Policy IDs which match the filter criteria
     */
    async queryFirewallPolicies(filter?: string, offset?: number, limit?: number, sort?: QueryFirewallPoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async queryFirewallPolicyMembersRaw(requestParameters: QueryFirewallPolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Firewall Policy in your environment by providing an FQL filter and paging details. Returns a set of Agent IDs which match the filter criteria
     */
    async queryFirewallPolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async setFirewallPoliciesPrecedenceRaw(requestParameters: SetFirewallPoliciesPrecedenceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling setFirewallPoliciesPrecedence().'
            );
        }
    ...
    async updateFirewallPoliciesRaw(requestParameters: UpdateFirewallPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FirewallRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateFirewallPolicies().'
            );
        }
