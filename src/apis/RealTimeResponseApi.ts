...
export class RealTimeResponseApi extends runtime.BaseAPI {
     ...
     */
    async batchActiveResponderCmdRaw(requestParameters: BatchActiveResponderCmdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainMultiCommandExecuteResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling batchActiveResponderCmd().'
            );
        }
     ...
     * Batch executes a RTR active-responder command across the hosts mapped to the given batch ID.
     */
    async batchActiveResponderCmd(body: DomainBatchExecuteCommandRequest, timeout?: number, timeoutDuration?: string, hostTimeoutDuration?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainMultiCommandExecuteResponseWrapper> {
    ...
    async batchCmdRaw(requestParameters: BatchCmdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainMultiCommandExecuteResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling batchCmd().'
            );
        }
     ...
     * Batch executes a RTR read-only command across the hosts mapped to the given batch ID.
     */
    async batchCmd(body: DomainBatchExecuteCommandRequest, timeout?: number, timeoutDuration?: string, hostTimeoutDuration?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainMultiCommandExecuteResponseWrapper> {
    ...
    async batchGetCmdRaw(requestParameters: BatchGetCmdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainBatchGetCommandResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling batchGetCmd().'
            );
        }
     ...
     * Batch executes `get` command across hosts to retrieve files. After this call is made `GET /real-time-response/combined/batch-get-command/v1` is used to query for the results.
     */
    async batchGetCmd(body: DomainBatchGetCommandRequest, timeout?: number, timeoutDuration?: string, hostTimeoutDuration?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainBatchGetCommandResponse> {
    ...
    async batchGetCmdStatusRaw(requestParameters: BatchGetCmdStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainBatchGetCmdStatusResponse>> {
        if (requestParameters['batchGetCmdReqId'] == null) {
            throw new runtime.RequiredError(
                'batchGetCmdReqId',
                'Required parameter "batchGetCmdReqId" was null or undefined when calling batchGetCmdStatus().'
            );
        }
     ...
     * Retrieves the status of the specified batch get command.  Will return successful files when they are finished processing.
     */
    async batchGetCmdStatus(batchGetCmdReqId: string, timeout?: number, timeoutDuration?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainBatchGetCmdStatusResponse> {
    ...
    async batchInitSessionsRaw(requestParameters: BatchInitSessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainBatchInitSessionResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling batchInitSessions().'
            );
        }
     ...
     * Batch initialize a RTR session on multiple hosts.  Before any RTR commands can be used, an active session is needed on the host.
     */
    async batchInitSessions(body: DomainBatchInitSessionRequest, timeout?: number, timeoutDuration?: string, hostTimeoutDuration?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainBatchInitSessionResponse> {
     ...
     */
    async batchRefreshSessionsRaw(requestParameters: BatchRefreshSessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainBatchRefreshSessionResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling batchRefreshSessions().'
            );
        }
     ...
     * Batch refresh a RTR session on multiple hosts. RTR sessions will expire after 10 minutes unless refreshed.
     */
    async batchRefreshSessions(body: DomainBatchRefreshSessionRequest, timeout?: number, timeoutDuration?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainBatchRefreshSessionResponse> {
    ...
    async rTRAggregateSessionsRaw(requestParameters: RTRAggregateSessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling rTRAggregateSessions().'
            );
        }
     ...
     */
    async rTRCheckActiveResponderCommandStatusRaw(requestParameters: RTRCheckActiveResponderCommandStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainStatusResponseWrapper>> {
        if (requestParameters['cloudRequestId'] == null) {
            throw new runtime.RequiredError(
                'cloudRequestId',
                'Required parameter "cloudRequestId" was null or undefined when calling rTRCheckActiveResponderCommandStatus().'
            );
        }
        ...
        if (requestParameters['sequenceId'] == null) {
            throw new runtime.RequiredError(
                'sequenceId',
                'Required parameter "sequenceId" was null or undefined when calling rTRCheckActiveResponderCommandStatus().'
            );
        }
     ...
     */
    async rTRCheckCommandStatusRaw(requestParameters: RTRCheckCommandStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainStatusResponseWrapper>> {
        if (requestParameters['cloudRequestId'] == null) {
            throw new runtime.RequiredError(
                'cloudRequestId',
                'Required parameter "cloudRequestId" was null or undefined when calling rTRCheckCommandStatus().'
            );
        }
        ...
        if (requestParameters['sequenceId'] == null) {
            throw new runtime.RequiredError(
                'sequenceId',
                'Required parameter "sequenceId" was null or undefined when calling rTRCheckCommandStatus().'
            );
        }
    ...
    async rTRDeleteFileRaw(requestParameters: RTRDeleteFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling rTRDeleteFile().'
            );
        }
        ...
        if (requestParameters['sessionId'] == null) {
            throw new runtime.RequiredError(
                'sessionId',
                'Required parameter "sessionId" was null or undefined when calling rTRDeleteFile().'
            );
        }
    ...
    async rTRDeleteFileV2Raw(requestParameters: RTRDeleteFileV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling rTRDeleteFileV2().'
            );
        }
        ...
        if (requestParameters['sessionId'] == null) {
            throw new runtime.RequiredError(
                'sessionId',
                'Required parameter "sessionId" was null or undefined when calling rTRDeleteFileV2().'
            );
        }
    ...
    async rTRDeleteQueuedSessionRaw(requestParameters: RTRDeleteQueuedSessionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['sessionId'] == null) {
            throw new runtime.RequiredError(
                'sessionId',
                'Required parameter "sessionId" was null or undefined when calling rTRDeleteQueuedSession().'
            );
        }
        ...
        if (requestParameters['cloudRequestId'] == null) {
            throw new runtime.RequiredError(
                'cloudRequestId',
                'Required parameter "cloudRequestId" was null or undefined when calling rTRDeleteQueuedSession().'
            );
        }
    ...
    async rTRDeleteSessionRaw(requestParameters: RTRDeleteSessionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['sessionId'] == null) {
            throw new runtime.RequiredError(
                'sessionId',
                'Required parameter "sessionId" was null or undefined when calling rTRDeleteSession().'
            );
        }
     ...
     */
    async rTRExecuteActiveResponderCommandRaw(requestParameters: RTRExecuteActiveResponderCommandRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainCommandExecuteResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling rTRExecuteActiveResponderCommand().'
            );
        }
     ...
     */
    async rTRExecuteCommandRaw(requestParameters: RTRExecuteCommandRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainCommandExecuteResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling rTRExecuteCommand().'
            );
        }
    ...
    async rTRGetExtractedFileContentsRaw(requestParameters: RTRGetExtractedFileContentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters['sessionId'] == null) {
            throw new runtime.RequiredError(
                'sessionId',
                'Required parameter "sessionId" was null or undefined when calling rTRGetExtractedFileContents().'
            );
        }
        ...
        if (requestParameters['sha256'] == null) {
            throw new runtime.RequiredError(
                'sha256',
                'Required parameter "sha256" was null or undefined when calling rTRGetExtractedFileContents().'
            );
        }
    ...
    async rTRInitSessionRaw(requestParameters: RTRInitSessionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainInitResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling rTRInitSession().'
            );
        }
    ...
    async rTRListFilesRaw(requestParameters: RTRListFilesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainListFilesResponseWrapper>> {
        if (requestParameters['sessionId'] == null) {
            throw new runtime.RequiredError(
                'sessionId',
                'Required parameter "sessionId" was null or undefined when calling rTRListFiles().'
            );
        }
    ...
    async rTRListFilesV2Raw(requestParameters: RTRListFilesV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainListFilesV2ResponseWrapper>> {
        if (requestParameters['sessionId'] == null) {
            throw new runtime.RequiredError(
                'sessionId',
                'Required parameter "sessionId" was null or undefined when calling rTRListFilesV2().'
            );
        }
     ...
     */
    async rTRListQueuedSessionsRaw(requestParameters: RTRListQueuedSessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainQueuedSessionResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling rTRListQueuedSessions().'
            );
        }
    ...
    async rTRListSessionsRaw(requestParameters: RTRListSessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainSessionResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling rTRListSessions().'
            );
        }
    ...
    async rTRPulseSessionRaw(requestParameters: RTRPulseSessionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainInitResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling rTRPulseSession().'
            );
        }
