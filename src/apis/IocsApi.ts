...
import type {
  ...
  IocapiMsaReplyIOCDevicesCount,
  IocapiMsaReplyProcessesRanOn,
  MsaReplyMetaOnly,
  ProcessesapiMsaProcessDetailResponse,
} from '../models/index';
import {
...
export class IocsApi extends runtime.BaseAPI {
    ...
    async devicesCountRaw(requestParameters: DevicesCountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IocapiMsaReplyIOCDevicesCount>> {
        if (requestParameters['type'] == null) {
            throw new runtime.RequiredError(
                'type',
                'Required parameter "type" was null or undefined when calling devicesCount().'
            );
        }
        ...
        if (requestParameters['value'] == null) {
            throw new runtime.RequiredError(
                'value',
                'Required parameter "value" was null or undefined when calling devicesCount().'
            );
        }
    ...
    async devicesRanOnRaw(requestParameters: DevicesRanOnRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IocapiMsaReplyDevicesRanOn>> {
        if (requestParameters['type'] == null) {
            throw new runtime.RequiredError(
                'type',
                'Required parameter "type" was null or undefined when calling devicesRanOn().'
            );
        }
        ...
        if (requestParameters['value'] == null) {
            throw new runtime.RequiredError(
                'value',
                'Required parameter "value" was null or undefined when calling devicesRanOn().'
            );
        }
     ...
     */
    async entitiesProcessesRaw(requestParameters: EntitiesProcessesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProcessesapiMsaProcessDetailResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling entitiesProcesses().'
            );
        }
    ...
    async processesRanOnRaw(requestParameters: ProcessesRanOnRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IocapiMsaReplyProcessesRanOn>> {
        if (requestParameters['type'] == null) {
            throw new runtime.RequiredError(
                'type',
                'Required parameter "type" was null or undefined when calling processesRanOn().'
            );
        }
        ...
        if (requestParameters['value'] == null) {
            throw new runtime.RequiredError(
                'value',
                'Required parameter "value" was null or undefined when calling processesRanOn().'
            );
        }
        ...
        if (requestParameters['deviceId'] == null) {
            throw new runtime.RequiredError(
                'deviceId',
                'Required parameter "deviceId" was null or undefined when calling processesRanOn().'
            );
        }
     ...
     * Search for processes associated with a custom IOC
     */
    async processesRanOn(type: string, value: string, deviceId: string, limit?: string, offset?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IocapiMsaReplyProcessesRanOn> {
