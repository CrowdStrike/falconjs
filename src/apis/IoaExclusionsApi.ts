...
export class IoaExclusionsApi extends runtime.BaseAPI {
     ...
     */
    async createIOAExclusionsV1Raw(requestParameters: CreateIOAExclusionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IoaExclusionsIoaExclusionsRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createIOAExclusionsV1().'
            );
        }
    ...
    async deleteIOAExclusionsV1Raw(requestParameters: DeleteIOAExclusionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling deleteIOAExclusionsV1().'
            );
        }
     ...
     */
    async getIOAExclusionsV1Raw(requestParameters: GetIOAExclusionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IoaExclusionsIoaExclusionsRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getIOAExclusionsV1().'
            );
        }
     ...
     * Search for IOA exclusions.
     */
    async queryIOAExclusionsV1(filter?: string, offset?: number, limit?: number, sort?: QueryIOAExclusionsV1SortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async updateIOAExclusionsV1Raw(requestParameters: UpdateIOAExclusionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IoaExclusionsIoaExclusionsRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateIOAExclusionsV1().'
            );
        }
