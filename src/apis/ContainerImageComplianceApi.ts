...
export interface ContainerImageComplianceApiExtAggregateClusterAssessmentsRequest {
    filter?: string;
}

export interface ContainerImageComplianceApiExtAggregateFailedContainersByRulesPathRequest {
    filter?: string;
}

export interface ContainerImageComplianceApiExtAggregateFailedContainersCountBySeverityRequest {
    filter?: string;
}

export interface ContainerImageComplianceApiExtAggregateFailedImagesByRulesPathRequest {
    filter?: string;
}

export interface ContainerImageComplianceApiExtAggregateFailedImagesCountBySeverityRequest {
    filter?: string;
}

export interface ContainerImageComplianceApiExtAggregateFailedRulesByClustersRequest {
    filter?: string;
}

export interface ContainerImageComplianceApiExtAggregateFailedRulesByImagesRequest {
    filter?: string;
}

export interface ContainerImageComplianceApiExtAggregateFailedRulesCountBySeverityRequest {
    filter?: string;
}

export interface ContainerImageComplianceApiExtAggregateImageAssessmentsRequest {
    filter?: string;
    after?: string;
    limit?: string;
}

export interface ContainerImageComplianceApiExtAggregateRulesAssessmentsRequest {
    filter?: string;
}

export interface ContainerImageComplianceApiExtAggregateRulesByStatusRequest {
    filter?: string;
}
