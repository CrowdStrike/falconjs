...
import {
    MainDiscoveryResponseV2FromJSON,
    MainDiscoveryResponseV2ToJSON,
...
export class EventStreamsApi extends runtime.BaseAPI {
     ...
     */
    async listAvailableStreamsOAuth2Raw(requestParameters: ListAvailableStreamsOAuth2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MainDiscoveryResponseV2>> {
        if (requestParameters['appId'] == null) {
            throw new runtime.RequiredError(
                'appId',
                'Required parameter "appId" was null or undefined when calling listAvailableStreamsOAuth2().'
            );
        }
     ...
     */
    async refreshActiveStreamSessionRaw(requestParameters: RefreshActiveStreamSessionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling refreshActiveStreamSession().'
            );
        }
        ...
        if (requestParameters['appId'] == null) {
            throw new runtime.RequiredError(
                'appId',
                'Required parameter "appId" was null or undefined when calling refreshActiveStreamSession().'
            );
        }
        ...
        if (requestParameters['partition'] == null) {
            throw new runtime.RequiredError(
                'partition',
                'Required parameter "partition" was null or undefined when calling refreshActiveStreamSession().'
            );
        }
