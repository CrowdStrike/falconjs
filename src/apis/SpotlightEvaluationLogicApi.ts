...
export class SpotlightEvaluationLogicApi extends runtime.BaseAPI {
     ...
     */
    async combinedQueryEvaluationLogicRaw(requestParameters: CombinedQueryEvaluationLogicRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainSPAPIEvaluationLogicCombinedResponseV1>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling combinedQueryEvaluationLogic().'
            );
        }
     ...
     * Search for evaluation logic in your environment by providing a FQL filter and paging details. Returns a set of evaluation logic entities which match the filter criteria.
     */
    async combinedQueryEvaluationLogic(filter: string, after?: string, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainSPAPIEvaluationLogicCombinedResponseV1> {
     ...
     */
    async getEvaluationLogicRaw(requestParameters: GetEvaluationLogicRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainSPAPIEvaluationLogicEntitiesResponseV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getEvaluationLogic().'
            );
        }
    ...
    async queryEvaluationLogicRaw(requestParameters: QueryEvaluationLogicRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainSPAPIQueryResponse>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling queryEvaluationLogic().'
            );
        }
