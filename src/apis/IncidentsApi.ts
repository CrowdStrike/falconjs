...
export class IncidentsApi extends runtime.BaseAPI {
     ...
     * Query environment wide CrowdScore and return the entity data
     */
    async crowdScore(filter?: string, offset?: number, limit?: number, sort?: CrowdScoreSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainMsaEnvironmentScoreResponse> {
    ...
    async getBehaviorsRaw(requestParameters: GetBehaviorsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainMsaExternalBehaviorResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getBehaviors().'
            );
        }
    ...
    async getIncidentsRaw(requestParameters: GetIncidentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainMsaExternalIncidentResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getIncidents().'
            );
        }
     ...
     */
    async performIncidentActionRaw(requestParameters: PerformIncidentActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainMsaIncidentPerformActionResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling performIncidentAction().'
            );
        }
     ...
     * Perform a set of actions on one or more incidents, such as adding tags or comments or updating the incident name or description
     */
    async performIncidentAction(body: DomainEntityActionRequest, updateDetects?: boolean, overwriteDetects?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainMsaIncidentPerformActionResponse> {
     ...
     * Search for incidents by providing an FQL filter, sorting, and paging details
     */
    async queryIncidents(sort?: QueryIncidentsSortEnum, filter?: string, offset?: number, limit?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainMsaIncidentQueryResponse> {
