...
export class SensorUpdatePoliciesApi extends runtime.BaseAPI {
     ...
     */
    async createSensorUpdatePoliciesRaw(requestParameters: CreateSensorUpdatePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createSensorUpdatePolicies().'
            );
        }
     ...
     */
    async createSensorUpdatePoliciesV2Raw(requestParameters: CreateSensorUpdatePoliciesV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateRespV2>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createSensorUpdatePoliciesV2().'
            );
        }
     ...
     */
    async deleteSensorUpdatePoliciesRaw(requestParameters: DeleteSensorUpdatePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling deleteSensorUpdatePolicies().'
            );
        }
    ...
    async getSensorUpdatePoliciesRaw(requestParameters: GetSensorUpdatePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getSensorUpdatePolicies().'
            );
        }
     ...
     */
    async getSensorUpdatePoliciesV2Raw(requestParameters: GetSensorUpdatePoliciesV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateRespV2>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getSensorUpdatePoliciesV2().'
            );
        }
     ...
     */
    async performSensorUpdatePoliciesActionRaw(requestParameters: PerformSensorUpdatePoliciesActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateRespV1>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling performSensorUpdatePoliciesAction().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling performSensorUpdatePoliciesAction().'
            );
        }
     ...
     * Perform the specified action on the Sensor Update Policies specified in the request
     */
    async performSensorUpdatePoliciesAction(actionName: PerformSensorUpdatePoliciesActionActionNameEnum, body: MsaEntityActionRequestV2, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SensorUpdateRespV1> {
     ...
     */
    async queryCombinedSensorUpdateBuildsRaw(requestParameters: QueryCombinedSensorUpdateBuildsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateBuildsRespV1>> {
        const queryParameters: any = {};
     ...
     * Retrieve available builds for use with Sensor Update Policies
     */
    async queryCombinedSensorUpdateBuilds(platform?: QueryCombinedSensorUpdateBuildsPlatformEnum, stage?: QueryCombinedSensorUpdateBuildsStageEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SensorUpdateBuildsRespV1> {
     ...
     */
    async queryCombinedSensorUpdateKernelsRaw(requestParameters: QueryCombinedSensorUpdateKernelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateKernelsRespV1>> {
        const queryParameters: any = {};
     ...
     */
    async queryCombinedSensorUpdatePoliciesRaw(requestParameters: QueryCombinedSensorUpdatePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for Sensor Update Policies in your environment by providing an FQL filter and paging details. Returns a set of Sensor Update Policies which match the filter criteria
     */
    async queryCombinedSensorUpdatePolicies(filter?: string, offset?: number, limit?: number, sort?: QueryCombinedSensorUpdatePoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SensorUpdateRespV1> {
     ...
     */
    async queryCombinedSensorUpdatePoliciesV2Raw(requestParameters: QueryCombinedSensorUpdatePoliciesV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateRespV2>> {
        const queryParameters: any = {};
     ...
     * Search for Sensor Update Policies with additional support for uninstall protection in your environment by providing an FQL filter and paging details. Returns a set of Sensor Update Policies which match the filter criteria
     */
    async queryCombinedSensorUpdatePoliciesV2(filter?: string, offset?: number, limit?: number, sort?: QueryCombinedSensorUpdatePoliciesV2SortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SensorUpdateRespV2> {
     ...
     */
    async queryCombinedSensorUpdatePolicyMembersRaw(requestParameters: QueryCombinedSensorUpdatePolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BasePolicyMembersRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Sensor Update Policy in your environment by providing an FQL filter and paging details. Returns a set of host details which match the filter criteria
     */
    async queryCombinedSensorUpdatePolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BasePolicyMembersRespV1> {
     ...
     * Retrieve kernel compatibility info for Sensor Update Builds
     */
    async querySensorUpdateKernelsDistinctRaw(requestParameters: QuerySensorUpdateKernelsDistinctRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['distinctField'] == null) {
            throw new runtime.RequiredError(
                'distinctField',
                'Required parameter "distinctField" was null or undefined when calling querySensorUpdateKernelsDistinct().'
            );
        }
     ...
     * Retrieve kernel compatibility info for Sensor Update Builds
     */
    async querySensorUpdateKernelsDistinct(distinctField: string, filter?: string, offset?: number, limit?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async querySensorUpdatePoliciesRaw(requestParameters: QuerySensorUpdatePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Search for Sensor Update Policies in your environment by providing an FQL filter and paging details. Returns a set of Sensor Update Policy IDs which match the filter criteria
     */
    async querySensorUpdatePolicies(filter?: string, offset?: number, limit?: number, sort?: QuerySensorUpdatePoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async querySensorUpdatePolicyMembersRaw(requestParameters: QuerySensorUpdatePolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Sensor Update Policy in your environment by providing an FQL filter and paging details. Returns a set of Agent IDs which match the filter criteria
     */
    async querySensorUpdatePolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
    ...
    async revealUninstallTokenRaw(requestParameters: RevealUninstallTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UninstallTokenRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling revealUninstallToken().'
            );
        }
     ...
     */
    async setSensorUpdatePoliciesPrecedenceRaw(requestParameters: SetSensorUpdatePoliciesPrecedenceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling setSensorUpdatePoliciesPrecedence().'
            );
        }
     ...
     */
    async updateSensorUpdatePoliciesRaw(requestParameters: UpdateSensorUpdatePoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateSensorUpdatePolicies().'
            );
        }
     ...
     */
    async updateSensorUpdatePoliciesV2Raw(requestParameters: UpdateSensorUpdatePoliciesV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SensorUpdateRespV2>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateSensorUpdatePoliciesV2().'
            );
        }
