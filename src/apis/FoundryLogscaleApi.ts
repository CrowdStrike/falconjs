...
export interface CreateSavedSearchesDynamicExecuteAltV1Request {
...
export interface CreateSavedSearchesExecuteAltV1Request {
...
export interface CreateSavedSearchesIngestAltV1Request {
    appId?: string;
}
...
export interface GetSavedSearchesExecuteAltV1Request {
    jobId: string;
    appId?: string;
    inferJsonTypes?: boolean;
    limit?: string;
...
export interface IngestDataAsyncV1Request {
    dataContent?: string;
    dataFile?: Blob;
    repo?: string;
    tag?: Array<string>;
...
export class FoundryLogscaleApi extends runtime.BaseAPI {
     ...
     */
    async createSavedSearchesDynamicExecuteAltV1Raw(requestParameters: CreateSavedSearchesDynamicExecuteAltV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApidomainQueryResponseWrapperV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createSavedSearchesDynamicExecuteAltV1().'
            );
        }
     ...
     * Execute a dynamic saved search
     */
    async createSavedSearchesDynamicExecuteAltV1(body: ApidomainDynamicExecuteSearchRequestV1, appId?: string, includeSchemaGeneration?: boolean, includeTestData?: boolean, inferJsonTypes?: boolean, matchResponseSchema?: boolean, metadata?: boolean, mode?: CreateSavedSearchesDynamicExecuteAltV1ModeEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApidomainQueryResponseWrapperV1> {
        const response = await this.createSavedSearchesDynamicExecuteAltV1Raw({ body: body, appId: appId, includeSchemaGeneration: includeSchemaGeneration, includeTestData: includeTestData, inferJsonTypes: inferJsonTypes, matchResponseSchema: matchResponseSchema, metadata: metadata, mode: mode }, initOverrides);
     ...
     */
    async createSavedSearchesExecuteAltV1Raw(requestParameters: CreateSavedSearchesExecuteAltV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApidomainQueryResponseWrapperV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createSavedSearchesExecuteAltV1().'
            );
        }
     ...
     * Execute a saved search
     */
    async createSavedSearchesExecuteAltV1(body: ApidomainSavedSearchExecuteRequestV1, appId?: string, detailed?: boolean, includeTestData?: boolean, inferJsonTypes?: boolean, matchResponseSchema?: boolean, metadata?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApidomainQueryResponseWrapperV1> {
        const response = await this.createSavedSearchesExecuteAltV1Raw({ body: body, appId: appId, detailed: detailed, includeTestData: includeTestData, inferJsonTypes: inferJsonTypes, matchResponseSchema: matchResponseSchema, metadata: metadata }, initOverrides);
        return await response.value();
    }
     ...
     */
    async createSavedSearchesIngestAltV1Raw(requestParameters: CreateSavedSearchesIngestAltV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientDataIngestResponseWrapperV1>> {
        const queryParameters: any = {};
     ...
     */
    async downloadResultsRaw(requestParameters: DownloadResultsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters['jobId'] == null) {
            throw new runtime.RequiredError(
                'jobId',
                'Required parameter "jobId" was null or undefined when calling downloadResults().'
            );
        }
     ...
     * Execute a saved search
     */
    async execute(body: ApidomainSavedSearchExecuteRequestV1, appId?: string, detailed?: boolean, includeTestData?: boolean, inferJsonTypes?: boolean, matchResponseSchema?: boolean, metadata?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApidomainQueryResponseWrapperV1> {
        const response = await this.executeRaw({ body: body, appId: appId, detailed: detailed, includeTestData: includeTestData, inferJsonTypes: inferJsonTypes, matchResponseSchema: matchResponseSchema, metadata: metadata }, initOverrides);
        return await response.value();
    }
    ...
    async executeDynamicRaw(requestParameters: ExecuteDynamicRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApidomainQueryResponseWrapperV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling executeDynamic().'
            );
        }
     ...
     * Execute a dynamic saved search
     */
    async executeDynamic(body: ApidomainDynamicExecuteSearchRequestV1, appId?: string, includeSchemaGeneration?: boolean, includeTestData?: boolean, inferJsonTypes?: boolean, matchResponseSchema?: boolean, metadata?: boolean, mode?: ExecuteDynamicModeEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApidomainQueryResponseWrapperV1> {
        const response = await this.executeDynamicRaw({ body: body, appId: appId, includeSchemaGeneration: includeSchemaGeneration, includeTestData: includeTestData, inferJsonTypes: inferJsonTypes, matchResponseSchema: matchResponseSchema, metadata: metadata, mode: mode }, initOverrides);
        return await response.value();
    }
     ...
     */
    async getSavedSearchesExecuteAltV1Raw(requestParameters: GetSavedSearchesExecuteAltV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApidomainQueryResponseWrapperV1>> {
        if (requestParameters['jobId'] == null) {
            throw new runtime.RequiredError(
                'jobId',
                'Required parameter "jobId" was null or undefined when calling getSavedSearchesExecuteAltV1().'
            );
        }
     ...
     * Get the results of a saved search
     */
    async getSavedSearchesExecuteAltV1(jobId: string, appId?: string, inferJsonTypes?: boolean, limit?: string, matchResponseSchema?: boolean, metadata?: boolean, offset?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApidomainQueryResponseWrapperV1> {
        const response = await this.getSavedSearchesExecuteAltV1Raw({ jobId: jobId, appId: appId, inferJsonTypes: inferJsonTypes, limit: limit, matchResponseSchema: matchResponseSchema, metadata: metadata, offset: offset }, initOverrides);
        return await response.value();
    }
     ...
     * Get the results of a saved search as a file
     */
    async getSavedSearchesJobResultsDownloadAltV1Raw(requestParameters: GetSavedSearchesJobResultsDownloadAltV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters['jobId'] == null) {
            throw new runtime.RequiredError(
                'jobId',
                'Required parameter "jobId" was null or undefined when calling getSavedSearchesJobResultsDownloadAltV1().'
            );
        }
     ...
     * Get the results of a saved search as a file
     */
    async getSavedSearchesJobResultsDownloadAltV1(jobId: string, inferJsonTypes?: boolean, resultFormat?: GetSavedSearchesJobResultsDownloadAltV1ResultFormatEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
     ...
     * Get the results of a saved search
     */
    async getSearchResultsRaw(requestParameters: GetSearchResultsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApidomainQueryResponseWrapperV1>> {
        if (requestParameters['jobId'] == null) {
            throw new runtime.RequiredError(
                'jobId',
                'Required parameter "jobId" was null or undefined when calling getSearchResults().'
            );
        }
     ...
     * Get the results of a saved search
     */
    async getSearchResults(jobId: string, appId?: string, inferJsonTypes?: boolean, limit?: string, matchResponseSchema?: boolean, metadata?: boolean, offset?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApidomainQueryResponseWrapperV1> {
        const response = await this.getSearchResultsRaw({ jobId: jobId, appId: appId, inferJsonTypes: inferJsonTypes, limit: limit, matchResponseSchema: matchResponseSchema, metadata: metadata, offset: offset }, initOverrides);
        return await response.value();
    }
     ...
     */
    async ingestDataRaw(requestParameters: IngestDataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientDataIngestResponseWrapperV1>> {
        const queryParameters: any = {};
     ...
     * Synchronously ingest data into the application repository
     */
    async ingestData(dataContent?: string, dataFile?: Blob, tag?: Array<string>, tagSource?: string, testData?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ClientDataIngestResponseWrapperV1> {
     ...
     */
    async ingestDataAsyncV1Raw(requestParameters: IngestDataAsyncV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientDataIngestResponseWrapperV1>> {
        const queryParameters: any = {};
     ...
     * Asynchronously ingest data into the application repository
     */
    async ingestDataAsyncV1(dataContent?: string, dataFile?: Blob, repo?: string, tag?: Array<string>, tagSource?: string, testData?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ClientDataIngestResponseWrapperV1> {
     ...
     * Populate a saved search
     */
    async populateRaw(requestParameters: PopulateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientDataIngestResponseWrapperV1>> {
        const queryParameters: any = {};
...
export type GetSavedSearchesJobResultsDownloadAltV1ResultFormatEnum = typeof GetSavedSearchesJobResultsDownloadAltV1ResultFormatEnum[keyof typeof GetSavedSearchesJobResultsDownloadAltV1ResultFormatEnum];
