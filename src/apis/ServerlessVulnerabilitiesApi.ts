...
import type { MsaReplyMetaOnly, MsaspecResponseFields, VulnerabilitiesVulnerabilityEntitySARIFResponse } from "../models/index";
import {
    MsaReplyMetaOnlyFromJSON,
    MsaReplyMetaOnlyToJSON,
    MsaspecResponseFieldsFromJSON,
    MsaspecResponseFieldsToJSON,
    VulnerabilitiesVulnerabilityEntitySARIFResponseFromJSON,
    VulnerabilitiesVulnerabilityEntitySARIFResponseToJSON,
} from "../models/index";

export interface ServerlessVulnerabilitiesApiGetCombinedVulnerabilitiesSARIFRequest {
    filter?: string;
    limit?: number;
    offset?: number;
    sort?: string;
...
export class ServerlessVulnerabilitiesApi extends runtime.BaseAPI {
     ...
     * Retrieve all lambda vulnerabilities that match the given query and return in the SARIF format
     */
    async getCombinedVulnerabilitiesSARIF(
        filter?: string,
        limit?: number,
        offset?: number,
        sort?: string,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<VulnerabilitiesVulnerabilityEntitySARIFResponse> {
        const response = await this.getCombinedVulnerabilitiesSARIFRaw({ filter: filter, limit: limit, offset: offset, sort: sort }, initOverrides);
