...
export interface AggregatePreventionPolicyRequest {
    body: Array<MsaAggregateQueryRequest>;
}
...
export interface AggregateSensorUpdatePolicyRequest {
    body: Array<MsaAggregateQueryRequest>;
}

export interface AggregateSupportIssuesRequest {
    body: Array<MsaAggregateQueryRequest>;
}

export interface AggregateTotalDeviceCountsRequest {
    body: Array<MsaAggregateQueryRequest>;
}
...
export class FalconCompleteDashboardApi extends runtime.BaseAPI {
    ...
    async aggregateAlertsRaw(requestParameters: AggregateAlertsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateAlerts().'
            );
        }
    ...
    async aggregateAllowListRaw(requestParameters: AggregateAllowListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateAllowList().'
            );
        }
    ...
    async aggregateBlockListRaw(requestParameters: AggregateBlockListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateBlockList().'
            );
        }
    ...
    async aggregateDetectionsRaw(requestParameters: AggregateDetectionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateDetections().'
            );
        }
     ...
     */
    async aggregateDeviceCountCollectionRaw(requestParameters: AggregateDeviceCountCollectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateDeviceCountCollection().'
            );
        }
    ...
    async aggregateEscalationsRaw(requestParameters: AggregateEscalationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateEscalations().'
            );
        }
    ...
    async aggregateFCIncidentsRaw(requestParameters: AggregateFCIncidentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateFCIncidents().'
            );
        }
     ...
     */
    async aggregatePreventionPolicyRaw(requestParameters: AggregatePreventionPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregatePreventionPolicy().'
            );
        }
    ...
    async aggregateRemediationsRaw(requestParameters: AggregateRemediationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateRemediations().'
            );
        }
     ...
     */
    async aggregateSensorUpdatePolicyRaw(requestParameters: AggregateSensorUpdatePolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateSensorUpdatePolicy().'
            );
        }
     ...
     */
    async aggregateSupportIssuesRaw(requestParameters: AggregateSupportIssuesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateSupportIssues().'
            );
        }
     ...
     */
    async aggregateTotalDeviceCountsRaw(requestParameters: AggregateTotalDeviceCountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateTotalDeviceCounts().'
            );
        }
     ...
     */
    async getDeviceCountCollectionQueriesByFilterRaw(requestParameters: GetDeviceCountCollectionQueriesByFilterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Retrieve device count collection Ids that match the provided FQL filter, criteria with scrolling enabled
     */
    async getDeviceCountCollectionQueriesByFilter(limit?: number, sort?: string, filter?: string, offset?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async queryDetectionIdsByFilterRaw(requestParameters: QueryDetectionIdsByFilterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
