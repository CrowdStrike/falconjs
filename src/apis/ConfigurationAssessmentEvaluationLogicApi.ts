...
import type {
  DomainAPIEvaluationLogicEntitiesResponseV1,
  MsaReplyMetaOnly,
} from '../models/index';
import {
    DomainAPIEvaluationLogicEntitiesResponseV1FromJSON,
    DomainAPIEvaluationLogicEntitiesResponseV1ToJSON,
...
export class ConfigurationAssessmentEvaluationLogicApi extends runtime.BaseAPI {
     ...
     */
    async getEvaluationLogicMixin0Raw(requestParameters: GetEvaluationLogicMixin0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainAPIEvaluationLogicEntitiesResponseV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getEvaluationLogicMixin0().'
            );
        }
