...
export interface IndicatorGetDeviceCountV1Request {
    type: string;
    value: string;
}
...
export class IocApi extends runtime.BaseAPI {
    ...
    async getIndicatorsReportRaw(requestParameters: GetIndicatorsReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaEntitiesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getIndicatorsReport().'
            );
        }
    ...
    async indicatorAggregateV1Raw(requestParameters: IndicatorAggregateV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling indicatorAggregateV1().'
            );
        }
     ...
     * Get Combined for Indicators.
     */
    async indicatorCombinedV1(filter?: string, offset?: number, limit?: number, sort?: IndicatorCombinedV1SortEnum, after?: string, fromParent?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiIndicatorRespV1> {
    ...
    async indicatorCreateV1Raw(requestParameters: IndicatorCreateV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiIndicatorRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling indicatorCreateV1().'
            );
        }
     ...
     * Delete Indicators by ids.
     */
    async indicatorDeleteV1(filter?: string, ids?: Array<string>, comment?: string, fromParent?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiIndicatorQueryRespV1> {
     ...
     */
    async indicatorGetDeviceCountV1Raw(requestParameters: IndicatorGetDeviceCountV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiDeviceCountRespV1>> {
        if (requestParameters['type'] == null) {
            throw new runtime.RequiredError(
                'type',
                'Required parameter "type" was null or undefined when calling indicatorGetDeviceCountV1().'
            );
        }
        ...
        if (requestParameters['value'] == null) {
            throw new runtime.RequiredError(
                'value',
                'Required parameter "value" was null or undefined when calling indicatorGetDeviceCountV1().'
            );
        }
     ...
     */
    async indicatorGetDevicesRanOnV1Raw(requestParameters: IndicatorGetDevicesRanOnV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiDevicesRanOnRespV1>> {
        if (requestParameters['type'] == null) {
            throw new runtime.RequiredError(
                'type',
                'Required parameter "type" was null or undefined when calling indicatorGetDevicesRanOnV1().'
            );
        }
        ...
        if (requestParameters['value'] == null) {
            throw new runtime.RequiredError(
                'value',
                'Required parameter "value" was null or undefined when calling indicatorGetDevicesRanOnV1().'
            );
        }
     ...
     */
    async indicatorGetProcessesRanOnV1Raw(requestParameters: IndicatorGetProcessesRanOnV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiProcessesRanOnRespV1>> {
        if (requestParameters['type'] == null) {
            throw new runtime.RequiredError(
                'type',
                'Required parameter "type" was null or undefined when calling indicatorGetProcessesRanOnV1().'
            );
        }
        ...
        if (requestParameters['value'] == null) {
            throw new runtime.RequiredError(
                'value',
                'Required parameter "value" was null or undefined when calling indicatorGetProcessesRanOnV1().'
            );
        }
        ...
        if (requestParameters['deviceId'] == null) {
            throw new runtime.RequiredError(
                'deviceId',
                'Required parameter "deviceId" was null or undefined when calling indicatorGetProcessesRanOnV1().'
            );
        }
     ...
     * Get the number of processes the indicator has run on
     */
    async indicatorGetProcessesRanOnV1(type: string, value: string, deviceId: string, limit?: string, offset?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiProcessesRanOnRespV1> {
    ...
    async indicatorGetV1Raw(requestParameters: IndicatorGetV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiIndicatorRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling indicatorGetV1().'
            );
        }
     ...
     * Search for Indicators.
     */
    async indicatorSearchV1(filter?: string, offset?: number, limit?: number, sort?: IndicatorSearchV1SortEnum, after?: string, fromParent?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiIndicatorQueryRespV1> {
    ...
    async indicatorUpdateV1Raw(requestParameters: IndicatorUpdateV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiIndicatorRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling indicatorUpdateV1().'
            );
        }
