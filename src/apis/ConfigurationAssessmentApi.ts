...
import type {
  DomainAPICombinedFindingsResponseV1,
  DomainAPIRuleDetailsResponseV1,
  MsaReplyMetaOnly,
} from '../models/index';
import {
...
export interface GetRuleDetailsRequest {
    ids: Array<string>;
}
...
export class ConfigurationAssessmentApi extends runtime.BaseAPI {
     ...
     */
    async getCombinedAssessmentsQueryRaw(requestParameters: GetCombinedAssessmentsQueryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainAPICombinedFindingsResponseV1>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling getCombinedAssessmentsQuery().'
            );
        }
     ...
     * Search for assessments in your environment by providing an FQL filter and paging details. Returns a set of HostFinding entities which match the filter criteria
     */
    async getCombinedAssessmentsQuery(filter: string, after?: string, limit?: number, sort?: string, facet?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainAPICombinedFindingsResponseV1> {
     ...
     */
    async getRuleDetailsRaw(requestParameters: GetRuleDetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainAPIRuleDetailsResponseV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getRuleDetails().'
            );
        }
