...
export class MalqueryApi extends runtime.BaseAPI {
    ...
    async getMalQueryDownloadV1Raw(requestParameters: GetMalQueryDownloadV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getMalQueryDownloadV1().'
            );
        }
     ...
     */
    async getMalQueryEntitiesSamplesFetchV1Raw(requestParameters: GetMalQueryEntitiesSamplesFetchV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getMalQueryEntitiesSamplesFetchV1().'
            );
        }
     ...
     */
    async getMalQueryMetadataV1Raw(requestParameters: GetMalQueryMetadataV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MalquerySampleMetadataResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getMalQueryMetadataV1().'
            );
        }
    ...
    async getMalQueryRequestV1Raw(requestParameters: GetMalQueryRequestV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MalqueryRequestResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getMalQueryRequestV1().'
            );
        }
     ...
     */
    async postMalQueryEntitiesSamplesMultidownloadV1Raw(requestParameters: PostMalQueryEntitiesSamplesMultidownloadV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MalqueryExternalQueryResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling postMalQueryEntitiesSamplesMultidownloadV1().'
            );
        }
     ...
     */
    async postMalQueryExactSearchV1Raw(requestParameters: PostMalQueryExactSearchV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MalqueryExternalQueryResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling postMalQueryExactSearchV1().'
            );
        }
     ...
     */
    async postMalQueryFuzzySearchV1Raw(requestParameters: PostMalQueryFuzzySearchV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MalqueryFuzzySearchResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling postMalQueryFuzzySearchV1().'
            );
        }
    ...
    async postMalQueryHuntV1Raw(requestParameters: PostMalQueryHuntV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MalqueryExternalQueryResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling postMalQueryHuntV1().'
            );
        }
