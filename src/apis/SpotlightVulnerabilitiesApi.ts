...
export class SpotlightVulnerabilitiesApi extends runtime.BaseAPI {
     ...
     */
    async combinedQueryVulnerabilitiesRaw(requestParameters: CombinedQueryVulnerabilitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainSPAPICombinedVulnerabilitiesResponse>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling combinedQueryVulnerabilities().'
            );
        }
     ...
     * Search for Vulnerabilities in your environment by providing an FQL filter and paging details. Returns a set of Vulnerability entities which match the filter criteria
     */
    async combinedQueryVulnerabilities(filter: string, after?: string, limit?: number, sort?: string, facet?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainSPAPICombinedVulnerabilitiesResponse> {
     ...
     */
    async getRemediationsV2Raw(requestParameters: GetRemediationsV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainSPAPIRemediationEntitiesResponseV2>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getRemediationsV2().'
            );
        }
     ...
     */
    async getVulnerabilitiesRaw(requestParameters: GetVulnerabilitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainSPAPIVulnerabilitiesEntitiesResponseV2>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getVulnerabilities().'
            );
        }
    ...
    async queryVulnerabilitiesRaw(requestParameters: QueryVulnerabilitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainSPAPIQueryResponse>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling queryVulnerabilities().'
            );
        }
