...
export class FalconxSandboxApi extends runtime.BaseAPI {
     ...
     */
    async deleteReportRaw(requestParameters: DeleteReportRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<FalconxQueryResponse>> {
     ...
     * Delete report based on the report ID. Operation can be checked for success by polling for the report ID on the report-summaries endpoint.
     */
    async deleteReport(ids: string, initOverrides?: RequestInit): Promise<FalconxQueryResponse> {
     ...
     */
    async deleteSampleV2Raw(requestParameters: DeleteSampleV2Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Removes a sample, including file, meta and submissions from the collection
     */
    async deleteSampleV2(ids: string, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async getArtifactsRaw(requestParameters: GetArtifactsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Download IOC packs, PCAP files, and other analysis artifacts.
     */
    async getArtifacts(id: string, name?: string, acceptEncoding?: string, initOverrides?: RequestInit): Promise<void> {
     ...
     */
    async getReportsRaw(requestParameters: GetReportsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<FalconxReportV1Response>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Get a full sandbox report.
     */
    async getReports(ids: Array<string>, initOverrides?: RequestInit): Promise<FalconxReportV1Response> {
     ...
     */
    async getSampleV2Raw(requestParameters: GetSampleV2Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Retrieves the file associated with the given ID (SHA256)
     */
    async getSampleV2(ids: string, passwordProtected?: boolean, initOverrides?: RequestInit): Promise<string> {
     ...
     */
    async getSubmissionsRaw(requestParameters: GetSubmissionsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<FalconxSubmissionV1Response>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Check the status of a sandbox analysis. Time required for analysis varies but is usually less than 15 minutes.
     */
    async getSubmissions(ids: Array<string>, initOverrides?: RequestInit): Promise<FalconxSubmissionV1Response> {
     ...
     */
    async getSummaryReportsRaw(requestParameters: GetSummaryReportsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<FalconxSummaryReportV1Response>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Get a short summary version of a sandbox report.
     */
    async getSummaryReports(ids: Array<string>, initOverrides?: RequestInit): Promise<FalconxSummaryReportV1Response> {
     ...
     */
    async queryReportsRaw(requestParameters: QueryReportsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Find sandbox reports by providing an FQL filter and paging details. Returns a set of report IDs that match your criteria.
     */
    async queryReports(filter?: string, offset?: string, limit?: number, sort?: string, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async querySampleV1Raw(requestParameters: QuerySampleV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
     ...
     * Retrieves a list with sha256 of samples that exist and customer has rights to access them, maximum number of accepted items is 200
     */
    async querySampleV1(body: ClientQuerySamplesRequest, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async querySubmissionsRaw(requestParameters: QuerySubmissionsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Find submission IDs for uploaded files by providing an FQL filter and paging details. Returns a set of submission IDs that match your criteria.
     */
    async querySubmissions(filter?: string, offset?: string, limit?: number, sort?: string, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async submitRaw(requestParameters: SubmitRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<FalconxSubmissionV1Response>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * Submit an uploaded file or a URL for sandbox analysis. Time required for analysis varies but is usually less than 15 minutes.
     */
    async submit(body: FalconxSubmissionParametersV1, initOverrides?: RequestInit): Promise<FalconxSubmissionV1Response> {
     ...
     */
    async uploadSampleV2Raw(requestParameters: UploadSampleV2Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ClientSampleMetadataResponseV2>> {
     ...
     * Upload a file for sandbox analysis. After uploading, use `/falconx/entities/submissions/v1` to start analyzing the file.
     */
    async uploadSampleV2(sample: Blob, fileName: string, comment?: string, isConfidential?: boolean, initOverrides?: RequestInit): Promise<ClientSampleMetadataResponseV2> {
