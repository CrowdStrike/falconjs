...
export class RealTimeResponseAdminApi extends runtime.BaseAPI {
     ...
     */
    async batchAdminCmdRaw(requestParameters: BatchAdminCmdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainMultiCommandExecuteResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling batchAdminCmd().'
            );
        }
     ...
     * Batch executes a RTR administrator command across the hosts mapped to the given batch ID.
     */
    async batchAdminCmd(body: DomainBatchExecuteCommandRequest, timeout?: number, timeoutDuration?: string, hostTimeoutDuration?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainMultiCommandExecuteResponseWrapper> {
     ...
     */
    async rTRCheckAdminCommandStatusRaw(requestParameters: RTRCheckAdminCommandStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainStatusResponseWrapper>> {
        if (requestParameters['cloudRequestId'] == null) {
            throw new runtime.RequiredError(
                'cloudRequestId',
                'Required parameter "cloudRequestId" was null or undefined when calling rTRCheckAdminCommandStatus().'
            );
        }
        ...
        if (requestParameters['sequenceId'] == null) {
            throw new runtime.RequiredError(
                'sequenceId',
                'Required parameter "sequenceId" was null or undefined when calling rTRCheckAdminCommandStatus().'
            );
        }
    ...
    async rTRCreatePutFilesRaw(requestParameters: RTRCreatePutFilesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['file'] == null) {
            throw new runtime.RequiredError(
                'file',
                'Required parameter "file" was null or undefined when calling rTRCreatePutFiles().'
            );
        }
        ...
        if (requestParameters['description'] == null) {
            throw new runtime.RequiredError(
                'description',
                'Required parameter "description" was null or undefined when calling rTRCreatePutFiles().'
            );
        }
    ...
    async rTRCreateScriptsRaw(requestParameters: RTRCreateScriptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['description'] == null) {
            throw new runtime.RequiredError(
                'description',
                'Required parameter "description" was null or undefined when calling rTRCreateScripts().'
            );
        }
        ...
        if (requestParameters['permissionType'] == null) {
            throw new runtime.RequiredError(
                'permissionType',
                'Required parameter "permissionType" was null or undefined when calling rTRCreateScripts().'
            );
        }
     ...
     * Upload a new custom-script to use for the RTR `runscript` command.
     */
    async rTRCreateScripts(description: string, permissionType: string, file?: Blob, name?: string, commentsForAuditLog?: string, content?: string, platform?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaReplyMetaOnly> {
        const response = await this.rTRCreateScriptsRaw({ description: description, permissionType: permissionType, file: file, name: name, commentsForAuditLog: commentsForAuditLog, content: content, platform: platform }, initOverrides);
        return await response.value();
    }
    ...
    async rTRDeletePutFilesRaw(requestParameters: RTRDeletePutFilesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling rTRDeletePutFiles().'
            );
        }
    ...
    async rTRDeleteScriptsRaw(requestParameters: RTRDeleteScriptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling rTRDeleteScripts().'
            );
        }
     ...
     */
    async rTRExecuteAdminCommandRaw(requestParameters: RTRExecuteAdminCommandRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainCommandExecuteResponseWrapper>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling rTRExecuteAdminCommand().'
            );
        }
     ...
     */
    async rTRGetFalconScriptsRaw(requestParameters: RTRGetFalconScriptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmpowerapiMsaFalconScriptResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling rTRGetFalconScripts().'
            );
        }
    ...
    async rTRGetPutFilesRaw(requestParameters: RTRGetPutFilesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmpowerapiMsaPFResponseV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling rTRGetPutFiles().'
            );
        }
    ...
    async rTRGetPutFilesV2Raw(requestParameters: RTRGetPutFilesV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmpowerapiMsaPFResponseV2>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling rTRGetPutFilesV2().'
            );
        }
    ...
    async rTRGetScriptsRaw(requestParameters: RTRGetScriptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmpowerapiMsaPFResponseV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling rTRGetScripts().'
            );
        }
    ...
    async rTRGetScriptsV2Raw(requestParameters: RTRGetScriptsV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmpowerapiMsaPFResponseV2>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling rTRGetScriptsV2().'
            );
        }
     ...
     */
    async rTRListFalconScriptsRaw(requestParameters: RTRListFalconScriptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmpowerapiMsaIDListResponse>> {
        const queryParameters: any = {};
     ...
     * Get a list of Falcon script IDs available to the user to run
     */
    async rTRListFalconScripts(filter?: string, offset?: number, limit?: number, sort?: RTRListFalconScriptsSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EmpowerapiMsaIDListResponse> {
    ...
    async rTRUpdateScriptsRaw(requestParameters: RTRUpdateScriptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling rTRUpdateScripts().'
            );
        }
     ...
     * Upload a new scripts to replace an existing one.
     */
    async rTRUpdateScripts(id: string, file?: Blob, description?: string, name?: string, commentsForAuditLog?: string, permissionType?: string, content?: string, platform?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaReplyMetaOnly> {
        const response = await this.rTRUpdateScriptsRaw({ id: id, file: file, description: description, name: name, commentsForAuditLog: commentsForAuditLog, permissionType: permissionType, content: content, platform: platform }, initOverrides);
        return await response.value();
    }
