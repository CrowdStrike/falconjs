...
export class OverwatchDashboardApi extends runtime.BaseAPI {
     ...
     */
    async aggregatesDetectionsGlobalCountsRaw(requestParameters: AggregatesDetectionsGlobalCountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaFacetsResponse>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling aggregatesDetectionsGlobalCounts().'
            );
        }
    ...
    async aggregatesEventsRaw(requestParameters: AggregatesEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregatesEvents().'
            );
        }
     ...
     */
    async aggregatesEventsCollectionsRaw(requestParameters: AggregatesEventsCollectionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregatesEventsCollections().'
            );
        }
     ...
     */
    async aggregatesIncidentsGlobalCountsRaw(requestParameters: AggregatesIncidentsGlobalCountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaFacetsResponse>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling aggregatesIncidentsGlobalCounts().'
            );
        }
     ...
     */
    async aggregatesOWEventsGlobalCountsRaw(requestParameters: AggregatesOWEventsGlobalCountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaFacetsResponse>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling aggregatesOWEventsGlobalCounts().'
            );
        }
