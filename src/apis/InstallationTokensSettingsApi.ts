...
export class InstallationTokensSettingsApi extends runtime.BaseAPI {
     ...
     */
    async customerSettingsUpdateRaw(requestParameters: CustomerSettingsUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecQueryResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling customerSettingsUpdate().'
            );
        }
