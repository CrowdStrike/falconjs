...
export class HostGroupApi extends runtime.BaseAPI {
    ...
    async createHostGroupsRaw(requestParameters: CreateHostGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HostGroupsRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createHostGroups().'
            );
        }
    ...
    async deleteHostGroupsRaw(requestParameters: DeleteHostGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling deleteHostGroups().'
            );
        }
    ...
    async getHostGroupsRaw(requestParameters: GetHostGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HostGroupsRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getHostGroups().'
            );
        }
    ...
    async performGroupActionRaw(requestParameters: PerformGroupActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HostGroupsRespV1>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling performGroupAction().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling performGroupAction().'
            );
        }
     ...
     * Perform the specified action on the Host Groups specified in the request
     */
    async performGroupAction(actionName: PerformGroupActionActionNameEnum, body: MsaEntityActionRequestV2, disableHostnameCheck?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<HostGroupsRespV1> {
     ...
     */
    async queryCombinedGroupMembersRaw(requestParameters: QueryCombinedGroupMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HostGroupsMembersRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Host Group in your environment by providing an FQL filter and paging details. Returns a set of host details which match the filter criteria
     */
    async queryCombinedGroupMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<HostGroupsMembersRespV1> {
     ...
     * Search for Host Groups in your environment by providing an FQL filter and paging details. Returns a set of Host Groups which match the filter criteria
     */
    async queryCombinedHostGroups(filter?: string, offset?: number, limit?: number, sort?: QueryCombinedHostGroupsSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<HostGroupsRespV1> {
    ...
    async updateHostGroupsRaw(requestParameters: UpdateHostGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HostGroupsRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updateHostGroups().'
            );
        }
