...
export interface CreateMigrationV1Request {
    body: ApiCreateMigrationRequestV1;
}

export interface GetHostMigrationIDsV1Request {
    id: string;
    offset?: number;
    limit?: number;
...
export interface GetHostMigrationsV1Request {
    body: MsaIdsRequest;
}

export interface GetMigrationDestinationsV1Request {
    body: ApiGetMigrationDestinationsRequestBodyV1;
}

export interface GetMigrationIDsV1Request {
    offset?: number;
    limit?: number;
...
export interface GetMigrationsV1Request {
    ids: Array<string>;
}

export interface HostMigrationAggregatesV1Request {
    body: Array<MsaAggregateQueryRequest>;
}

export interface HostMigrationsActionsV1Request {
    id: string;
    actionName: HostMigrationsActionsV1ActionNameEnum;
    body: MsaEntityActionRequestV3;
}

export interface MigrationAggregatesV1Request {
    body: Array<MsaAggregateQueryRequest>;
}

export interface MigrationsActionsV1Request {
...
export class HostMigrationApi extends runtime.BaseAPI {
     ...
     */
    async createMigrationV1Raw(requestParameters: CreateMigrationV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiCreateMigrationResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createMigrationV1().'
            );
        }
     ...
     * Query host migration IDs.
     */
    async getHostMigrationIDsV1Raw(requestParameters: GetHostMigrationIDsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecQueryResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getHostMigrationIDsV1().'
            );
        }
     ...
     * Query host migration IDs.
     */
    async getHostMigrationIDsV1(id: string, offset?: number, limit?: number, sort?: GetHostMigrationIDsV1SortEnum, filter?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaspecQueryResponse> {
     ...
     */
    async getHostMigrationsV1Raw(requestParameters: GetHostMigrationsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiGetHostMigrationResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getHostMigrationsV1().'
            );
        }
     ...
     */
    async getMigrationDestinationsV1Raw(requestParameters: GetMigrationDestinationsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiGetMigrationDestinationsResponseV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getMigrationDestinationsV1().'
            );
        }
     ...
     */
    async getMigrationIDsV1Raw(requestParameters: GetMigrationIDsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Query migration jobs.
     */
    async getMigrationIDsV1(offset?: number, limit?: number, sort?: GetMigrationIDsV1SortEnum, filter?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaspecQueryResponse> {
     ...
     */
    async getMigrationsV1Raw(requestParameters: GetMigrationsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiGetMigrationsResponseV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getMigrationsV1().'
            );
        }
     ...
     */
    async hostMigrationAggregatesV1Raw(requestParameters: HostMigrationAggregatesV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling hostMigrationAggregatesV1().'
            );
        }
     ...
     */
    async hostMigrationsActionsV1Raw(requestParameters: HostMigrationsActionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecQueryResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling hostMigrationsActionsV1().'
            );
        }
        ...
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling hostMigrationsActionsV1().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling hostMigrationsActionsV1().'
            );
        }
     ...
     * Perform an action on host migrations.
     */
    async hostMigrationsActionsV1(id: string, actionName: HostMigrationsActionsV1ActionNameEnum, body: MsaEntityActionRequestV3, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaspecQueryResponse> {
     ...
     */
    async migrationAggregatesV1Raw(requestParameters: MigrationAggregatesV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling migrationAggregatesV1().'
            );
        }
     ...
     */
    async migrationsActionsV1Raw(requestParameters: MigrationsActionsV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecQueryResponse>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling migrationsActionsV1().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling migrationsActionsV1().'
            );
        }
     ...
     * Perform an action on a migration job.
     */
    async migrationsActionsV1(actionName: MigrationsActionsV1ActionNameEnum, body: MsaEntityActionRequestV3, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaspecQueryResponse> {
