...
export class CustomStorageApi extends runtime.BaseAPI {
     ...
     */
    async _deleteRaw(requestParameters: DeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CustomStorageResponse>> {
        ...
        if (requestParameters['objectKey'] == null) {
            throw new runtime.RequiredError(
                'objectKey',
                'Required parameter "objectKey" was null or undefined when calling _delete().'
            );
        }
        ...
        const response = await this.request({
            path: `/customobjects/v1/collections/{collection_name}/objects/{object_key}`.replace(`{${"collection_name"}}`, encodeURIComponent(String(requestParameters['collectionName']))).replace(`{${"object_key"}}`, encodeURIComponent(String(requestParameters['objectKey']))),
            method: 'DELETE',
     ...
     */
    async getRaw(requestParameters: GetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters['collectionName'] == null) {
            throw new runtime.RequiredError(
                'collectionName',
                'Required parameter "collectionName" was null or undefined when calling get().'
            );
        }
        ...
        if (requestParameters['objectKey'] == null) {
            throw new runtime.RequiredError(
                'objectKey',
                'Required parameter "objectKey" was null or undefined when calling get().'
            );
        }
     ...
     */
    async listRaw(requestParameters: ListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CustomStorageObjectKeys>> {
        if (requestParameters['collectionName'] == null) {
            throw new runtime.RequiredError(
                'collectionName',
                'Required parameter "collectionName" was null or undefined when calling list().'
            );
        }
     ...
     */
    async metadataRaw(requestParameters: MetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CustomStorageResponse>> {
        if (requestParameters['collectionName'] == null) {
            throw new runtime.RequiredError(
                'collectionName',
                'Required parameter "collectionName" was null or undefined when calling metadata().'
            );
        }
        ...
        if (requestParameters['objectKey'] == null) {
            throw new runtime.RequiredError(
                'objectKey',
                'Required parameter "objectKey" was null or undefined when calling metadata().'
            );
        }
        ...
        const response = await this.request({
            path: `/customobjects/v1/collections/{collection_name}/objects/{object_key}/metadata`.replace(`{${"collection_name"}}`, encodeURIComponent(String(requestParameters['collectionName']))).replace(`{${"object_key"}}`, encodeURIComponent(String(requestParameters['objectKey']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     */
    async searchRaw(requestParameters: SearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CustomStorageResponse>> {
        if (requestParameters['collectionName'] == null) {
            throw new runtime.RequiredError(
                'collectionName',
        ...
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling search().'
            );
        }
     ...
     */
    async uploadRaw(requestParameters: UploadRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CustomStorageResponse>> {
        if (requestParameters['collectionName'] == null) {
            throw new runtime.RequiredError(
                'collectionName',
                'Required parameter "collectionName" was null or undefined when calling upload().'
            );
        }
        ...
        if (requestParameters['objectKey'] == null) {
            throw new runtime.RequiredError(
                'objectKey',
                'Required parameter "objectKey" was null or undefined when calling upload().'
            );
        }
     ...
     * Put the specified new object at the given key or overwrite an existing object at the given key
     */
    async upload(collectionName: string, objectKey: string, body: Blob, dryRun?: boolean, schemaVersion?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CustomStorageResponse> {
