...
import type { ApiPostEnrollmentDetails, ApiPostEnrollmentDetailsResponse, ApiPostEnrollmentDetailsV4, MsaReplyMetaOnly, MsaspecResponseFields } from "../models/index";
import {
...
export interface MobileEnrollmentApiRequestDeviceEnrollmentV3Request {
    body: ApiPostEnrollmentDetails;
    actionName?: RequestDeviceEnrollmentV3ActionNameEnum;
    filter?: string;
}

export interface MobileEnrollmentApiRequestDeviceEnrollmentV4Request {
...
export class MobileEnrollmentApi extends runtime.BaseAPI {
     ...
     * Trigger on-boarding process for a mobile device
     */
    async requestDeviceEnrollmentV4(
        body: ApiPostEnrollmentDetailsV4,
        actionName?: RequestDeviceEnrollmentV4ActionNameEnum,
        filter?: string,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
