...
export interface CombinedApplicationsRequest {
    filter: string;
    after?: string;
    limit?: number;
    sort?: string;
...
export interface CombinedHostsRequest {
    filter: string;
    after?: string;
    limit?: number;
    sort?: string;
...
export class DiscoverApi extends runtime.BaseAPI {
     ...
     */
    async combinedApplicationsRaw(requestParameters: CombinedApplicationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainDiscoverAPICombinedApplicationsResponse>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling combinedApplications().'
            );
        }
     ...
     * Search for applications in your environment by providing an FQL filter and paging details. Returns details on applications which match the filter criteria.
     */
    async combinedApplications(filter: string, after?: string, limit?: number, sort?: string, facet?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainDiscoverAPICombinedApplicationsResponse> {
     ...
     */
    async combinedHostsRaw(requestParameters: CombinedHostsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainDiscoverAPICombinedHostsResponse>> {
        if (requestParameters['filter'] == null) {
            throw new runtime.RequiredError(
                'filter',
                'Required parameter "filter" was null or undefined when calling combinedHosts().'
            );
        }
     ...
     * Search for assets in your environment by providing an FQL (Falcon Query Language) filter and paging details. Returns details on assets which match the filter criteria.
     */
    async combinedHosts(filter: string, after?: string, limit?: number, sort?: string, facet?: Array<string>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainDiscoverAPICombinedHostsResponse> {
    ...
    async getAccountsRaw(requestParameters: GetAccountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainDiscoverAPIAccountEntitiesResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getAccounts().'
            );
        }
     ...
     */
    async getApplicationsRaw(requestParameters: GetApplicationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainDiscoverAPIApplicationEntitiesResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getApplications().'
            );
        }
    ...
    async getHostsRaw(requestParameters: GetHostsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainDiscoverAPIHostEntitiesResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getHosts().'
            );
        }
    ...
    async getLoginsRaw(requestParameters: GetLoginsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainDiscoverAPILoginEntitiesResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getLogins().'
            );
        }
     ...
     */
    async queryHostsRaw(requestParameters: QueryHostsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecQueryResponse>> {
        const queryParameters: any = {};
