...
export interface CreateCaseV2Request {
...
export class MessageCenterApi extends runtime.BaseAPI {
     ...
     */
    async aggregateCasesRaw(requestParameters: AggregateCasesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaAggregatesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling aggregateCases().'
            );
        }
     ...
     */
    async caseAddActivityRaw(requestParameters: CaseAddActivityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecResponseFields>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling caseAddActivity().'
            );
        }
     ...
     */
    async caseAddAttachmentRaw(requestParameters: CaseAddAttachmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiMessageCenterAttachmentUploadResponse>> {
        if (requestParameters['caseId'] == null) {
            throw new runtime.RequiredError(
                'caseId',
                'Required parameter "caseId" was null or undefined when calling caseAddAttachment().'
            );
        }
        ...
        if (requestParameters['userUuid'] == null) {
            throw new runtime.RequiredError(
                'userUuid',
                'Required parameter "userUuid" was null or undefined when calling caseAddAttachment().'
            );
        }
        ...
        if (requestParameters['file'] == null) {
            throw new runtime.RequiredError(
                'file',
                'Required parameter "file" was null or undefined when calling caseAddAttachment().'
            );
        }
     ...
     */
    async caseDownloadAttachmentRaw(requestParameters: CaseDownloadAttachmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling caseDownloadAttachment().'
            );
        }
     ...
     * @deprecated
     */
    async createCaseRaw(requestParameters: CreateCaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyAffectedEntities>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createCase().'
            );
        }
     ...
     * create a new case
     */
    async createCaseV2Raw(requestParameters: CreateCaseV2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaReplyAffectedEntities>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createCaseV2().'
            );
        }
     ...
     */
    async getCaseActivityByIdsRaw(requestParameters: GetCaseActivityByIdsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiMessageCenterActivityResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getCaseActivityByIds().'
            );
        }
     ...
     */
    async getCaseEntitiesByIDsRaw(requestParameters: GetCaseEntitiesByIDsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiMessageCenterCasesResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling getCaseEntitiesByIDs().'
            );
        }
     ...
     */
    async queryActivityByCaseIDRaw(requestParameters: QueryActivityByCaseIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecQueryResponse>> {
        if (requestParameters['caseId'] == null) {
            throw new runtime.RequiredError(
                'caseId',
                'Required parameter "caseId" was null or undefined when calling queryActivityByCaseID().'
            );
        }
     ...
     * Retrieve activities id\'s for a case
     */
    async queryActivityByCaseID(caseId: string, limit?: number, sort?: QueryActivityByCaseIDSortEnum, filter?: string, offset?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaspecQueryResponse> {
     ...
     */
    async queryCasesIdsByFilterRaw(requestParameters: QueryCasesIdsByFilterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaspecQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Retrieve case id\'s that match the provided filter criteria
     */
    async queryCasesIdsByFilter(limit?: number, sort?: QueryCasesIdsByFilterSortEnum, filter?: string, offset?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaspecQueryResponse> {
