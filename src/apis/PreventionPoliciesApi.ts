...
export class PreventionPoliciesApi extends runtime.BaseAPI {
    ...
    async createPreventionPoliciesRaw(requestParameters: CreatePreventionPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PreventionRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling createPreventionPolicies().'
            );
        }
    ...
    async deletePreventionPoliciesRaw(requestParameters: DeletePreventionPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling deletePreventionPolicies().'
            );
        }
    ...
    async getPreventionPoliciesRaw(requestParameters: GetPreventionPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PreventionRespV1>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling getPreventionPolicies().'
            );
        }
     ...
     */
    async performPreventionPoliciesActionRaw(requestParameters: PerformPreventionPoliciesActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PreventionRespV1>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling performPreventionPoliciesAction().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling performPreventionPoliciesAction().'
            );
        }
     ...
     * Perform the specified action on the Prevention Policies specified in the request
     */
    async performPreventionPoliciesAction(actionName: PerformPreventionPoliciesActionActionNameEnum, body: MsaEntityActionRequestV2, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PreventionRespV1> {
     ...
     */
    async queryCombinedPreventionPoliciesRaw(requestParameters: QueryCombinedPreventionPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PreventionRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for Prevention Policies in your environment by providing an FQL filter and paging details. Returns a set of Prevention Policies which match the filter criteria
     */
    async queryCombinedPreventionPolicies(filter?: string, offset?: number, limit?: number, sort?: QueryCombinedPreventionPoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PreventionRespV1> {
     ...
     */
    async queryCombinedPreventionPolicyMembersRaw(requestParameters: QueryCombinedPreventionPolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BasePolicyMembersRespV1>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Prevention Policy in your environment by providing an FQL filter and paging details. Returns a set of host details which match the filter criteria
     */
    async queryCombinedPreventionPolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BasePolicyMembersRespV1> {
     ...
     * Search for Prevention Policies in your environment by providing an FQL filter and paging details. Returns a set of Prevention Policy IDs which match the filter criteria
     */
    async queryPreventionPolicies(filter?: string, offset?: number, limit?: number, sort?: QueryPreventionPoliciesSortEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async queryPreventionPolicyMembersRaw(requestParameters: QueryPreventionPolicyMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Search for members of a Prevention Policy in your environment by providing an FQL filter and paging details. Returns a set of Agent IDs which match the filter criteria
     */
    async queryPreventionPolicyMembers(id?: string, filter?: string, offset?: number, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MsaQueryResponse> {
     ...
     */
    async setPreventionPoliciesPrecedenceRaw(requestParameters: SetPreventionPoliciesPrecedenceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling setPreventionPoliciesPrecedence().'
            );
        }
    ...
    async updatePreventionPoliciesRaw(requestParameters: UpdatePreventionPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PreventionRespV1>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling updatePreventionPolicies().'
            );
        }
