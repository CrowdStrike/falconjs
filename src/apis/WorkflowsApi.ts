...
export interface ExecutionResultsRequest {
    ids: Array<string>;
}
...
export interface WorkflowActivitiesCombinedRequest {
    filter?: string;
    offset?: string;
    limit?: number;
    sort?: string;
...
export interface WorkflowDefinitionsCombinedRequest {
    filter?: string;
    offset?: string;
    limit?: number;
    sort?: string;
...
export interface WorkflowDefinitionsExportRequest {
    id: string;
    sanitize?: boolean;
}

export interface WorkflowDefinitionsImportRequest {
    dataFile: Blob;
    name?: string;
    validateOnly?: boolean;
}

export interface WorkflowDefinitionsUpdateRequest {
    body: ModelsDefinitionUpdateRequestV2;
    validateOnly?: boolean;
}

export interface WorkflowExecuteInternalRequest {
    body: object;
    executionCid?: Array<string>;
    definitionId?: Array<string>;
    name?: string;
...
export interface WorkflowExecutionsCombinedRequest {
    filter?: string;
    offset?: string;
    limit?: number;
    sort?: string;
...
export interface WorkflowGetHumanInputV1Request {
    ids: Array<string>;
}

export interface WorkflowMockExecuteRequest {
...
export interface WorkflowTriggersCombinedRequest {
    filter?: string;
}

export interface WorkflowUpdateHumanInputV1Request {
    id: string;
...
export class WorkflowsApi extends runtime.BaseAPI {
     ...
     */
    async deprovisionRaw(requestParameters: DeprovisionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientSystemDefinitionCreateResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling deprovision().'
            );
        }
     ...
     * Executes an on-demand Workflow, the body is JSON used to trigger the execution, the response the execution ID(s)
     */
    async execute(body: object, executionCid?: Array<string>, definitionId?: Array<string>, name?: string, key?: string, depth?: number, sourceEventUrl?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiResourceIDsResponse> {
        const response = await this.executeRaw({ body: body, executionCid: executionCid, definitionId: definitionId, name: name, key: key, depth: depth, sourceEventUrl: sourceEventUrl }, initOverrides);
        return await response.value();
    }
     ...
     */
    async executionActionRaw(requestParameters: ExecutionActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DefinitionsDefinitionEntitiesResponse>> {
        if (requestParameters['actionName'] == null) {
            throw new runtime.RequiredError(
                'actionName',
                'Required parameter "actionName" was null or undefined when calling executionAction().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling executionAction().'
            );
        }
     ...
     * Allows a user to resume/retry a failed workflow execution.
     */
    async executionAction(actionName: ExecutionActionActionNameEnum, body: ClientActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DefinitionsDefinitionEntitiesResponse> {
     ...
     */
    async executionResultsRaw(requestParameters: ExecutionResultsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiExecutionResultsResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling executionResults().'
            );
        }
     ...
     */
    async promoteRaw(requestParameters: PromoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientSystemDefinitionCreateResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling promote().'
            );
        }
     ...
     */
    async provisionRaw(requestParameters: ProvisionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClientSystemDefinitionCreateResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling provision().'
            );
        }
     ...
     */
    async workflowActivitiesCombinedRaw(requestParameters: WorkflowActivitiesCombinedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ActivitiesActivityExternalResponse>> {
        const queryParameters: any = {};
     ...
     * Search for activities by name. Returns all supported activities if no filter specified
     */
    async workflowActivitiesCombined(filter?: string, offset?: string, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ActivitiesActivityExternalResponse> {
     ...
     */
    async workflowDefinitionsCombinedRaw(requestParameters: WorkflowDefinitionsCombinedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DefinitionsDefinitionExternalResponse>> {
        const queryParameters: any = {};
     ...
     * Search workflow definitions based on the provided filter
     */
    async workflowDefinitionsCombined(filter?: string, offset?: string, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DefinitionsDefinitionExternalResponse> {
     ...
     */
    async workflowDefinitionsExportRaw(requestParameters: WorkflowDefinitionsExportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<number>>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling workflowDefinitionsExport().'
            );
        }
     ...
     */
    async workflowDefinitionsImportRaw(requestParameters: WorkflowDefinitionsImportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DefinitionsDefinitionImportResponse>> {
        if (requestParameters['dataFile'] == null) {
            throw new runtime.RequiredError(
                'dataFile',
                'Required parameter "dataFile" was null or undefined when calling workflowDefinitionsImport().'
            );
        }
     ...
     */
    async workflowDefinitionsUpdateRaw(requestParameters: WorkflowDefinitionsUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiResourceIDsResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling workflowDefinitionsUpdate().'
            );
        }
     ...
     */
    async workflowExecuteInternalRaw(requestParameters: WorkflowExecuteInternalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiResourceIDsResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling workflowExecuteInternal().'
            );
        }
     ...
     * Executes an on-demand Workflow - internal workflows permitted, the body is JSON used to trigger the execution, the response the execution ID(s)
     */
    async workflowExecuteInternal(body: object, executionCid?: Array<string>, definitionId?: Array<string>, name?: string, key?: string, depth?: number, batchSize?: number, sourceEventUrl?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiResourceIDsResponse> {
        const response = await this.workflowExecuteInternalRaw({ body: body, executionCid: executionCid, definitionId: definitionId, name: name, key: key, depth: depth, batchSize: batchSize, sourceEventUrl: sourceEventUrl }, initOverrides);
        return await response.value();
    }
     ...
     */
    async workflowExecutionsCombinedRaw(requestParameters: WorkflowExecutionsCombinedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiExecutionResultsResponse>> {
        const queryParameters: any = {};
     ...
     * Search workflow executions based on the provided filter
     */
    async workflowExecutionsCombined(filter?: string, offset?: string, limit?: number, sort?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiExecutionResultsResponse> {
     ...
     */
    async workflowGetHumanInputV1Raw(requestParameters: WorkflowGetHumanInputV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelUserInputReadResponse>> {
        if (requestParameters['ids'] == null) {
            throw new runtime.RequiredError(
                'ids',
                'Required parameter "ids" was null or undefined when calling workflowGetHumanInputV1().'
            );
        }
     ...
     */
    async workflowMockExecuteRaw(requestParameters: WorkflowMockExecuteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiResourceIDsResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling workflowMockExecute().'
            );
        }
     ...
     * Executes a workflow definition with mocks
     */
    async workflowMockExecute(body: ModelsMockExecutionCreateRequestV1, executionCid?: Array<string>, definitionId?: string, name?: string, key?: string, depth?: number, sourceEventUrl?: string, validateOnly?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiResourceIDsResponse> {
        const response = await this.workflowMockExecuteRaw({ body: body, executionCid: executionCid, definitionId: definitionId, name: name, key: key, depth: depth, sourceEventUrl: sourceEventUrl, validateOnly: validateOnly }, initOverrides);
        return await response.value();
    }
     ...
     */
    async workflowTriggersCombinedRaw(requestParameters: WorkflowTriggersCombinedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TriggersTriggerExternalResponse>> {
        const queryParameters: any = {};
     ...
     */
    async workflowUpdateHumanInputV1Raw(requestParameters: WorkflowUpdateHumanInputV1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiResourceIDsResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling workflowUpdateHumanInputV1().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling workflowUpdateHumanInputV1().'
            );
        }
