 ...
 */
export function instanceOfFwmgrDomainDNSResolutionTargetsWithPolling(value: object): boolean {
    let isInstance = true;
...
export function FwmgrDomainDNSResolutionTargetsWithPollingFromJSONTyped(json: any, ignoreDiscriminator: boolean): FwmgrDomainDNSResolutionTargetsWithPolling {
    ...
    return {
        ...
        targets: !exists(json, "targets") ? undefined : (json["targets"] as Array<any>).map(FwmgrDomainDNSTargetFromJSON),
    };
}
...
export function FwmgrDomainDNSResolutionTargetsWithPollingToJSON(value?: FwmgrDomainDNSResolutionTargetsWithPolling | null): any {
    ...
    return {
        ...
        targets: value.targets === undefined ? undefined : (value.targets as Array<any>).map(FwmgrDomainDNSTargetToJSON),
    };
}
