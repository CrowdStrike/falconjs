...
import {
    DomainMSSPRolesFromJSON,
    DomainMSSPRolesFromJSONTyped,
    DomainMSSPRolesToJSON,
} from './DomainMSSPRoles';
 ...
 * 
 * @export
 * @interface DomainMSSPRoleResponseV1
 */
export interface DomainMSSPRoleResponseV1 {
    /**
     * 
     * @type {Array<MsaAPIError>}
     * @memberof DomainMSSPRoleResponseV1
     */
 ...
 */
export function instanceOfDomainMSSPRoleResponseV1(value: object): value is DomainMSSPRoleResponseV1 {
...
export function DomainMSSPRoleResponseV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainMSSPRoleResponseV1 {
    if (json == null) {
        return json;
    }
    return {
