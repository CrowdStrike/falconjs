 ...
 */
export function instanceOfMsaspecQueryResponse(value: object): value is MsaspecQueryResponse {
...
export function MsaspecQueryResponseToJSON(json: any): MsaspecQueryResponse {
    return MsaspecQueryResponseToJSONTyped(json, false);
}

export function MsaspecQueryResponseToJSONTyped(value?: MsaspecQueryResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
