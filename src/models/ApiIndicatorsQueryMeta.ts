...
import {
    ApiIndicatorsQueryPagingFromJSON,
    ApiIndicatorsQueryPagingFromJSONTyped,
    ApiIndicatorsQueryPagingToJSON,
} from './ApiIndicatorsQueryPaging';

/**
 * 
 * @export
 * @interface ApiIndicatorsQueryMeta
 */
export interface ApiIndicatorsQueryMeta {
    /**
     * 
     * @type {ApiIndicatorsQueryPaging}
     * @memberof ApiIndicatorsQueryMeta
     */
    pagination?: ApiIndicatorsQueryPaging;
    /**
     * 
     * @type {string}
     * @memberof ApiIndicatorsQueryMeta
 ...
 */
export function instanceOfApiIndicatorsQueryMeta(value: object): value is ApiIndicatorsQueryMeta {
...
export function ApiIndicatorsQueryMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiIndicatorsQueryMeta {
    if (json == null) {
        return json;
    }
    return {
        
        'pagination': json['pagination'] == null ? undefined : ApiIndicatorsQueryPagingFromJSON(json['pagination']),
