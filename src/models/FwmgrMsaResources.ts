 ...
 *
 * @export
 * @interface FwmgrMsaResources
 */
export interface FwmgrMsaResources {
    /**
     *
     * @type {number}
     * @memberof FwmgrMsaResources
     */
...
export function FwmgrMsaResourcesFromJSONTyped(json: any, ignoreDiscriminator: boolean): FwmgrMsaResources {
...
export function FwmgrMsaResourcesToJSON(value?: FwmgrMsaResources | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
