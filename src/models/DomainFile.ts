 ...
 */
export function instanceOfDomainFile(value: object): value is DomainFile {
...
export function DomainFileFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainFile {
    if (json == null) {
        return json;
    }
    return {
