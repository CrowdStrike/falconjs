 ...
 */
export function instanceOfAlertsContainerAlertsCountValue(value: object): value is AlertsContainerAlertsCountValue {
...
export function AlertsContainerAlertsCountValueToJSON(json: any): AlertsContainerAlertsCountValue {
    return AlertsContainerAlertsCountValueToJSONTyped(json, false);
}

export function AlertsContainerAlertsCountValueToJSONTyped(value?: AlertsContainerAlertsCountValue | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
