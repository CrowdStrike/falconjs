 ...
 */
export function instanceOfApidomainDynamicExecuteSearchRequestV1(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "repoOrView" in value;
    isInstance = isInstance && "searchQuery" in value;
    isInstance = isInstance && "searchQueryArgs" in value;
