 ...
 *
 * @export
 * @interface SdkEventEvidenceRecordVM
 */
export interface SdkEventEvidenceRecordVM {
     ...
     */
    selector: SdkEventEvidenceSelector;
}
...
export function SdkEventEvidenceRecordVMFromJSON(json: any): SdkEventEvidenceRecordVM {
    return SdkEventEvidenceRecordVMFromJSONTyped(json, false);
}

export function SdkEventEvidenceRecordVMFromJSONTyped(json: any, ignoreDiscriminator: boolean): SdkEventEvidenceRecordVM {
    if (json == null) {
        return json;
    }
    return {
