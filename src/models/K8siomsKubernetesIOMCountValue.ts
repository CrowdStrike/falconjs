 ...
 *
 * @export
 * @interface K8siomsKubernetesIOMCountValue
 */
...
export function K8siomsKubernetesIOMCountValueFromJSON(json: any): K8siomsKubernetesIOMCountValue {
    return K8siomsKubernetesIOMCountValueFromJSONTyped(json, false);
}

export function K8siomsKubernetesIOMCountValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): K8siomsKubernetesIOMCountValue {
    if (json == null) {
        return json;
    }
    return {
...
export function K8siomsKubernetesIOMCountValueToJSON(json: any): K8siomsKubernetesIOMCountValue {
    return K8siomsKubernetesIOMCountValueToJSONTyped(json, false);
}

export function K8siomsKubernetesIOMCountValueToJSONTyped(value?: K8siomsKubernetesIOMCountValue | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
