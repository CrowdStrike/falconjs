...
import {
    FwmgrApiFirewallFieldsV1FromJSON,
    FwmgrApiFirewallFieldsV1FromJSONTyped,
    FwmgrApiFirewallFieldsV1ToJSON,
} from './FwmgrApiFirewallFieldsV1';
 ...
 * 
 * @export
 * @interface FwmgrApiFirewallFieldsResponse
 */
export interface FwmgrApiFirewallFieldsResponse {
    /**
     * 
     * @type {Array<FwmgrMsaspecError>}
     * @memberof FwmgrApiFirewallFieldsResponse
     */
    ...
    /**
     * 
     * @type {Array<FwmgrApiFirewallFieldsV1>}
     * @memberof FwmgrApiFirewallFieldsResponse
     */
 ...
 */
export function instanceOfFwmgrApiFirewallFieldsResponse(value: object): value is FwmgrApiFirewallFieldsResponse {
...
export function FwmgrApiFirewallFieldsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FwmgrApiFirewallFieldsResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'resources': ((json['resources'] as Array<any>).map(FwmgrApiFirewallFieldsV1FromJSON)),
    };
}
...
export function FwmgrApiFirewallFieldsResponseToJSON(value?: FwmgrApiFirewallFieldsResponse | null): any {
    ...
    return {
        ...
        'resources': ((value['resources'] as Array<any>).map(FwmgrApiFirewallFieldsV1ToJSON)),
    };
}
