...
import {
    ...
    DomainAzureClientServicePrincipalV1ToJSONTyped,
...
export function RegistrationAzureTenantConfigurationResponseV1ToJSON(json: any): RegistrationAzureTenantConfigurationResponseV1 {
    return RegistrationAzureTenantConfigurationResponseV1ToJSONTyped(json, false);
}

export function RegistrationAzureTenantConfigurationResponseV1ToJSONTyped(value?: RegistrationAzureTenantConfigurationResponseV1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
