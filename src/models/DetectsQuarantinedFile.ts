 ...
 *
 * @export
 * @interface DetectsQuarantinedFile
 */
export interface DetectsQuarantinedFile {
    /**
     *
     * @type {string}
     * @memberof DetectsQuarantinedFile
     */
    id?: string;
    /**
     *
 ...
 */
export function instanceOfDetectsQuarantinedFile(value: object): value is DetectsQuarantinedFile {
    return true;
}
...
export function DetectsQuarantinedFileFromJSONTyped(json: any, ignoreDiscriminator: boolean): DetectsQuarantinedFile {
    if (json == null) {
        return json;
    }
    return {
