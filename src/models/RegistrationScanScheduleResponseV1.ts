...
/**
 * Check if a given object implements the RegistrationScanScheduleResponseV1 interface.
 */
export function instanceOfRegistrationScanScheduleResponseV1(value: object): value is RegistrationScanScheduleResponseV1 {
