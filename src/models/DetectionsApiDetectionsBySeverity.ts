...
export function DetectionsApiDetectionsBySeverityToJSON(json: any): DetectionsApiDetectionsBySeverity {
    return DetectionsApiDetectionsBySeverityToJSONTyped(json, false);
}

export function DetectionsApiDetectionsBySeverityToJSONTyped(value?: DetectionsApiDetectionsBySeverity | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
