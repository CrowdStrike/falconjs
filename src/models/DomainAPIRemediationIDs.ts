 ...
 */
export function instanceOfDomainAPIRemediationIDs(value: object): value is DomainAPIRemediationIDs {
    return true;
}
...
export function DomainAPIRemediationIDsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainAPIRemediationIDs {
    if (json == null) {
        return json;
    }
    return {
