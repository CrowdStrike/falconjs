...
export function RegistrationStaticScriptsResponseToJSON(json: any): RegistrationStaticScriptsResponse {
    return RegistrationStaticScriptsResponseToJSONTyped(json, false);
}

export function RegistrationStaticScriptsResponseToJSONTyped(value?: RegistrationStaticScriptsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
