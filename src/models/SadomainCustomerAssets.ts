 ...
 *
 * @export
 * @interface SadomainCustomerAssets
 */
export interface SadomainCustomerAssets {
    /**
     *
     * @type {Array<string>}
     * @memberof SadomainCustomerAssets
     */
...
export function SadomainCustomerAssetsFromJSON(json: any): SadomainCustomerAssets {
    return SadomainCustomerAssetsFromJSONTyped(json, false);
}
...
export function SadomainCustomerAssetsToJSON(json: any): SadomainCustomerAssets {
    return SadomainCustomerAssetsToJSONTyped(json, false);
}

export function SadomainCustomerAssetsToJSONTyped(value?: SadomainCustomerAssets | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
