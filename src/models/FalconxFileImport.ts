 ...
 * 
 * @export
 * @interface FalconxFileImport
 */
export interface FalconxFileImport {
    /**
     * 
     * @type {Array<string>}
     * @memberof FalconxFileImport
     */
 ...
 */
export function instanceOfFalconxFileImport(value: object): value is FalconxFileImport {
    return true;
}
...
export function FalconxFileImportFromJSONTyped(json: any, ignoreDiscriminator: boolean): FalconxFileImport {
    if (json == null) {
        return json;
    }
    return {
