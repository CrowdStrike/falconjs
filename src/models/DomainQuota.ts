 ...
 */
export function instanceOfDomainQuota(value: object): value is DomainQuota {
...
export function DomainQuotaFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainQuota {
    if (json == null) {
        return json;
    }
    return {
