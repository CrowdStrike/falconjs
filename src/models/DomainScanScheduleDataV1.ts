...
export function DomainScanScheduleDataV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainScanScheduleDataV1 {
    ...
    return {
        ...
        nextScanTimestamp: !exists(json, "next_scan_timestamp") ? undefined : new Date(json["next_scan_timestamp"]),
        scanInterval: !exists(json, "scan_interval") ? undefined : json["scan_interval"],
        scanSchedule: !exists(json, "scan_schedule") ? undefined : json["scan_schedule"],
    };
}
...
export function DomainScanScheduleDataV1ToJSON(value?: DomainScanScheduleDataV1 | null): any {
    ...
    return {
        ...
        next_scan_timestamp: value.nextScanTimestamp === undefined ? undefined : value.nextScanTimestamp.toISOString(),
