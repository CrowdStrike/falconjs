 ...
 *
 * @export
 * @interface FigapiIndicator
 */
export interface FigapiIndicator {
    /**
     *
     * @type {Array<FigapiAdversary>}
     * @memberof FigapiIndicator
     */
...
/**
 * Check if a given object implements the FigapiIndicator interface.
 */
export function instanceOfFigapiIndicator(value: object): value is FigapiIndicator {
    return true;
}

export function FigapiIndicatorFromJSON(json: any): FigapiIndicator {
    return FigapiIndicatorFromJSONTyped(json, false);
}

export function FigapiIndicatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): FigapiIndicator {
    if (json == null) {
        return json;
    }
    return {
...
export function FigapiIndicatorToJSON(json: any): FigapiIndicator {
    return FigapiIndicatorToJSONTyped(json, false);
}

export function FigapiIndicatorToJSONTyped(value?: FigapiIndicator | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
