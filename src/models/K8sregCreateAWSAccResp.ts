...
export function K8sregCreateAWSAccRespToJSON(json: any): K8sregCreateAWSAccResp {
    return K8sregCreateAWSAccRespToJSONTyped(json, false);
}

export function K8sregCreateAWSAccRespToJSONTyped(value?: K8sregCreateAWSAccResp | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
