 ...
 *
 * @export
 * @interface DomainBatchRefreshSessionResponse
 */
export interface DomainBatchRefreshSessionResponse {
    /**
     *
     * @type {Array<MsaAPIError>}
     * @memberof DomainBatchRefreshSessionResponse
     */
    ...
    /**
     *
     * @type {{ [key: string]: DomainMultiPulseSensorResponse; }}
     * @memberof DomainBatchRefreshSessionResponse
     */
 ...
 */
export function instanceOfDomainBatchRefreshSessionResponse(value: object): value is DomainBatchRefreshSessionResponse {
...
export function DomainBatchRefreshSessionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainBatchRefreshSessionResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        resources: mapValues(json["resources"], DomainMultiPulseSensorResponseFromJSON),
    };
}
...
export function DomainBatchRefreshSessionResponseToJSON(value?: DomainBatchRefreshSessionResponse | null): any {
    ...
    return {
        ...
        resources: mapValues(value["resources"], DomainMultiPulseSensorResponseToJSON),
    };
}
