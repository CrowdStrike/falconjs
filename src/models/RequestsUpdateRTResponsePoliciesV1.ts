 ...
 * @export
 * @interface RequestsUpdateRTResponsePoliciesV1
 */
export interface RequestsUpdateRTResponsePoliciesV1 {
    /**
     * A collection of policies to update
     * @type {Array<RequestsUpdateRTResponsePolicyV1>}
     * @memberof RequestsUpdateRTResponsePoliciesV1
     */
...
export function RequestsUpdateRTResponsePoliciesV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): RequestsUpdateRTResponsePoliciesV1 {
    if (json === undefined || json === null) {
        return json;
    }
    return {
        resources: (json["resources"] as Array<any>).map(RequestsUpdateRTResponsePolicyV1FromJSON),
    };
}

export function RequestsUpdateRTResponsePoliciesV1ToJSON(value?: RequestsUpdateRTResponsePoliciesV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        resources: (value.resources as Array<any>).map(RequestsUpdateRTResponsePolicyV1ToJSON),
    };
}
