 ...
 *
 * @export
 * @interface ApiRulesGetRequestV1
 */
export interface ApiRulesGetRequestV1 {
    /**
     *
     * @type {Array<string>}
     * @memberof ApiRulesGetRequestV1
     */
    ids: Array<string>;
}
 ...
 */
export function instanceOfApiRulesGetRequestV1(value: object): value is ApiRulesGetRequestV1 {
...
export function ApiRulesGetRequestV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiRulesGetRequestV1 {
    if (json == null) {
        return json;
    }
    return {
