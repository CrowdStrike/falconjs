 ...
 */
export function instanceOfDetectsapiAggregationResultItem(value: object): value is DetectsapiAggregationResultItem {
...
export function DetectsapiAggregationResultItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): DetectsapiAggregationResultItem {
    ...
    return {
        ...
        'subAggregates': json['sub_aggregates'] == null ? undefined : ((json['sub_aggregates'] as Array<any>).map(DetectsapiAggregationResultFromJSON)),
...
export function DetectsapiAggregationResultItemToJSON(value?: DetectsapiAggregationResultItem | null): any {
    ...
    return {
        ...
        'sub_aggregates': value['subAggregates'] == null ? undefined : ((value['subAggregates'] as Array<any>).map(DetectsapiAggregationResultToJSON)),
        'to': value['to'],
        'value': value['value'],
