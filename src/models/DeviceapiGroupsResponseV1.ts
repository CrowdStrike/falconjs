...
import { DeviceapiGroupResponseV1FromJSON, DeviceapiGroupResponseV1FromJSONTyped, DeviceapiGroupResponseV1ToJSON, DeviceapiGroupResponseV1ToJSONTyped } from "./DeviceapiGroupResponseV1";
...
export function DeviceapiGroupsResponseV1ToJSON(json: any): DeviceapiGroupsResponseV1 {
    return DeviceapiGroupsResponseV1ToJSONTyped(json, false);
}

export function DeviceapiGroupsResponseV1ToJSONTyped(value?: DeviceapiGroupsResponseV1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
