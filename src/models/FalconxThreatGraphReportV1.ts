 ...
 */
export function instanceOfFalconxThreatGraphReportV1(value: object): value is FalconxThreatGraphReportV1 {
    return true;
}
...
export function FalconxThreatGraphReportV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): FalconxThreatGraphReportV1 {
    ...
    return {
        indicators: json["indicators"] == null ? undefined : (json["indicators"] as Array<any>).map(FalconxThreatGraphIndicatorV1FromJSON),
    };
}
