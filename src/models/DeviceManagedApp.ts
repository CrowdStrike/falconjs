 ...
 * 
 * @export
 * @interface DeviceManagedApp
 */
export interface DeviceManagedApp {
    /**
     * 
     * @type {string}
     * @memberof DeviceManagedApp
     */
    version: string;
}
 ...
 */
export function instanceOfDeviceManagedApp(value: object): value is DeviceManagedApp {
...
export function DeviceManagedAppFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeviceManagedApp {
    if (json == null) {
        return json;
    }
    return {
