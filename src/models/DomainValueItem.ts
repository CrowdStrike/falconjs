 ...
 */
export function instanceOfDomainValueItem(value: object): value is DomainValueItem {
...
export function DomainValueItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainValueItem {
    if (json == null) {
        return json;
    }
    return {
