 ...
 */
export function instanceOfMalqueryExternalHuntParametersV1(value: object): value is MalqueryExternalHuntParametersV1 {
    if (!('yaraRule' in value) || value['yaraRule'] === undefined) return false;
    return true;
}
