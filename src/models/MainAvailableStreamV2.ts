...
import {
    MainSessionTokenFromJSON,
    MainSessionTokenFromJSONTyped,
    MainSessionTokenToJSON,
} from './MainSessionToken';
 ...
 */
export function instanceOfMainAvailableStreamV2(value: object): value is MainAvailableStreamV2 {
    if (!('dataFeedURL' in value) || value['dataFeedURL'] === undefined) return false;
    if (!('refreshActiveSessionInterval' in value) || value['refreshActiveSessionInterval'] === undefined) return false;
    if (!('refreshActiveSessionURL' in value) || value['refreshActiveSessionURL'] === undefined) return false;
