 ...
 *
 * @export
 * @interface SdkAlertEvidenceRecordVM
 */
...
export function SdkAlertEvidenceRecordVMFromJSON(json: any): SdkAlertEvidenceRecordVM {
    return SdkAlertEvidenceRecordVMFromJSONTyped(json, false);
}

export function SdkAlertEvidenceRecordVMFromJSONTyped(json: any, ignoreDiscriminator: boolean): SdkAlertEvidenceRecordVM {
    if (json == null) {
        return json;
    }
    return {
