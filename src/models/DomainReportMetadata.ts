 ...
 */
export function instanceOfDomainReportMetadata(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "createdByUserId" in value;
    isInstance = isInstance && "createdByUuid" in value;
    isInstance = isInstance && "lastUnscheduledExecution" in value;
...
export function DomainReportMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainReportMetadata {
    ...
    return {
        ...
        discoverParams: !exists(json, "discover_params") ? undefined : DomainDiscoverParamsFromJSON(json["discover_params"]),
        lastScheduledExecution: !exists(json, "last_scheduled_execution") ? undefined : DomainLastScheduledExecutionFromJSON(json["last_scheduled_execution"]),
        lastUnscheduledExecution: DomainLastUnscheduledExecutionFromJSON(json["last_unscheduled_execution"]),
        subtype: json["subtype"],
        xdrParams: !exists(json, "xdr_params") ? undefined : DomainXDRParamsFromJSON(json["xdr_params"]),
    };
}
