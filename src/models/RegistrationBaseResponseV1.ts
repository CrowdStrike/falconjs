 ...
 *
 * @export
 * @interface RegistrationBaseResponseV1
 */
export interface RegistrationBaseResponseV1 {
    /**
     *
     * @type {Array<MsaAPIError>}
     * @memberof RegistrationBaseResponseV1
     */
...
export function RegistrationBaseResponseV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): RegistrationBaseResponseV1 {
...
export function RegistrationBaseResponseV1ToJSON(value?: RegistrationBaseResponseV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
