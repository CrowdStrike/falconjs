 ...
 *
 * @export
 * @interface RestCursorMetaInfo
 */
export interface RestCursorMetaInfo {
    /**
     *
     * @type {string}
     * @memberof RestCursorMetaInfo
     */
    next?: string;
    /**
     *
...
/**
 * Check if a given object implements the RestCursorMetaInfo interface.
 */
export function instanceOfRestCursorMetaInfo(value: object): value is RestCursorMetaInfo {
    if (!("queryTime" in value) || value["queryTime"] === undefined) return false;
    if (!("traceId" in value) || value["traceId"] === undefined) return false;
    return true;
}

export function RestCursorMetaInfoFromJSON(json: any): RestCursorMetaInfo {
    return RestCursorMetaInfoFromJSONTyped(json, false);
}

export function RestCursorMetaInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RestCursorMetaInfo {
    if (json == null) {
        return json;
    }
    return {
