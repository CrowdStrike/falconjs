...
import {
    ...
    ModelsComplianceExportGroupedByClustersReportToJSONTyped,
...
export function DomainAggregateClusterAssessmentsResponseToJSON(json: any): DomainAggregateClusterAssessmentsResponse {
    return DomainAggregateClusterAssessmentsResponseToJSONTyped(json, false);
}

export function DomainAggregateClusterAssessmentsResponseToJSONTyped(value?: DomainAggregateClusterAssessmentsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
