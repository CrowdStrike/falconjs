...
import {
    DomainUserGroupFromJSON,
    DomainUserGroupFromJSONTyped,
    DomainUserGroupToJSON,
} from './DomainUserGroup';
...
export function DomainUserGroupsResponseV1ToJSON(value?: DomainUserGroupsResponseV1 | null): any {
    if (value == null) {
        return value;
    }
    return {
