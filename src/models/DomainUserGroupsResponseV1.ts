 ...
 *
 * @export
 * @interface DomainUserGroupsResponseV1
 */
export interface DomainUserGroupsResponseV1 {
    /**
     *
     * @type {Array<MsaAPIError>}
     * @memberof DomainUserGroupsResponseV1
     */
 ...
 */
export function instanceOfDomainUserGroupsResponseV1(value: object): value is DomainUserGroupsResponseV1 {
...
export function DomainUserGroupsResponseV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainUserGroupsResponseV1 {
    if (json == null) {
        return json;
    }
    return {
...
export function DomainUserGroupsResponseV1ToJSON(json: any): DomainUserGroupsResponseV1 {
    return DomainUserGroupsResponseV1ToJSONTyped(json, false);
}

export function DomainUserGroupsResponseV1ToJSONTyped(value?: DomainUserGroupsResponseV1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
