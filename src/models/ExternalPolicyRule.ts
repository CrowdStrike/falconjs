 ...
 */
export interface ExternalPolicyRule {
    /**
     *
     * @type {string}
     * @memberof ExternalPolicyRule
     */
    basePath?: string;
}
...
export function ExternalPolicyRuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExternalPolicyRule {
...
export function ExternalPolicyRuleToJSON(value?: ExternalPolicyRule | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
