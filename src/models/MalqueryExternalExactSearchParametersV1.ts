 ...
 * 
 * @export
 * @interface MalqueryExternalExactSearchParametersV1
 */
export interface MalqueryExternalExactSearchParametersV1 {
    /**
     * 
     * @type {MalqueryExternalHuntOptions}
     * @memberof MalqueryExternalExactSearchParametersV1
     */
 ...
 */
export function instanceOfMalqueryExternalExactSearchParametersV1(value: object): value is MalqueryExternalExactSearchParametersV1 {
...
export function MalqueryExternalExactSearchParametersV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): MalqueryExternalExactSearchParametersV1 {
    if (json == null) {
        return json;
    }
    return {
