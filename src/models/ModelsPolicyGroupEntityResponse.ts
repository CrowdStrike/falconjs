 ...
 *
 * @export
 * @interface ModelsPolicyGroupEntityResponse
 */
...
export function ModelsPolicyGroupEntityResponseFromJSON(json: any): ModelsPolicyGroupEntityResponse {
    return ModelsPolicyGroupEntityResponseFromJSONTyped(json, false);
}

export function ModelsPolicyGroupEntityResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelsPolicyGroupEntityResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelsPolicyGroupEntityResponseToJSON(json: any): ModelsPolicyGroupEntityResponse {
    return ModelsPolicyGroupEntityResponseToJSONTyped(json, false);
}

export function ModelsPolicyGroupEntityResponseToJSONTyped(value?: ModelsPolicyGroupEntityResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
