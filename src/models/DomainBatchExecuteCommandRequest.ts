 ...
 */
export function instanceOfDomainBatchExecuteCommandRequest(value: object): value is DomainBatchExecuteCommandRequest {
    ...
    if (!("optionalHosts" in value) || value["optionalHosts"] === undefined) return false;
    if (!("persistAll" in value) || value["persistAll"] === undefined) return false;
    return true;
}
