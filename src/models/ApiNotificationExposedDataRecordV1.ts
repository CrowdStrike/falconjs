...
export function ApiNotificationExposedDataRecordV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiNotificationExposedDataRecordV1 {
    ...
    return {
        ...
        id: json["id"],
        impactedDomain: !exists(json, "impacted_domain") ? undefined : json["impacted_domain"],
        impactedIp: !exists(json, "impacted_ip") ? undefined : json["impacted_ip"],
        impactedUrl: !exists(json, "impacted_url") ? undefined : json["impacted_url"],
...
export function ApiNotificationExposedDataRecordV1ToJSON(value?: ApiNotificationExposedDataRecordV1 | null): any {
    ...
    return {
        ...
        id: value.id,
        impacted_domain: value.impactedDomain,
        impacted_ip: value.impactedIp,
        impacted_url: value.impactedUrl,
