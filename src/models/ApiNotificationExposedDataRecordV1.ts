...
import {
    ApiRuleDetailsV1FromJSON,
    ApiRuleDetailsV1FromJSONTyped,
    ApiRuleDetailsV1ToJSON,
} from './ApiRuleDetailsV1';
...
import {
    ApiExposedDataRecordBotV1FromJSON,
    ApiExposedDataRecordBotV1FromJSONTyped,
    ApiExposedDataRecordBotV1ToJSON,
} from './ApiExposedDataRecordBotV1';
 ...
 */
export function instanceOfApiNotificationExposedDataRecordV1(value: object): value is ApiNotificationExposedDataRecordV1 {
    ...
    if (!('exposureDate' in value) || value['exposureDate'] === undefined) return false;
    ...
    if (!('sourceCategory' in value) || value['sourceCategory'] === undefined) return false;
...
export function ApiNotificationExposedDataRecordV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiNotificationExposedDataRecordV1 {
    ...
    return {
        ...
        'bot': json['bot'] == null ? undefined : ApiExposedDataRecordBotV1FromJSON(json['bot']),
        'cid': json['cid'],
        ...
        'file': json['file'] == null ? undefined : ApiExposedDataFileDetailsV1FromJSON(json['file']),
        'financial': json['financial'] == null ? undefined : ApiExposedDataRecordFinancialV1FromJSON(json['financial']),
        'fullName': json['full_name'] == null ? undefined : json['full_name'],
        'hashType': json['hash_type'] == null ? undefined : json['hash_type'],
        'id': json['id'],
        ...
        'social': json['social'] == null ? undefined : ApiExposedDataRecordSocialV1FromJSON(json['social']),
