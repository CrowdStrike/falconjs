 ...
 *
 * @export
 * @interface RestapiLookupIndicatorResponse
 */
export interface RestapiLookupIndicatorResponse {
    /**
     *
...
/**
 * Check if a given object implements the RestapiLookupIndicatorResponse interface.
 */
export function instanceOfRestapiLookupIndicatorResponse(value: object): value is RestapiLookupIndicatorResponse {
...
export function RestapiLookupIndicatorResponseFromJSON(json: any): RestapiLookupIndicatorResponse {
    return RestapiLookupIndicatorResponseFromJSONTyped(json, false);
}

export function RestapiLookupIndicatorResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RestapiLookupIndicatorResponse {
    if (json == null) {
        return json;
    }
    return {
