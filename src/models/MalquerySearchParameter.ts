 ...
 *
 * @export
 * @interface MalquerySearchParameter
 */
export interface MalquerySearchParameter {
    /**
     * Pattern type. Accepted values: hex, ascii, wide
     * @type {string}
     * @memberof MalquerySearchParameter
     */
    type: string;
    /**
     * Pattern value
 ...
 */
export function instanceOfMalquerySearchParameter(value: object): value is MalquerySearchParameter {
...
export function MalquerySearchParameterFromJSONTyped(json: any, ignoreDiscriminator: boolean): MalquerySearchParameter {
    if (json == null) {
        return json;
    }
    return {
