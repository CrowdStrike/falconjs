 ...
 */
export function instanceOfDomainInitResponse(value: object): value is DomainInitResponse {
    if (!('createdAt' in value) || value['createdAt'] === undefined) return false;
    if (!('existingAidSessions' in value) || value['existingAidSessions'] === undefined) return false;
