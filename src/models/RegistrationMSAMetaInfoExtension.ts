 ...
 */
export function instanceOfRegistrationMSAMetaInfoExtension(value: object): value is RegistrationMSAMetaInfoExtension {
...
export function RegistrationMSAMetaInfoExtensionFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegistrationMSAMetaInfoExtension {
    ...
    return {
        ...
        'pagination': json['pagination'] == null ? undefined : RegistrationMSAPagingExtensionFromJSON(json['pagination']),
    };
}
