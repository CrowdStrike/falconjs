...
/**
 * Check if a given object implements the RequestsUpdateSensorUpdatePoliciesV1 interface.
 */
export function instanceOfRequestsUpdateSensorUpdatePoliciesV1(value: object): boolean {
    let isInstance = true;
