...
export function V2ModelToJSON(json: any): V2Model {
    return V2ModelToJSONTyped(json, false);
}

export function V2ModelToJSONTyped(value?: V2Model | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
