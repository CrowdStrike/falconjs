 ...
 */
export function instanceOfDomainDDOSAttackSource(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "attackType" in value;
    isInstance = isInstance && "confidence" in value;
    isInstance = isInstance && "duration" in value;
    isInstance = isInstance && "key" in value;
    isInstance = isInstance && "networkProtocol" in value;
    isInstance = isInstance && "protocols" in value;
    isInstance = isInstance && "requests" in value;
    isInstance = isInstance && "startTime" in value;
    isInstance = isInstance && "target" in value;
    isInstance = isInstance && "targetDetails" in value;
    isInstance = isInstance && "targetDomain" in value;
    isInstance = isInstance && "targetIp" in value;
    isInstance = isInstance && "targetPorts" in value;
