 ...
 *
 * @export
 * @interface ContentUpdatePolicyV1
 */
export interface ContentUpdatePolicyV1 {
    /**
 ...
 * @export
 */
export const ContentUpdatePolicyV1PlatformNameEnum = {
    All: "all",
} as const;
export type ContentUpdatePolicyV1PlatformNameEnum = (typeof ContentUpdatePolicyV1PlatformNameEnum)[keyof typeof ContentUpdatePolicyV1PlatformNameEnum];

/**
 * Check if a given object implements the ContentUpdatePolicyV1 interface.
 */
export function instanceOfContentUpdatePolicyV1(value: object): value is ContentUpdatePolicyV1 {
...
export function ContentUpdatePolicyV1FromJSON(json: any): ContentUpdatePolicyV1 {
    return ContentUpdatePolicyV1FromJSONTyped(json, false);
}

export function ContentUpdatePolicyV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ContentUpdatePolicyV1 {
    if (json == null) {
        return json;
    }
    return {
        ...
        settings: ContentUpdateSettingsV1FromJSON(json["settings"]),
    };
}
...
export function ContentUpdatePolicyV1ToJSON(value?: ContentUpdatePolicyV1 | null): any {
    ...
    return {
        ...
        settings: ContentUpdateSettingsV1ToJSON(value["settings"]),
    };
}
