 ...
 *
 * @export
 * @interface AzureAzureRegistrationUpdateInput
 */
export interface AzureAzureRegistrationUpdateInput {
    /**
     *
     * @type {string}
     * @memberof AzureAzureRegistrationUpdateInput
     */
    accountType?: string;
    /**
     *
     ...
     * @type {AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeEnum}
     * @memberof AzureAzureRegistrationUpdateInput
     */
    dspmNetworkConfigurationType?: AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeEnum;
    /**
     *
     * @type {Array<string>}
     * @memberof AzureAzureRegistrationUpdateInput
 ...
 * @export
 */
export const AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeEnum = {
    Managed: "managed",
    ManagedNoNat: "managed_no_nat",
    Custom: "custom",
} as const;
export type AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeEnum =
    (typeof AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeEnum)[keyof typeof AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeEnum];

/**
 * Check if a given object implements the AzureAzureRegistrationUpdateInput interface.
 */
export function instanceOfAzureAzureRegistrationUpdateInput(value: object): value is AzureAzureRegistrationUpdateInput {
...
export function AzureAzureRegistrationUpdateInputFromJSON(json: any): AzureAzureRegistrationUpdateInput {
    return AzureAzureRegistrationUpdateInputFromJSONTyped(json, false);
}

export function AzureAzureRegistrationUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): AzureAzureRegistrationUpdateInput {
    if (json == null) {
        return json;
    }
    return {
...
export function AzureAzureRegistrationUpdateInputToJSON(json: any): AzureAzureRegistrationUpdateInput {
    return AzureAzureRegistrationUpdateInputToJSONTyped(json, false);
}

export function AzureAzureRegistrationUpdateInputToJSONTyped(value?: AzureAzureRegistrationUpdateInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
