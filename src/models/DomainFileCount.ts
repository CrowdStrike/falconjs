 ...
 */
export function instanceOfDomainFileCount(value: object): value is DomainFileCount {
    return true;
}
...
export function DomainFileCountFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainFileCount {
    ...
    return {
        malicious: json["malicious"] == null ? undefined : json["malicious"],
        ...
        traversed: json["traversed"] == null ? undefined : json["traversed"],
    };
}
