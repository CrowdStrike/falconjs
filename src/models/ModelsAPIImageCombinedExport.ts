 ...
 */
export function instanceOfModelsAPIImageCombinedExport(value: object): boolean {
    let isInstance = true;
    ...
    isInstance = isInstance && "detectionSeverity" in value;
    ...
    isInstance = isInstance && "packagesImpacted" in value;
    isInstance = isInstance && "registry" in value;
    isInstance = isInstance && "repository" in value;
    isInstance = isInstance && "startedContainers" in value;
    isInstance = isInstance && "stoppedContainers" in value;
    isInstance = isInstance && "tag" in value;
    isInstance = isInstance && "vulnerabilityCpsRating" in value;
    isInstance = isInstance && "vulnerabilityDescription" in value;
    isInstance = isInstance && "vulnerabilitySeverity" in value;
