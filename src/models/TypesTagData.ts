...
export function TypesTagDataToJSON(json: any): TypesTagData {
    return TypesTagDataToJSONTyped(json, false);
}

export function TypesTagDataToJSONTyped(value?: TypesTagData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
