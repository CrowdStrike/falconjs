 ...
 *
 * @export
 * @interface CorrelationrulesapiPatchRuleSearchV1
 */
export interface CorrelationrulesapiPatchRuleSearchV1 {
    /**
     *
     * @type {string}
...
export function CorrelationrulesapiPatchRuleSearchV1FromJSON(json: any): CorrelationrulesapiPatchRuleSearchV1 {
    return CorrelationrulesapiPatchRuleSearchV1FromJSONTyped(json, false);
}

export function CorrelationrulesapiPatchRuleSearchV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CorrelationrulesapiPatchRuleSearchV1 {
    if (json == null) {
        return json;
    }
    return {
