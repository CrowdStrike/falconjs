 ...
 * 
 * @export
 * @interface DomainListFilesResponseWrapper
 */
export interface DomainListFilesResponseWrapper {
    /**
     * 
     * @type {Array<MsaAPIError>}
     * @memberof DomainListFilesResponseWrapper
     */
 ...
 */
export function instanceOfDomainListFilesResponseWrapper(value: object): value is DomainListFilesResponseWrapper {
...
export function DomainListFilesResponseWrapperFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainListFilesResponseWrapper {
    if (json == null) {
        return json;
    }
    return {
        ...
        'resources': ((json['resources'] as Array<any>).map(ModelFileFromJSON)),
    };
}
...
export function DomainListFilesResponseWrapperToJSON(value?: DomainListFilesResponseWrapper | null): any {
    ...
    return {
        ...
        'resources': ((value['resources'] as Array<any>).map(ModelFileToJSON)),
    };
}
