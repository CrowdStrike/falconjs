 ...
 *
 * @export
 * @interface RegistrationGCPAccountReqObjV2
 */
export interface RegistrationGCPAccountReqObjV2 {
    /**
     *
     * @type {string}
     * @memberof RegistrationGCPAccountReqObjV2
     */
    clientEmail?: string;
    /**
     *
...
/**
 * Check if a given object implements the RegistrationGCPAccountReqObjV2 interface.
 */
export function instanceOfRegistrationGCPAccountReqObjV2(value: object): value is RegistrationGCPAccountReqObjV2 {
    if (!("parentId" in value) || value["parentId"] === undefined) return false;
    return true;
}

export function RegistrationGCPAccountReqObjV2FromJSON(json: any): RegistrationGCPAccountReqObjV2 {
    return RegistrationGCPAccountReqObjV2FromJSONTyped(json, false);
}

export function RegistrationGCPAccountReqObjV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): RegistrationGCPAccountReqObjV2 {
    if (json == null) {
        return json;
    }
    return {
...
export function RegistrationGCPAccountReqObjV2ToJSON(json: any): RegistrationGCPAccountReqObjV2 {
    return RegistrationGCPAccountReqObjV2ToJSONTyped(json, false);
}

export function RegistrationGCPAccountReqObjV2ToJSONTyped(value?: RegistrationGCPAccountReqObjV2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
