 ...
 *
 * @export
 * @interface DomainPlatform
 */
export interface DomainPlatform {
    /**
     *
     * @type {string}
     * @memberof DomainPlatform
     */
    id: string;
    /**
     *
 ...
 */
export function instanceOfDomainPlatform(value: object): value is DomainPlatform {
...
export function DomainPlatformFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainPlatform {
    if (json == null) {
        return json;
    }
    return {
