...
export function PoliciesDeleteResponseToJSON(json: any): PoliciesDeleteResponse {
    return PoliciesDeleteResponseToJSONTyped(json, false);
}

export function PoliciesDeleteResponseToJSONTyped(value?: PoliciesDeleteResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
