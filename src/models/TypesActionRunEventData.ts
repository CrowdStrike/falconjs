...
import {
    TypesCloudFunctionMetadataFromJSON,
    TypesCloudFunctionMetadataFromJSONTyped,
    TypesCloudFunctionMetadataToJSON,
} from './TypesCloudFunctionMetadata';
import type { TypesHostMetadata } from './TypesHostMetadata';
import {
    TypesHostMetadataFromJSON,
    TypesHostMetadataFromJSONTyped,
    TypesHostMetadataToJSON,
} from './TypesHostMetadata';
import type { TypesGCPMetadata } from './TypesGCPMetadata';
import {
    TypesGCPMetadataFromJSON,
    TypesGCPMetadataFromJSONTyped,
    TypesGCPMetadataToJSON,
} from './TypesGCPMetadata';
import type { TypesAWSMetadata } from './TypesAWSMetadata';
import {
    TypesAWSMetadataFromJSON,
    TypesAWSMetadataFromJSONTyped,
    TypesAWSMetadataToJSON,
} from './TypesAWSMetadata';
import type { TypesAzureVmMetadata } from './TypesAzureVmMetadata';
import {
    TypesAzureVmMetadataFromJSON,
    TypesAzureVmMetadataFromJSONTyped,
    TypesAzureVmMetadataToJSON,
} from './TypesAzureVmMetadata';
...
import {
    TypesECSMetadataFromJSON,
    TypesECSMetadataFromJSONTyped,
    TypesECSMetadataToJSON,
} from './TypesECSMetadata';
import type { TypesSonatypeMetadata } from './TypesSonatypeMetadata';
import {
    TypesSonatypeMetadataFromJSON,
    TypesSonatypeMetadataFromJSONTyped,
    TypesSonatypeMetadataToJSON,
} from './TypesSonatypeMetadata';
import type { TypesSnykMetadata } from './TypesSnykMetadata';
import {
    TypesSnykMetadataFromJSON,
    TypesSnykMetadataFromJSONTyped,
    TypesSnykMetadataToJSON,
} from './TypesSnykMetadata';
import type { TypesEC2Metadata } from './TypesEC2Metadata';
import {
    TypesEC2MetadataFromJSON,
    TypesEC2MetadataFromJSONTyped,
    TypesEC2MetadataToJSON,
} from './TypesEC2Metadata';
import type { TypesLambdaMetadata } from './TypesLambdaMetadata';
import {
    TypesLambdaMetadataFromJSON,
    TypesLambdaMetadataFromJSONTyped,
    TypesLambdaMetadataToJSON,
} from './TypesLambdaMetadata';
import type { TypesRemediation } from './TypesRemediation';
import {
    TypesRemediationFromJSON,
    TypesRemediationFromJSONTyped,
    TypesRemediationToJSON,
} from './TypesRemediation';
import type { TypesK8SMetadata } from './TypesK8SMetadata';
import {
    TypesK8SMetadataFromJSON,
    TypesK8SMetadataFromJSONTyped,
    TypesK8SMetadataToJSON,
} from './TypesK8SMetadata';
import type { TypesAzureSiteMetadata } from './TypesAzureSiteMetadata';
import {
    TypesAzureSiteMetadataFromJSON,
    TypesAzureSiteMetadataFromJSONTyped,
    TypesAzureSiteMetadataToJSON,
} from './TypesAzureSiteMetadata';
