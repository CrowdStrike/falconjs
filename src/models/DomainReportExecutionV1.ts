 ...
 */
export function instanceOfDomainReportExecutionV1(value: object): boolean {
    let isInstance = true;
...
export function DomainReportExecutionV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainReportExecutionV1 {
    ...
    return {
        ...
        executionMetadata: !exists(json, "execution_metadata") ? undefined : DomainExecutionMetadataV1FromJSON(json["execution_metadata"]),
