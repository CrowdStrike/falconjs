 ...
 */
export function instanceOfCoreEntitiesResponse(value: object): value is CoreEntitiesResponse {
...
export function CoreEntitiesResponseToJSON(json: any): CoreEntitiesResponse {
    return CoreEntitiesResponseToJSONTyped(json, false);
}

export function CoreEntitiesResponseToJSONTyped(value?: CoreEntitiesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
