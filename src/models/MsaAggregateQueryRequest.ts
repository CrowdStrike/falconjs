...
export interface MsaAggregateQueryRequest {
    ...
    /**
     *
     * @type {MsaAPIFiltersSpec}
     * @memberof MsaAggregateQueryRequest
     */
    filtersSpec: MsaAPIFiltersSpec;
    /**
     *
     * @type {number}
     * @memberof MsaAggregateQueryRequest
...
export function MsaAggregateQueryRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): MsaAggregateQueryRequest {
    ...
    return {
        ...
        field: json["field"],
        filter: json["filter"],
        filtersSpec: MsaAPIFiltersSpecFromJSON(json["filters_spec"]),
        from: json["from"],
...
export function MsaAggregateQueryRequestToJSON(value?: MsaAggregateQueryRequest | null): any {
    ...
    return {
        ...
        field: value["field"],
        filter: value["filter"],
        filters_spec: MsaAPIFiltersSpecToJSON(value["filtersSpec"]),
        from: value["from"],
