 ...
 *
 * @export
 * @interface V2InlineConfig
 */
export interface V2InlineConfig {
    /**
     *
     * @type {object}
...
/**
 * Check if a given object implements the V2InlineConfig interface.
 */
export function instanceOfV2InlineConfig(value: object): value is V2InlineConfig {
    return true;
}

export function V2InlineConfigFromJSON(json: any): V2InlineConfig {
    return V2InlineConfigFromJSONTyped(json, false);
}

export function V2InlineConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2InlineConfig {
    if (json == null) {
        return json;
    }
    return {
