...
export function ApiRuleV1ToJSON(json: any): ApiRuleV1 {
    return ApiRuleV1ToJSONTyped(json, false);
}

export function ApiRuleV1ToJSONTyped(value?: ApiRuleV1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
