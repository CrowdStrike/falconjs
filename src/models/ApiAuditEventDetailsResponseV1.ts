 ...
 *
 * @export
 * @interface ApiAuditEventDetailsResponseV1
 */
export interface ApiAuditEventDetailsResponseV1 {
    /**
     *
     * @type {Array<MsaAPIError>}
     * @memberof ApiAuditEventDetailsResponseV1
     */
    ...
    /**
     *
     * @type {Array<ApiAuditEventDetailsResourceV1>}
     * @memberof ApiAuditEventDetailsResponseV1
     */
 ...
 */
export function instanceOfApiAuditEventDetailsResponseV1(value: object): value is ApiAuditEventDetailsResponseV1 {
...
export function ApiAuditEventDetailsResponseV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiAuditEventDetailsResponseV1 {
    if (json == null) {
        return json;
    }
    return {
        ...
        resources: (json["resources"] as Array<any>).map(ApiAuditEventDetailsResourceV1FromJSON),
    };
}
...
export function ApiAuditEventDetailsResponseV1ToJSON(value?: ApiAuditEventDetailsResponseV1 | null): any {
    ...
    return {
        ...
        resources: (value["resources"] as Array<any>).map(ApiAuditEventDetailsResourceV1ToJSON),
    };
}
