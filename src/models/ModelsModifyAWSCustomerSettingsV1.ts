 ...
 *
 * @export
 * @interface ModelsModifyAWSCustomerSettingsV1
 */
export interface ModelsModifyAWSCustomerSettingsV1 {
    /**
     *
     * @type {Array<ModelsAWSCustomerSettingsRequestV1>}
     * @memberof ModelsModifyAWSCustomerSettingsV1
     */
 ...
 */
export function instanceOfModelsModifyAWSCustomerSettingsV1(value: object): value is ModelsModifyAWSCustomerSettingsV1 {
...
export function ModelsModifyAWSCustomerSettingsV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelsModifyAWSCustomerSettingsV1 {
    if (json == null) {
        return json;
    }
    return {
        resources: (json["resources"] as Array<any>).map(ModelsAWSCustomerSettingsRequestV1FromJSON),
    };
}
