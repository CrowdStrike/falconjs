...
export interface FalconxMalqueryReportV1 {
     ...
     */
    errors?: Array<FalconxMalqueryErrorV1> | null;
    /**
     *
     * @type {string}
     * @memberof FalconxMalqueryReportV1
...
export function FalconxMalqueryReportV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): FalconxMalqueryReportV1 {
    ...
    return {
        errors: !exists(json, "errors") ? undefined : json["errors"] === null ? null : (json["errors"] as Array<any>).map(FalconxMalqueryErrorV1FromJSON),
...
export function FalconxMalqueryReportV1ToJSON(value?: FalconxMalqueryReportV1 | null): any {
    ...
    return {
        errors: value.errors === undefined ? undefined : value.errors === null ? null : (value.errors as Array<any>).map(FalconxMalqueryErrorV1ToJSON),
        input: value.input,
