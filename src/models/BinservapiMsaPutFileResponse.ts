...
export function BinservapiMsaPutFileResponseToJSON(json: any): BinservapiMsaPutFileResponse {
    return BinservapiMsaPutFileResponseToJSONTyped(json, false);
}

export function BinservapiMsaPutFileResponseToJSONTyped(value?: BinservapiMsaPutFileResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
