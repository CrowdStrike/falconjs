 ...
 *
 * @export
 * @interface DomainMsaMetaInfoWithSearchAfter
 */
export interface DomainMsaMetaInfoWithSearchAfter {
    /**
     *
     * @type {DomainPagingWithSearchAfter}
     * @memberof DomainMsaMetaInfoWithSearchAfter
     */
    pagination?: DomainPagingWithSearchAfter;
    /**
     *
     * @type {string}
     * @memberof DomainMsaMetaInfoWithSearchAfter
...
/**
 * Check if a given object implements the DomainMsaMetaInfoWithSearchAfter interface.
 */
export function instanceOfDomainMsaMetaInfoWithSearchAfter(value: object): value is DomainMsaMetaInfoWithSearchAfter {
    if (!("queryTime" in value) || value["queryTime"] === undefined) return false;
    if (!("traceId" in value) || value["traceId"] === undefined) return false;
    return true;
}

export function DomainMsaMetaInfoWithSearchAfterFromJSON(json: any): DomainMsaMetaInfoWithSearchAfter {
    return DomainMsaMetaInfoWithSearchAfterFromJSONTyped(json, false);
}

export function DomainMsaMetaInfoWithSearchAfterFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainMsaMetaInfoWithSearchAfter {
    if (json == null) {
        return json;
    }
    return {
        pagination: json["pagination"] == null ? undefined : DomainPagingWithSearchAfterFromJSON(json["pagination"]),
