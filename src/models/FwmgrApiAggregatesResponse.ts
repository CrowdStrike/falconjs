...
export function FwmgrApiAggregatesResponseToJSON(json: any): FwmgrApiAggregatesResponse {
    return FwmgrApiAggregatesResponseToJSONTyped(json, false);
}

export function FwmgrApiAggregatesResponseToJSONTyped(value?: FwmgrApiAggregatesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
