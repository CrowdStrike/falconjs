 ...
 */
export function instanceOfChangesHost(value: object): boolean {
    let isInstance = true;
...
export function ChangesHostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangesHost {
    ...
    return {
        ...
        groups: !exists(json, "groups") ? undefined : (json["groups"] as Array<any>).map(ChangesHostGroupFromJSON),
...
export function ChangesHostToJSON(value?: ChangesHost | null): any {
    ...
    return {
        ...
        groups: value.groups === undefined ? undefined : (value.groups as Array<any>).map(ChangesHostGroupToJSON),
