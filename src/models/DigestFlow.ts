...
/**
 * Check if a given object implements the DigestFlow interface.
 */
export function instanceOfDigestFlow(value: object): value is DigestFlow {
...
export function DigestFlowFromJSON(json: any): DigestFlow {
    return DigestFlowFromJSONTyped(json, false);
}

export function DigestFlowFromJSONTyped(json: any, ignoreDiscriminator: boolean): DigestFlow {
    if (json == null) {
        return json;
    }
    return {
