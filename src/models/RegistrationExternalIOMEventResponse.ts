 ...
 */
export function instanceOfRegistrationExternalIOMEventResponse(value: object): boolean {
    let isInstance = true;
...
export function RegistrationExternalIOMEventResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegistrationExternalIOMEventResponse {
    ...
    return {
        ...
        resources: !exists(json, "resources") ? undefined : RegistrationIOMResourcesFromJSON(json["resources"]),
    };
}
