 ...
 */
export function instanceOfApiCustomerSettingsResourceV1(value: object): value is ApiCustomerSettingsResourceV1 {
    if (!("tokensRequired" in value) || value["tokensRequired"] === undefined) return false;
    return true;
}
