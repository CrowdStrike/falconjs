 ...
 * 
 * @export
 * @interface DeviceControlPolicyV1
 */
export interface DeviceControlPolicyV1 {
    /**
    ...
    /**
     * 
     * @type {DeviceControlSettingsRespV1}
     * @memberof DeviceControlPolicyV1
     */
    settings: DeviceControlSettingsRespV1;
}
 ...
 * @export
 */
export const DeviceControlPolicyV1PlatformNameEnum = {
    Windows: 'Windows',
    Mac: 'Mac',
    Linux: 'Linux'
} as const;
...
export function DeviceControlPolicyV1FromJSON(json: any): DeviceControlPolicyV1 {
    return DeviceControlPolicyV1FromJSONTyped(json, false);
}
...
export function DeviceControlPolicyV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DeviceControlPolicyV1 {
    ...
    return {
        ...
        'settings': DeviceControlSettingsRespV1FromJSON(json['settings']),
    };
}
