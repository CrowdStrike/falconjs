 ...
 */
export function instanceOfFirewallPolicyV1(value: object): value is FirewallPolicyV1 {
    if (!('channelVersion' in value) || value['channelVersion'] === undefined) return false;
