 ...
 *
 * @export
 * @interface FwmgrFirewallICMP
 */
export interface FwmgrFirewallICMP {
    /**
     *
     * @type {string}
     * @memberof FwmgrFirewallICMP
     */
    icmpCode: string;
    /**
     *
 ...
 */
export function instanceOfFwmgrFirewallICMP(value: object): value is FwmgrFirewallICMP {
...
export function FwmgrFirewallICMPFromJSONTyped(json: any, ignoreDiscriminator: boolean): FwmgrFirewallICMP {
    if (json == null) {
        return json;
    }
    return {
