 ...
 */
export function instanceOfDomainAPIQueryMetaV1(value: object): boolean {
    let isInstance = true;
...
export function DomainAPIQueryMetaV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainAPIQueryMetaV1 {
    ...
    return {
        pagination: !exists(json, "pagination") ? undefined : DomainAPIQueryPagingV1FromJSON(json["pagination"]),
