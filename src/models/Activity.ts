...
export interface Activity {
     ...
     * @memberof Activity
     */
    accessType?: TypesPolicyRulesCondition;
    /**
     *
     * @type {TypesPolicyRulesCondition}
     * @memberof Activity
     */
    accessTypeCustom?: TypesPolicyRulesCondition;
}
...
export function ActivityFromJSONTyped(json: any, ignoreDiscriminator: boolean): Activity {
    ...
    return {
        accessType: json["accessType"] == null ? undefined : TypesPolicyRulesConditionFromJSON(json["accessType"]),
        accessTypeCustom: json["accessTypeCustom"] == null ? undefined : TypesPolicyRulesConditionFromJSON(json["accessTypeCustom"]),
    };
}
