...
import {
    ModelsAPIPolicyEntityFromJSON,
    ModelsAPIPolicyEntityFromJSONTyped,
    ModelsAPIPolicyEntityToJSON,
} from './ModelsAPIPolicyEntity';
 ...
 * 
 * @export
 * @interface ModelsPolicyEntityResponse
 */
...
export function ModelsPolicyEntityResponseFromJSON(json: any): ModelsPolicyEntityResponse {
    return ModelsPolicyEntityResponseFromJSONTyped(json, false);
}

export function ModelsPolicyEntityResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelsPolicyEntityResponse {
    if (json == null) {
        return json;
    }
    return {
