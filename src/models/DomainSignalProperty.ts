 ...
 */
export function instanceOfDomainSignalProperty(value: object): value is DomainSignalProperty {
    if (!("criteria" in value) || value["criteria"] === undefined) return false;
    if (!("groupName" in value) || value["groupName"] === undefined) return false;
    if (!("meetsCriteria" in value) || value["meetsCriteria"] === undefined) return false;
    if (!("signalId" in value) || value["signalId"] === undefined) return false;
    if (!("signalName" in value) || value["signalName"] === undefined) return false;
    return true;
}
