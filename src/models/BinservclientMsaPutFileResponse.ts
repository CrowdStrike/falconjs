 ...
 *
 * @export
 * @interface BinservclientMsaPutFileResponse
 */
export interface BinservclientMsaPutFileResponse {
    /**
     *
     * @type {Array<MsaAPIError>}
     * @memberof BinservclientMsaPutFileResponse
     */
...
export function BinservclientMsaPutFileResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BinservclientMsaPutFileResponse {
...
export function BinservclientMsaPutFileResponseToJSON(value?: BinservclientMsaPutFileResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
