 ...
 */
export function instanceOfChangesDACL(value: object): boolean {
    let isInstance = true;
...
export function ChangesDACLFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangesDACL {
    ...
    return {
        changesType: !exists(json, "changes_type") ? undefined : json["changes_type"],
        entityList: !exists(json, "entity_list") ? undefined : (json["entity_list"] as Array<any>).map(ChangesDACLEntityFromJSON),
    };
}
...
export function ChangesDACLToJSON(value?: ChangesDACL | null): any {
    ...
    return {
        ...
        entity_list: value.entityList === undefined ? undefined : (value.entityList as Array<any>).map(ChangesDACLEntityToJSON),
    };
}
