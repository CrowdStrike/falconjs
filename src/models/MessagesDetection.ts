 ...
 *
 * @export
 * @interface MessagesDetection
 */
export interface MessagesDetection {
    /**
     *
     * @type {string}
 ...
 */
export function instanceOfMessagesDetection(value: object): value is MessagesDetection {
...
export function MessagesDetectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): MessagesDetection {
    if (json == null) {
        return json;
    }
    return {
