...
import {
    DomainUserRoleFromJSON,
    DomainUserRoleFromJSONTyped,
    DomainUserRoleToJSON,
} from './DomainUserRole';
 ...
 */
export function instanceOfApiUserRoleResponse(value: object): value is ApiUserRoleResponse {
