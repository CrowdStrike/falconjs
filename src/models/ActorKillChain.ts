 ...
 *
 * @export
 * @interface ActorKillChain
 */
export interface ActorKillChain {
    /**
     * Free form text describing actions and objectives of the actor
     * @type {string}
     * @memberof ActorKillChain
     */
...
/**
 * Check if a given object implements the ActorKillChain interface.
 */
export function instanceOfActorKillChain(value: object): value is ActorKillChain {
    return true;
}

export function ActorKillChainFromJSON(json: any): ActorKillChain {
    return ActorKillChainFromJSONTyped(json, false);
}

export function ActorKillChainFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActorKillChain {
    if (json == null) {
        return json;
    }
    return {
