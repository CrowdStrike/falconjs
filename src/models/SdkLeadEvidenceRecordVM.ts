 ...
 *
 * @export
 * @interface SdkLeadEvidenceRecordVM
 */
export interface SdkLeadEvidenceRecordVM {
     ...
     */
    selector: SdkLeadEvidenceSelector;
}
...
export function SdkLeadEvidenceRecordVMFromJSON(json: any): SdkLeadEvidenceRecordVM {
    return SdkLeadEvidenceRecordVMFromJSONTyped(json, false);
}

export function SdkLeadEvidenceRecordVMFromJSONTyped(json: any, ignoreDiscriminator: boolean): SdkLeadEvidenceRecordVM {
    if (json == null) {
        return json;
    }
    return {
...
export function SdkLeadEvidenceRecordVMToJSON(json: any): SdkLeadEvidenceRecordVM {
    return SdkLeadEvidenceRecordVMToJSONTyped(json, false);
}

export function SdkLeadEvidenceRecordVMToJSONTyped(value?: SdkLeadEvidenceRecordVM | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
