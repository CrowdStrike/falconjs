 ...
 *
 * @export
 * @interface DomainRoleIDs
 */
export interface DomainRoleIDs {
    /**
     *
     * @type {Array<string>}
     * @memberof DomainRoleIDs
     */
 ...
 */
export function instanceOfDomainRoleIDs(value: object): value is DomainRoleIDs {
...
export function DomainRoleIDsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainRoleIDs {
    if (json == null) {
        return json;
    }
    return {
