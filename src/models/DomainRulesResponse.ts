 ...
 */
export function instanceOfDomainRulesResponse(value: object): value is DomainRulesResponse {
...
export function DomainRulesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainRulesResponse {
    if (json == null) {
        return json;
    }
    return {
