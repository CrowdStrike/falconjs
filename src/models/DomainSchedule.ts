 ...
 */
export function instanceOfDomainSchedule(value: object): value is DomainSchedule {
    return true;
}
...
export function DomainScheduleFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainSchedule {
    ...
    return {
        ignoredByChannelfile: json["ignored_by_channelfile"] == null ? undefined : json["ignored_by_channelfile"],
