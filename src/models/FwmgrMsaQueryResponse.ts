 ...
 *
 * @export
 * @interface FwmgrMsaQueryResponse
 */
...
export function FwmgrMsaQueryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FwmgrMsaQueryResponse {
...
export function FwmgrMsaQueryResponseToJSON(value?: FwmgrMsaQueryResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
