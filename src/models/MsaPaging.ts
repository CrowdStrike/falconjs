 ...
 */
export function instanceOfMsaPaging(value: object): value is MsaPaging {
...
export function MsaPagingFromJSONTyped(json: any, ignoreDiscriminator: boolean): MsaPaging {
    if (json == null) {
        return json;
    }
    return {
