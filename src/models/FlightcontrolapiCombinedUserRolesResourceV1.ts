 ...
 *
 * @export
 * @interface FlightcontrolapiCombinedUserRolesResourceV1
 */
export interface FlightcontrolapiCombinedUserRolesResourceV1 {
    /**
     *
     * @type {string}
     * @memberof FlightcontrolapiCombinedUserRolesResourceV1
     */
    cid?: string;
    /**
     *
...
/**
 * Check if a given object implements the FlightcontrolapiCombinedUserRolesResourceV1 interface.
 */
export function instanceOfFlightcontrolapiCombinedUserRolesResourceV1(value: object): value is FlightcontrolapiCombinedUserRolesResourceV1 {
    if (!("roleId" in value) || value["roleId"] === undefined) return false;
    return true;
}

export function FlightcontrolapiCombinedUserRolesResourceV1FromJSON(json: any): FlightcontrolapiCombinedUserRolesResourceV1 {
    return FlightcontrolapiCombinedUserRolesResourceV1FromJSONTyped(json, false);
}

export function FlightcontrolapiCombinedUserRolesResourceV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): FlightcontrolapiCombinedUserRolesResourceV1 {
    if (json == null) {
        return json;
    }
    return {
