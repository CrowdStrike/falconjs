 ...
 */
export function instanceOfFwmgrMsaspecMetaInfo(value: object): boolean {
    let isInstance = true;
...
export function FwmgrMsaspecMetaInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): FwmgrMsaspecMetaInfo {
    ...
    return {
        pagination: !exists(json, "pagination") ? undefined : FwmgrMsaspecPagingFromJSON(json["pagination"]),
