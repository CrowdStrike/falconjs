...
import {
    ExecutionsTriggerResultFromJSON,
    ExecutionsTriggerResultFromJSONTyped,
    ExecutionsTriggerResultToJSON,
} from './ExecutionsTriggerResult';
import type { ExecutionsLoopResult } from './ExecutionsLoopResult';
import {
    ExecutionsLoopResultFromJSON,
    ExecutionsLoopResultFromJSONTyped,
    ExecutionsLoopResultToJSON,
} from './ExecutionsLoopResult';
