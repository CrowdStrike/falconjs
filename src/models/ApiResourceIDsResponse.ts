 ...
 */
export function instanceOfApiResourceIDsResponse(value: object): value is ApiResourceIDsResponse {
...
export function ApiResourceIDsResponseToJSON(json: any): ApiResourceIDsResponse {
    return ApiResourceIDsResponseToJSONTyped(json, false);
}

export function ApiResourceIDsResponseToJSONTyped(value?: ApiResourceIDsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
