 ...
 *
 * @export
 * @interface DeviceapiNetworkAddressHistoryResponseV1
 */
export interface DeviceapiNetworkAddressHistoryResponseV1 {
    /**
     *
     * @type {Array<MsaAPIError>}
     * @memberof DeviceapiNetworkAddressHistoryResponseV1
     */
    ...
    /**
     *
     * @type {Array<DeviceapiNetworkAddressHistoryV1>}
     * @memberof DeviceapiNetworkAddressHistoryResponseV1
     */
 ...
 */
export function instanceOfDeviceapiNetworkAddressHistoryResponseV1(value: object): value is DeviceapiNetworkAddressHistoryResponseV1 {
...
export function DeviceapiNetworkAddressHistoryResponseV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DeviceapiNetworkAddressHistoryResponseV1 {
    if (json == null) {
        return json;
    }
    return {
        ...
        resources: (json["resources"] as Array<any>).map(DeviceapiNetworkAddressHistoryV1FromJSON),
    };
}
...
export function DeviceapiNetworkAddressHistoryResponseV1ToJSON(value?: DeviceapiNetworkAddressHistoryResponseV1 | null): any {
    ...
    return {
        ...
        resources: (value["resources"] as Array<any>).map(DeviceapiNetworkAddressHistoryV1ToJSON),
    };
}
