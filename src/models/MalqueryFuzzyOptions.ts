 ...
 *
 * @export
 * @interface MalqueryFuzzyOptions
 */
export interface MalqueryFuzzyOptions {
    /**
     *
     * @type {Array<string>}
 ...
 */
export function instanceOfMalqueryFuzzyOptions(value: object): value is MalqueryFuzzyOptions {
    return true;
}
...
export function MalqueryFuzzyOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): MalqueryFuzzyOptions {
    if (json == null) {
        return json;
    }
    return {
