 ...
 * 
 * @export
 * @interface RegistrationAWSAccountPatchRequest
 */
export interface RegistrationAWSAccountPatchRequest {
    /**
     * 
     * @type {Array<RegistrationAWSAccountPatch>}
     * @memberof RegistrationAWSAccountPatchRequest
     */
 ...
 */
export function instanceOfRegistrationAWSAccountPatchRequest(value: object): value is RegistrationAWSAccountPatchRequest {
...
export function RegistrationAWSAccountPatchRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegistrationAWSAccountPatchRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'resources': ((json['resources'] as Array<any>).map(RegistrationAWSAccountPatchFromJSON)),
    };
}
