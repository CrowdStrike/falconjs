 ...
 *
 * @export
 * @interface ModelsSingleNodeExecutionCreateRequestV1
 */
export interface ModelsSingleNodeExecutionCreateRequestV1 {
    /**
     *
     * @type {ModelsDefinitionCreateRequestV2}
     * @memberof ModelsSingleNodeExecutionCreateRequestV1
     */
...
/**
 * Check if a given object implements the ModelsSingleNodeExecutionCreateRequestV1 interface.
 */
export function instanceOfModelsSingleNodeExecutionCreateRequestV1(value: object): value is ModelsSingleNodeExecutionCreateRequestV1 {
    if (!("mocks" in value) || value["mocks"] === undefined) return false;
    return true;
}

export function ModelsSingleNodeExecutionCreateRequestV1FromJSON(json: any): ModelsSingleNodeExecutionCreateRequestV1 {
    return ModelsSingleNodeExecutionCreateRequestV1FromJSONTyped(json, false);
}

export function ModelsSingleNodeExecutionCreateRequestV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelsSingleNodeExecutionCreateRequestV1 {
    if (json == null) {
        return json;
    }
    return {
