 ...
 */
export function instanceOfApiCustomerSettingsPatchRequestV1(value: object): value is ApiCustomerSettingsPatchRequestV1 {
    return true;
}
...
export function ApiCustomerSettingsPatchRequestV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiCustomerSettingsPatchRequestV1 {
    ...
    return {
        ...
        'maxActiveTokens': json['max_active_tokens'] == null ? undefined : json['max_active_tokens'],
        'tokensRequired': json['tokens_required'] == null ? undefined : json['tokens_required'],
    };
}
