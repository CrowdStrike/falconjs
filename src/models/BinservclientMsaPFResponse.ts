 ...
 *
 * @export
 * @interface BinservclientMsaPFResponse
 */
export interface BinservclientMsaPFResponse {
    /**
     *
     * @type {Array<MsaAPIError>}
     * @memberof BinservclientMsaPFResponse
     */
    ...
    /**
     *
     * @type {Array<BinservclientRemoteCommandPutFile>}
     * @memberof BinservclientMsaPFResponse
     */
...
export function BinservclientMsaPFResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BinservclientMsaPFResponse {
    ...
    return {
        ...
        resources: (json["resources"] as Array<any>).map(BinservclientRemoteCommandPutFileFromJSON),
    };
}

export function BinservclientMsaPFResponseToJSON(value?: BinservclientMsaPFResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        resources: (value.resources as Array<any>).map(BinservclientRemoteCommandPutFileToJSON),
    };
}
