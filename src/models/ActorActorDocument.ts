 ...
 * @export
 * @interface ActorActorDocument
 */
export interface ActorActorDocument {
    /**
     * Boolean field marking if actor is active
     * @type {boolean}
     * @memberof ActorActorDocument
     */
    active: boolean;
    /**
    ...
    /**
     *
     * @type {ActorECrimeKillChain}
     * @memberof ActorActorDocument
     */
    ecrimeKillChain?: ActorECrimeKillChain;
    /**
    ...
    /**
     *
     * @type {Array<ActorActorNewsDocument>}
     * @memberof ActorActorDocument
     */
    inReports?: Array<ActorActorNewsDocument>;
    /**
     *
     * @type {number}
     * @memberof ActorActorDocument
     ...
     * @memberof ActorActorDocument
     */
    usesDistinctIndicatorsCount?: number;
    /**
     *
     * @type {number}
     * @memberof ActorActorDocument
...
/**
 * Check if a given object implements the ActorActorDocument interface.
 */
export function instanceOfActorActorDocument(value: object): value is ActorActorDocument {
...
export function ActorActorDocumentFromJSON(json: any): ActorActorDocument {
    return ActorActorDocumentFromJSONTyped(json, false);
}

export function ActorActorDocumentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActorActorDocument {
    if (json == null) {
        return json;
    }
    return {
        ...
        ecrimeKillChain: json["ecrime_kill_chain"] == null ? undefined : ActorECrimeKillChainFromJSON(json["ecrime_kill_chain"]),
        ...
        id: json["id"],
        image: json["image"] == null ? undefined : ActorImageFromJSON(json["image"]),
        inReports: json["in_reports"] == null ? undefined : (json["in_reports"] as Array<any>).map(ActorActorNewsDocumentFromJSON),
        ...
        killChain: json["kill_chain"] == null ? undefined : ActorKillChainFromJSON(json["kill_chain"]),
        ...
        thumbnail: json["thumbnail"] == null ? undefined : ActorImageFromJSON(json["thumbnail"]),
        url: json["url"] == null ? undefined : json["url"],
        usesDistinctIndicatorsCount: json["uses_distinct_indicators_count"] == null ? undefined : json["uses_distinct_indicators_count"],
...
export function ActorActorDocumentToJSON(value?: ActorActorDocument | null): any {
    ...
    return {
        ...
        ecrime_kill_chain: ActorECrimeKillChainToJSON(value["ecrimeKillChain"]),
        ...
        id: value["id"],
        image: ActorImageToJSON(value["image"]),
        in_reports: value["inReports"] == null ? undefined : (value["inReports"] as Array<any>).map(ActorActorNewsDocumentToJSON),
        ...
        kill_chain: ActorKillChainToJSON(value["killChain"]),
        ...
        thumbnail: ActorImageToJSON(value["thumbnail"]),
        url: value["url"],
        uses_distinct_indicators_count: value["usesDistinctIndicatorsCount"],
