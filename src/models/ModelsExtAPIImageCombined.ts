 ...
 */
export function instanceOfModelsExtAPIImageCombined(value: object): boolean {
    let isInstance = true;
    ...
    isInstance = isInstance && "highestDetectionSeverity" in value;
    isInstance = isInstance && "highestVulnerabilitySeverity" in value;
    ...
    isInstance = isInstance && "reportUrlByIdAndDigest" in value;
    isInstance = isInstance && "reportUrlByRepoAndTag" in value;
