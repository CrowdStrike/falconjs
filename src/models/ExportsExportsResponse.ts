...
import type { DomainExternalExportJob } from "./DomainExternalExportJob";
import { DomainExternalExportJobFromJSON, DomainExternalExportJobFromJSONTyped, DomainExternalExportJobToJSON } from "./DomainExternalExportJob";
...
export interface ExportsExportsResponse {
    /**
     *
     * @type {Array<DomainExternalExportJob>}
     * @memberof ExportsExportsResponse
     */
    resources: Array<DomainExternalExportJob>;
    /**
     *
...
export function ExportsExportsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExportsExportsResponse {
    ...
    return {
        resources: (json["resources"] as Array<any>).map(DomainExternalExportJobFromJSON),
...
export function ExportsExportsResponseToJSON(value?: ExportsExportsResponse | null): any {
    ...
    return {
        resources: (value["resources"] as Array<any>).map(DomainExternalExportJobToJSON),
