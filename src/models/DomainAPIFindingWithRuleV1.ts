 ...
 */
export function instanceOfDomainAPIFindingWithRuleV1(value: object): boolean {
    let isInstance = true;
...
export function DomainAPIFindingWithRuleV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainAPIFindingWithRuleV1 {
    ...
    return {
        evaluationLogicType: !exists(json, "evaluation_logic_type") ? undefined : json["evaluation_logic_type"],
        evaluationReason: !exists(json, "evaluation_reason") ? undefined : json["evaluation_reason"],
        hostId: !exists(json, "host_id") ? undefined : json["host_id"],
        policyHostGroups: !exists(json, "policy_host_groups") ? undefined : json["policy_host_groups"],
        rule: !exists(json, "rule") ? undefined : DomainAPIFindingRuleV1FromJSON(json["rule"]),
        status: !exists(json, "status") ? undefined : json["status"],
        statusSinceTimestamp: !exists(json, "status_since_timestamp") ? undefined : json["status_since_timestamp"],
    };
}
