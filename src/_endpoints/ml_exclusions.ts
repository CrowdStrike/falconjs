...
export const _ml_exclusions_endpoints: Array<any> = [
    ...
    ["createMLExclusionsV1", "POST", "/policy/entities/ml-exclusions/v1", "Create the ML exclusions", "ml_exclusions", [{
        "name": "body",
        "in": "body",
        "required": 1
    }]],
    ["updateMLExclusionsV1", "PATCH", "/policy/entities/ml-exclusions/v1", "Update the ML exclusions", "ml_exclusions", [{
        "name": "body",
        "in": "body",
        "required": 1
    }]],
    ["deleteMLExclusionsV1", "DELETE", "/policy/entities/ml-exclusions/v1", "Delete the ML exclusions by id", "ml_exclusions", [{
        "type": "array",
        "items": {
            "type": "string"
        },
    ...
    ["queryMLExclusionsV1", "GET", "/policy/queries/ml-exclusions/v1", "Search for ML exclusions.", "ml_exclusions", [{
        "type": "string",
