...
export const _intel_endpoints: Array<any> = [
    ["QueryIntelActorEntities", "GET", "/intel/combined/actors/v1", "Get info about actors that match provided FQL filters.", "intel", [{
        ...
        "description": "The fields to return, or a predefined set of fields in the form of the collection name surrounded by two underscores like:\n\n\\_\\_\\<collection\\>\\_\\_.\n\nEx: slug \\_\\_full\\_\\_.\n\nDefaults to \\_\\_basic\\_\\_.",
        "name": "fields",
        "in": "query"
    }]],
    ["QueryIntelIndicatorEntities", "GET", "/intel/combined/indicators/v1", "Get info about indicators that match provided FQL filters.", "intel", [{
        "type": "integer",
    ...
    ["QueryIntelReportEntities", "GET", "/intel/combined/reports/v1", "Get info about reports that match provided FQL filters.", "intel", [{
        "type": "integer",
    ...
    ["GetIntelActorEntities", "GET", "/intel/entities/actors/v1", "Retrieve specific actors using their actor IDs.", "intel", [{
        "type": "array",
        "items": {
            "type": "string"
        },
    ...
    ["GetIntelIndicatorEntities", "POST", "/intel/entities/indicators/GET/v1", "Retrieve specific indicators using their indicator IDs.", "intel", [{
        "name": "body",
        "in": "body",
        "required": 1
    }]],
    ["GetMitreReport", "GET", "/intel/entities/mitre-reports/v1", "Export Mitre ATT&CK information for a given actor.", "intel", [{
        "type": "string",
    ...
    ["PostMitreAttacks", "POST", "/intel/entities/mitre/v1", "Retrieves report and observable IDs associated with the given actor and attacks", "intel", [{
        "name": "body",
        "in": "body",
        "required": 1
    }]],
    ["GetIntelReportPDF", "GET", "/intel/entities/report-files/v1", "Return a Report PDF attachment", "intel", [{
        "type": "string",
    ...
    ["GetIntelReportEntities", "GET", "/intel/entities/reports/v1", "Retrieve specific reports using their report IDs.", "intel", [{
        "type": "array",
        "items": {
            "type": "string"
        },
    ...
    ["GetIntelRuleFile", "GET", "/intel/entities/rules-files/v1", "Download earlier rule sets.", "intel", [{
        "type": "string",
    ...
    ["GetLatestIntelRuleFile", "GET", "/intel/entities/rules-latest-files/v1", "Download the latest rule set.", "intel", [{
        "type": "string",
        "description": "Choose the format you want the rule set in.",
        "name": "Accept",
        "in": "header"
    ...
    ["GetIntelRuleEntities", "GET", "/intel/entities/rules/v1", "Retrieve details for rule sets for the specified ids.", "intel", [{
        "type": "array",
        "items": {
            "type": "string"
        },
    ...
    ["GetVulnerabilities", "POST", "/intel/entities/vulnerabilities/GET/v1", "Get vulnerabilities", "intel", [{
        "name": "body",
        "in": "body",
        "required": 1
    }]],
    ["QueryIntelActorIds", "GET", "/intel/queries/actors/v1", "Get actor IDs that match provided FQL filters.", "intel", [{
        "type": "integer",
    ...
    ["QueryIntelIndicatorIds", "GET", "/intel/queries/indicators/v1", "Get indicators IDs that match provided FQL filters.", "intel", [{
        "type": "integer",
    ...
    ["QueryMitreAttacks", "GET", "/intel/queries/mitre/v1", "Gets MITRE tactics and techniques for the given actor", "intel", [{
        "type": "string",
    ...
    ["QueryIntelReportIds", "GET", "/intel/queries/reports/v1", "Get report IDs that match provided FQL filters.", "intel", [{
        "type": "integer",
    ...
    ["QueryIntelRuleIds", "GET", "/intel/queries/rules/v1", "Search for rule IDs that match provided filter criteria.", "intel", [{
        "type": "integer",
        "description": "Set the starting row number to return reports from. Defaults to 0.",
        "name": "offset",
        "in": "query"
    ...
    ["QueryVulnerabilities", "GET", "/intel/queries/vulnerabilities/v1", "Get vulnerabilities IDs", "intel", [{
        "type": "string",
