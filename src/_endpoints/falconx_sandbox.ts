...
export var _falconx_sandbox_endpoints: Array<any> = [
    ...
    ["GetMemoryDumpExtractedStrings", "GET", "/falconx/entities/memory-dump/extracted-strings/v1", "Get extracted strings from a memory dump", "falconx_sandbox", [{
        "type": "string",
    ...
    ["GetMemoryDumpHexDump", "GET", "/falconx/entities/memory-dump/hex-dump/v1", "Get hex view of a memory dump", "falconx_sandbox", [{
        "type": "string",
    ...
    ["GetMemoryDump", "GET", "/falconx/entities/memory-dump/v1", "Get memory dump content, as binary", "falconx_sandbox", [{
        "type": "string",
    ...
    ["GetSummaryReports", "GET", "/falconx/entities/report-summaries/v1", "Get a short summary version of a sandbox report.", "falconx_sandbox", [{
        "type": "array",
        "items": {
            "type": "string"
        },
    ...
    ["GetReports", "GET", "/falconx/entities/reports/v1", "Get a full sandbox report.", "falconx_sandbox", [{
        "type": "array",
        "items": {
            "type": "string"
        },
    ...
    ["DeleteReport", "DELETE", "/falconx/entities/reports/v1", "Delete report based on the report ID. Operation can be checked for success by polling for the report ID on the report-summaries endpoint.", "falconx_sandbox", [{
        "type": "string",
    ...
    ["QueryReports", "GET", "/falconx/queries/reports/v1", "Find sandbox reports by providing an FQL filter and paging details. Returns a set of report IDs that match your criteria.", "falconx_sandbox", [{
        "type": "string",
    ...
    ["QuerySubmissions", "GET", "/falconx/queries/submissions/v1", "Find submission IDs for uploaded files by providing an FQL filter and paging details. Returns a set of submission IDs that match your criteria.", "falconx_sandbox", [{
        "type": "string",
        "description": "Optional filter and sort criteria in the form of an FQL query. For more information about FQL queries, see [our FQL documentation in Falcon](https://falcon.crowdstrike.com/support/documentation/45/falcon-query-language-feature-guide).",
        "name": "filter",
        "in": "query"
    ...
    ["GetSampleV2", "GET", "/samples/entities/samples/v2", "Retrieves the file associated with the given ID (SHA256)", "falconx_sandbox", [{
        "type": "string",
    ...
    ["UploadSampleV2", "POST", "/samples/entities/samples/v2", "Upload a file for sandbox analysis. After uploading, use `/falconx/entities/submissions/v1` to start analyzing the file.", "falconx_sandbox", [{
    ...
    ["DeleteSampleV2", "DELETE", "/samples/entities/samples/v2", "Removes a sample, including file, meta and submissions from the collection", "falconx_sandbox", [{
        "type": "string",
        "description": "The file SHA256.",
        "name": "ids",
        "in": "query",
    ...
    ["QuerySampleV1", "POST", "/samples/queries/samples/GET/v1", "Retrieves a list with sha256 of samples that exist and customer has rights to access them, maximum number of accepted items is 200", "falconx_sandbox", [{
