...
export var _iocs_endpoints: Array<any> = [
    ...
    ["GetIOC", "GET", "/indicators/entities/iocs/v1", "Get an IOC by providing a type and value. *** Deprecated - Use the new IOC Management endpoint (GET /iocs/entities/indicators/v1). ***", "iocs", [{
        "type": "string",
        "description": "\nThe type of the indicator. Valid types include:\n\nsha256: A hex-encoded sha256 hash string. Length - min: 64, max: 64.\n\nmd5: A hex-encoded md5 hash string. Length - min 32, max: 32.\n\ndomain: A domain name. Length - min: 1, max: 200.\n\nipv4: An IPv4 address. Must be a valid IP address.\n\nipv6: An IPv6 address. Must be a valid IP address.\n",
        "name": "type",
        "in": "query",
    ...
    ["CreateIOC", "POST", "/indicators/entities/iocs/v1", "Create a new IOC. *** Deprecated - Use the new IOC Management endpoint (POST /iocs/entities/indicators/v1). ***", "iocs", [{
    ...
    ["UpdateIOC", "PATCH", "/indicators/entities/iocs/v1", "Update an IOC by providing a type and value. *** Deprecated - Use the new IOC Management endpoint (PATCH /iocs/entities/indicators/v1). ***", "iocs", [{
        "name": "body",
        "in": "body",
        "required": 1
    }, {
    ...
    ["DeleteIOC", "DELETE", "/indicators/entities/iocs/v1", "Delete an IOC by providing a type and value. *** Deprecated - Use the new IOC Management endpoint (DELETE /iocs/entities/indicators/v1). ***", "iocs", [{
        "type": "string",
        "description": "\nThe type of the indicator. Valid types include:\n\nsha256: A hex-encoded sha256 hash string. Length - min: 64, max: 64.\n\nmd5: A hex-encoded md5 hash string. Length - min 32, max: 32.\n\ndomain: A domain name. Length - min: 1, max: 200.\n\nipv4: An IPv4 address. Must be a valid IP address.\n\nipv6: An IPv6 address. Must be a valid IP address.\n",
        "name": "type",
        "in": "query",
    ...
    ["DevicesRanOn", "GET", "/indicators/queries/devices/v1", "Find hosts that have observed a given custom IOC. For details about those hosts, use GET /devices/entities/devices/v1", "iocs", [{
        "type": "string",
        "description": "\nThe type of the indicator. Valid types include:\n\nsha256: A hex-encoded sha256 hash string. Length - min: 64, max: 64.\n\nmd5: A hex-encoded md5 hash string. Length - min 32, max: 32.\n\ndomain: A domain name. Length - min: 1, max: 200.\n\nipv4: An IPv4 address. Must be a valid IP address.\n\nipv6: An IPv6 address. Must be a valid IP address.\n",
        "name": "type",
        "in": "query",
    ...
    ["QueryIOCs", "GET", "/indicators/queries/iocs/v1", "Search the custom IOCs in your customer account. *** Deprecated - Use the new IOC Management endpoint (GET /iocs/queries/indicators/v1). ***", "iocs", [{
        "type": "string",
        "description": "\nThe type of the indicator. Valid types include:\n\nsha256: A hex-encoded sha256 hash string. Length - min: 64, max: 64.\n\nmd5: A hex-encoded md5 hash string. Length - min 32, max: 32.\n\ndomain: A domain name. Length - min: 1, max: 200.\n\nipv4: An IPv4 address. Must be a valid IP address.\n\nipv6: An IPv6 address. Must be a valid IP address.\n",
        "name": "types",
        "in": "query"
    ...
    ["ProcessesRanOn", "GET", "/indicators/queries/processes/v1", "Search for processes associated with a custom IOC", "iocs", [{
        "type": "string",
        "description": "\nThe type of the indicator. Valid types include:\n\nsha256: A hex-encoded sha256 hash string. Length - min: 64, max: 64.\n\nmd5: A hex-encoded md5 hash string. Length - min 32, max: 32.\n\ndomain: A domain name. Length - min: 1, max: 200.\n\nipv4: An IPv4 address. Must be a valid IP address.\n\nipv6: An IPv6 address. Must be a valid IP address.\n",
        "name": "type",
        "in": "query",
    ...
    ["entities_processes", "GET", "/processes/entities/processes/v1", "For the provided ProcessID retrieve the process details", "iocs", [{
        "type": "array",
        "items": {
            "type": "string"
        },
