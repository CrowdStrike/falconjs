        ...
        [
            {
                type: "string",
                description:
                    "A FQL compatible query string. Terms: [id cid profile_id host_id scan_id host_scan_id filecount.scanned filecount.malicious filecount.quarantined filecount.skipped affected_hosts_count status severity completed_on started_on last_updated]",
                name: "filter",
                in: "query",
                allowEmptyValue: 1,
            },
        ...
        [
            {
                type: "string",
                description:
                    "A FQL compatible query string. Terms: [id cid profile_id description.keyword initiated_from filecount.scanned filecount.malicious filecount.quarantined filecount.skipped affected_hosts_count status severity scan_started_on scan_completed_on created_on created_by last_updated]",
                name: "filter",
                in: "query",
                allowEmptyValue: 1,
            },
