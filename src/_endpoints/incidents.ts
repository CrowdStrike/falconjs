export const _incidents_endpoints: Array<any> = [
    ...
    ["GetBehaviors", "POST", "/incidents/entities/behaviors/GET/v1", "Get details on behaviors by providing behavior IDs", "incidents", [{
        "name": "body",
        "in": "body",
        "required": 1
    }]],
    ["PerformIncidentAction", "POST", "/incidents/entities/incident-actions/v1", "Perform a set of actions on one or more incidents, such as adding tags or comments or updating the incident name or description", "incidents", [{
        "type": "boolean",
        "default": 0,
    ...
    ["GetIncidents", "POST", "/incidents/entities/incidents/GET/v1", "Get details on incidents by providing incident IDs", "incidents", [{
        "name": "body",
        "in": "body",
        "required": 1
    }]],
    ["QueryBehaviors", "GET", "/incidents/queries/behaviors/v1", "Search for behaviors by providing an FQL filter, sorting, and paging details", "incidents", [{
        "type": "string",
        "description": "Optional filter and sort criteria in the form of an FQL query. For more information about FQL queries, see [our FQL documentation in Falcon](https://falcon.crowdstrike.com/support/documentation/45/falcon-query-language-feature-guide).",
        "name": "filter",
        "in": "query"
    ...
    ["QueryIncidents", "GET", "/incidents/queries/incidents/v1", "Search for incidents by providing an FQL filter, sorting, and paging details", "incidents", [{
