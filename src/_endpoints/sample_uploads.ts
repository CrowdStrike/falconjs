...
export var _sample_uploads_endpoints: Array<any> = [
    ...
    ["ArchiveGetV1", "GET", "/archives/entities/archives/v1", "Retrieves the archives upload operation statuses. Status `done` means that archive was processed successfully. Status `error` means that archive was not processed successfully.", "sample_uploads", [{
        "type": "string",
        "description": "The archive SHA256.",
        "name": "id",
        "in": "query",
    ...
    ["ArchiveUploadV1", "POST", "/archives/entities/archives/v1", "Uploads an archive and extracts files list from it. Operation is asynchronous use the ListArchivesV1 operation to check the status. After uploading, use the ExtractionCreateV1 operation to copy the file to internal storage making it available for content analysis. This method is deprecated in favor of ArchiveUploadV2.", "sample_uploads", [{
        ...
        "type": "boolean",
        "default": 1,
        "description": "Defines visibility of this file, either via the API or the Falcon console. - `true`: File is only shown to users within your customer account - `false`: File can be seen by other CrowdStrike customers.  Default: `true`.",
    ...
    ["ArchiveDeleteV1", "DELETE", "/archives/entities/archives/v1", "Delete an archive that was uploaded previously", "sample_uploads", [{
        "type": "string",
        "description": "The archive SHA256.",
        "name": "id",
        "in": "query",
    ...
    ["ArchiveUploadV2", "POST", "/archives/entities/archives/v2", "Uploads an archive and extracts files list from it. Operation is asynchronous use `/archives/entities/archives/v1` to check the status. After uploading, use `/archives/entities/extractions/v1` to copy the file to internal storage making it available for content analysis.", "sample_uploads", [{
        ...
        "type": "boolean",
        "default": 1,
        "description": "Defines visibility of this file in Falcon MalQuery, either via the API or the Falcon console. For example, use `--form is_confidential=` when using cURL.\n\n- `true`: File is only shown to users within your customer account\n- `false`: File can be seen by other CrowdStrike customers \n\nDefault: `true`.",
        "name": "is_confidential",
        "in": "formData"
    }, {
        "type": "string",
    ...
    ["ExtractionListV1", "GET", "/archives/entities/extraction-files/v1", "Retrieves the files extractions in chunks. Status `done` means that all files were processed successfully. Status `error` means that at least one of the file could not be processed.", "sample_uploads", [{
        "type": "string",
    ...
    ["ExtractionGetV1", "GET", "/archives/entities/extractions/v1", "Retrieves the files extraction operation statuses. Status `done` means that all files were processed successfully. Status `error` means that at least one of the file could not be processed.", "sample_uploads", [{
        "type": "string",
        "description": "The extraction operation ID.",
        "name": "id",
        "in": "query",
    ...
    ["ExtractionCreateV1", "POST", "/archives/entities/extractions/v1", "Extracts files from an uploaded archive and copies them to internal storage making it available for content analysis.", "sample_uploads", [{
        "name": "body",
        "in": "body",
        "required": 1
    }]],
    ["GetSampleV3", "GET", "/samples/entities/samples/v3", "Retrieves the file associated with the given ID (SHA256)", "sample_uploads", [{
        "type": "string",
    ...
    ["UploadSampleV3", "POST", "/samples/entities/samples/v3", "Upload a file for further cloud analysis. After uploading, call the specific analysis API endpoint.", "sample_uploads", [{
    ...
    ["DeleteSampleV3", "DELETE", "/samples/entities/samples/v3", "Removes a sample, including file, meta and submissions from the collection", "sample_uploads", [{
        "type": "string",
        "description": "The file SHA256.",
        "name": "ids",
        "in": "query",
