export const _zero_trust_assessment_endpoints: Array<any> = [
    ...
    ["getAuditV1", "GET", "/zero-trust-assessment/entities/audit/v1", "Get the Zero Trust Assessment audit report for one customer ID (CID).", "zero_trust_assessment", []],
    [
        ...
        [
            ...
            {
                type: "integer",
                description: "The number of scores to return in this response (min: 1, max: 1000, default: 100). " + "Use with the `after` parameter to manage pagination of results.",
                name: "limit",
                in: "query",
            },
            {
    ...
    [
        ...
        [
            ...
            },
            {
                ...
                collectionFormat: "multi",
                description: "Select constious details blocks to be returned for each assessment entity. " + "Supported values:\n\n<ul><li>host</li><li>finding.rule</li></ul>",
                name: "facet",
                in: "query",
            },
        ],
