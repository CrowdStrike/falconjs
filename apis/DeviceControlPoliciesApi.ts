...
export class DeviceControlPoliciesApi extends runtime.BaseAPI {
     ...
     */
    async performDeviceControlPoliciesActionRaw(requestParameters: PerformDeviceControlPoliciesActionRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ResponsesDeviceControlPoliciesV1>> {
     ...
     * Perform the specified action on the Device Control Policies specified in the request
     */
    async performDeviceControlPoliciesAction(actionName: PerformDeviceControlPoliciesActionActionNameEnum, body: MsaEntityActionRequestV2, initOverrides?: RequestInit): Promise<ResponsesDeviceControlPoliciesV1> {
     ...
     */
    async queryCombinedDeviceControlPoliciesRaw(requestParameters: QueryCombinedDeviceControlPoliciesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ResponsesDeviceControlPoliciesV1>> {
        const queryParameters: any = {};
     ...
     * Search for Device Control Policies in your environment by providing an FQL filter and paging details. Returns a set of Device Control Policies which match the filter criteria
     */
    async queryCombinedDeviceControlPolicies(filter?: string, offset?: number, limit?: number, sort?: QueryCombinedDeviceControlPoliciesSortEnum, initOverrides?: RequestInit): Promise<ResponsesDeviceControlPoliciesV1> {
     ...
     */
    async queryCombinedDeviceControlPolicyMembersRaw(requestParameters: QueryCombinedDeviceControlPolicyMembersRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ResponsesPolicyMembersRespV1>> {
        const queryParameters: any = {};
