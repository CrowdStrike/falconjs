...
export class IntelApi extends runtime.BaseAPI {
     ...
     * Get info about indicators that match provided FQL filters.
     */
    async queryIntelIndicatorEntities(offset?: number, limit?: number, sort?: string, filter?: string, q?: string, includeDeleted?: boolean, includeRelations?: boolean, initOverrides?: RequestInit): Promise<DomainPublicIndicatorsV3Response> {
     ...
     * Get indicators IDs that match provided FQL filters.
     */
    async queryIntelIndicatorIds(offset?: number, limit?: number, sort?: string, filter?: string, q?: string, includeDeleted?: boolean, includeRelations?: boolean, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     * Search for rule IDs that match provided filter criteria.
     */
    async queryIntelRuleIds(type: string, offset?: number, limit?: number, sort?: string, name?: Array<string>, description?: Array<string>, tags?: Array<string>, minCreatedDate?: number, maxCreatedDate?: string, q?: string, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
