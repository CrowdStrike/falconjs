...
export class SensorVisibilityExclusionsApi extends runtime.BaseAPI {
     ...
     * Search for sensor visibility exclusions.
     */
    async querySensorVisibilityExclusionsV1(filter?: string, offset?: number, limit?: number, sort?: QuerySensorVisibilityExclusionsV1SortEnum, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
