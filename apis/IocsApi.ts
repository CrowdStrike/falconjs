...
export class IocsApi extends runtime.BaseAPI {
     ...
     */
    async devicesCountRaw(requestParameters: DevicesCountRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ApiMsaReplyIOCDevicesCount>> {
     ...
     * Number of hosts in your customer account that have observed a given custom IOC
     */
    async devicesCount(type: string, value: string, initOverrides?: RequestInit): Promise<ApiMsaReplyIOCDevicesCount> {
     ...
     */
    async devicesRanOnRaw(requestParameters: DevicesRanOnRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ApiMsaReplyDevicesRanOn>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
     ...
     * Find hosts that have observed a given custom IOC. For details about those hosts, use GET /devices/entities/devices/v1
     */
    async devicesRanOn(type: string, value: string, limit?: string, offset?: string, initOverrides?: RequestInit): Promise<ApiMsaReplyDevicesRanOn> {
     ...
     */
    async entitiesProcessesRaw(requestParameters: EntitiesProcessesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ApiMsaProcessDetailResponse>> {
     ...
     * For the provided ProcessID retrieve the process details
     */
    async entitiesProcesses(ids: Array<string>, initOverrides?: RequestInit): Promise<ApiMsaProcessDetailResponse> {
     ...
     */
    async processesRanOnRaw(requestParameters: ProcessesRanOnRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ApiMsaReplyProcessesRanOn>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
     ...
     * Search for processes associated with a custom IOC
     */
    async processesRanOn(type: string, value: string, deviceId: string, limit?: string, offset?: string, initOverrides?: RequestInit): Promise<ApiMsaReplyProcessesRanOn> {
