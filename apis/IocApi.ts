...
export class IocApi extends runtime.BaseAPI {
     ...
     * Get Combined for Indicators.
     */
    async indicatorCombinedV1(filter?: string, offset?: number, limit?: number, sort?: IndicatorCombinedV1SortEnum, after?: string, fromParent?: boolean, initOverrides?: RequestInit): Promise<ApiIndicatorRespV1> {
