...
export class ReconApi extends runtime.BaseAPI {
     ...
     */
    async getNotificationsDetailedTranslatedV1Raw(requestParameters: GetNotificationsDetailedTranslatedV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DomainNotificationDetailsResponseV1>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
