...
export class PreventionPoliciesApi extends runtime.BaseAPI {
     ...
     * Perform the specified action on the Prevention Policies specified in the request
     */
    async performPreventionPoliciesAction(actionName: PerformPreventionPoliciesActionActionNameEnum, body: MsaEntityActionRequestV2, initOverrides?: RequestInit): Promise<ResponsesPreventionPoliciesV1> {
     ...
     * Search for Prevention Policies in your environment by providing an FQL filter and paging details. Returns a set of Prevention Policies which match the filter criteria
     */
    async queryCombinedPreventionPolicies(filter?: string, offset?: number, limit?: number, sort?: QueryCombinedPreventionPoliciesSortEnum, initOverrides?: RequestInit): Promise<ResponsesPreventionPoliciesV1> {
     ...
     */
    async queryCombinedPreventionPolicyMembersRaw(requestParameters: QueryCombinedPreventionPolicyMembersRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ResponsesPolicyMembersRespV1>> {
        const queryParameters: any = {};
