...
export class UserManagementApi extends runtime.BaseAPI {
     ...
     */
    async createUserRaw(requestParameters: CreateUserRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DomainUserMetaDataResponse>> {
     ...
     * Create a new user. After creating a user, assign one or more roles with POST /user-roles/entities/user-roles/v1
     */
    async createUser(body: DomainUserCreateRequest, initOverrides?: RequestInit): Promise<DomainUserMetaDataResponse> {
     ...
     */
    async deleteUserRaw(requestParameters: DeleteUserRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaReplyMetaOnly>> {
     ...
     * Delete a user permanently
     */
    async deleteUser(userUuid: string, initOverrides?: RequestInit): Promise<MsaReplyMetaOnly> {
     ...
     */
    async getAvailableRoleIdsRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Show role IDs for all roles available in your customer account. For more information on each role, provide the role ID to `/customer/entities/roles/v1`.
     */
    async getAvailableRoleIds(initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async getRolesRaw(requestParameters: GetRolesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DomainUserRoleResponse>> {
     ...
     * Get info about a role
     */
    async getRoles(ids: Array<string>, initOverrides?: RequestInit): Promise<DomainUserRoleResponse> {
     ...
     */
    async getUserRoleIdsRaw(requestParameters: GetUserRoleIdsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        if (requestParameters.userUuid === null || requestParameters.userUuid === undefined) {
     ...
     * Show role IDs of roles assigned to a user. For more information on each role, provide the role ID to `/customer/entities/roles/v1`.
     */
    async getUserRoleIds(userUuid: string, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async grantUserRoleIdsRaw(requestParameters: GrantUserRoleIdsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DomainUserRoleIDsResponse>> {
        if (requestParameters.userUuid === null || requestParameters.userUuid === undefined) {
     ...
     * Assign one or more roles to a user
     */
    async grantUserRoleIds(userUuid: string, body: DomainRoleIDs, initOverrides?: RequestInit): Promise<DomainUserRoleIDsResponse> {
     ...
     */
    async retrieveEmailsByCIDRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * List the usernames (usually an email address) for all users in your customer account
     */
    async retrieveEmailsByCID(initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async retrieveUserRaw(requestParameters: RetrieveUserRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DomainUserMetaDataResponse>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Get info about a user
     */
    async retrieveUser(ids: Array<string>, initOverrides?: RequestInit): Promise<DomainUserMetaDataResponse> {
     ...
     */
    async retrieveUserUUIDRaw(requestParameters: RetrieveUserUUIDRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
     ...
     * Get a user\'s ID by providing a username (usually an email address)
     */
    async retrieveUserUUID(uid: Array<string>, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async retrieveUserUUIDsByCIDRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * List user IDs for all users in your customer account. For more information on each user, provide the user ID to `/users/entities/user/v1`.
     */
    async retrieveUserUUIDsByCID(initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async revokeUserRoleIdsRaw(requestParameters: RevokeUserRoleIdsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DomainUserRoleIDsResponse>> {
        if (requestParameters.userUuid === null || requestParameters.userUuid === undefined) {
     ...
     * Revoke one or more roles from a user
     */
    async revokeUserRoleIds(userUuid: string, ids: Array<string>, initOverrides?: RequestInit): Promise<DomainUserRoleIDsResponse> {
     ...
     */
    async updateUserRaw(requestParameters: UpdateUserRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DomainUserMetaDataResponse>> {
        if (requestParameters.userUuid === null || requestParameters.userUuid === undefined) {
     ...
     * Modify an existing user\'s first or last name
     */
    async updateUser(userUuid: string, body: DomainUpdateUserFields, initOverrides?: RequestInit): Promise<DomainUserMetaDataResponse> {
