...
export class MalqueryApi extends runtime.BaseAPI {
     ...
     */
    async getMalQueryDownloadV1Raw(requestParameters: GetMalQueryDownloadV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Download a file indexed by MalQuery. Specify the file using its SHA256. Only one file is supported at this time
     */
    async getMalQueryDownloadV1(ids: Array<string>, initOverrides?: RequestInit): Promise<void> {
     ...
     */
    async getMalQueryEntitiesSamplesFetchV1Raw(requestParameters: GetMalQueryEntitiesSamplesFetchV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Fetch a zip archive with password \'infected\' containing the samples. Call this once the /entities/samples-multidownload request has finished processing
     */
    async getMalQueryEntitiesSamplesFetchV1(ids: string, initOverrides?: RequestInit): Promise<void> {
     ...
     */
    async getMalQueryMetadataV1Raw(requestParameters: GetMalQueryMetadataV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MalquerySampleMetadataResponse>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Retrieve indexed files metadata by their hash
     */
    async getMalQueryMetadataV1(ids: Array<string>, initOverrides?: RequestInit): Promise<MalquerySampleMetadataResponse> {
     ...
     */
    async getMalQueryQuotasV1Raw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<MalqueryRateLimitsResponse>> {
        const queryParameters: any = {};
     ...
     * Get information about search and download quotas in your environment
     */
    async getMalQueryQuotasV1(initOverrides?: RequestInit): Promise<MalqueryRateLimitsResponse> {
     ...
     */
    async getMalQueryRequestV1Raw(requestParameters: GetMalQueryRequestV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MalqueryRequestResponse>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Check the status and results of an asynchronous request, such as hunt or exact-search. Supports a single request id at this time.
     */
    async getMalQueryRequestV1(ids: Array<string>, initOverrides?: RequestInit): Promise<MalqueryRequestResponse> {
     ...
     */
    async postMalQueryEntitiesSamplesMultidownloadV1Raw(requestParameters: PostMalQueryEntitiesSamplesMultidownloadV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MalqueryExternalQueryResponse>> {
     ...
     * Schedule samples for download. Use the result id with the /request endpoint to check if the download is ready after which you can call the /entities/samples-fetch to get the zip
     */
    async postMalQueryEntitiesSamplesMultidownloadV1(body: MalqueryMultiDownloadRequestV1, initOverrides?: RequestInit): Promise<MalqueryExternalQueryResponse> {
     ...
     */
    async postMalQueryExactSearchV1Raw(requestParameters: PostMalQueryExactSearchV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MalqueryExternalQueryResponse>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * Search Falcon MalQuery for a combination of hex patterns and strings in order to identify samples based upon file content at byte level granularity. You can filter results on criteria such as file type, file size and first seen date. Returns a request id which can be used with the /request endpoint
     */
    async postMalQueryExactSearchV1(body: MalqueryExternalExactSearchParametersV1, initOverrides?: RequestInit): Promise<MalqueryExternalQueryResponse> {
     ...
     */
    async postMalQueryFuzzySearchV1Raw(requestParameters: PostMalQueryFuzzySearchV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MalqueryFuzzySearchResponse>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * Search Falcon MalQuery quickly, but with more potential for false positives. Search for a combination of hex patterns and strings in order to identify samples based upon file content at byte level granularity.
     */
    async postMalQueryFuzzySearchV1(body: MalqueryFuzzySearchParametersV1, initOverrides?: RequestInit): Promise<MalqueryFuzzySearchResponse> {
     ...
     */
    async postMalQueryHuntV1Raw(requestParameters: PostMalQueryHuntV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MalqueryExternalQueryResponse>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * Schedule a YARA-based search for execution. Returns a request id which can be used with the /request endpoint
     */
    async postMalQueryHuntV1(body: MalqueryExternalHuntParametersV1, initOverrides?: RequestInit): Promise<MalqueryExternalQueryResponse> {
