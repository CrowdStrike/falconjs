...
export class HostsApi extends runtime.BaseAPI {
     ...
     */
    async queryGetNetworkAddressHistoryV1Raw(requestParameters: QueryGetNetworkAddressHistoryV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeviceapiNetworkAddressHistoryResponseV1>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
