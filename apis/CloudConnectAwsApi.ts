...
export class CloudConnectAwsApi extends runtime.BaseAPI {
     ...
     */
    async createOrUpdateAWSSettingsRaw(requestParameters: CreateOrUpdateAWSSettingsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelsCustomerConfigurationsV1>> {
     ...
     * Create or update Global Settings which are applicable to all provisioned AWS accounts
     */
    async createOrUpdateAWSSettings(body: ModelsModifyAWSCustomerSettingsV1, initOverrides?: RequestInit): Promise<ModelsCustomerConfigurationsV1> {
     ...
     */
    async deleteAWSAccountsRaw(requestParameters: DeleteAWSAccountsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelsBaseResponseV1>> {
     ...
     * Delete a set of AWS Accounts by specifying their IDs
     */
    async deleteAWSAccounts(ids: Array<string>, initOverrides?: RequestInit): Promise<ModelsBaseResponseV1> {
     ...
     */
    async getAWSAccountsRaw(requestParameters: GetAWSAccountsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelsAWSAccountsV1>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Retrieve a set of AWS Accounts by specifying their IDs
     */
    async getAWSAccounts(ids: Array<string>, initOverrides?: RequestInit): Promise<ModelsAWSAccountsV1> {
     ...
     */
    async getAWSSettingsRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelsCustomerConfigurationsV1>> {
        const queryParameters: any = {};
     ...
     * Retrieve a set of Global Settings which are applicable to all provisioned AWS accounts
     */
    async getAWSSettings(initOverrides?: RequestInit): Promise<ModelsCustomerConfigurationsV1> {
     ...
     */
    async provisionAWSAccountsRaw(requestParameters: ProvisionAWSAccountsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelsAWSAccountsV1>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * Provision AWS Accounts by specifying details about the accounts to provision
     */
    async provisionAWSAccounts(body: ModelsCreateAWSAccountsV1, mode?: ProvisionAWSAccountsModeEnum, initOverrides?: RequestInit): Promise<ModelsAWSAccountsV1> {
     ...
     */
    async queryAWSAccountsRaw(requestParameters: QueryAWSAccountsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelsAWSAccountsV1>> {
        const queryParameters: any = {};
     ...
     * Search for provisioned AWS Accounts by providing an FQL filter and paging details. Returns a set of AWS accounts which match the filter criteria
     */
    async queryAWSAccounts(limit?: number, offset?: number, sort?: string, filter?: string, initOverrides?: RequestInit): Promise<ModelsAWSAccountsV1> {
     ...
     */
    async queryAWSAccountsForIDsRaw(requestParameters: QueryAWSAccountsForIDsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MsaQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Search for provisioned AWS Accounts by providing an FQL filter and paging details. Returns a set of AWS account IDs which match the filter criteria
     */
    async queryAWSAccountsForIDs(limit?: number, offset?: number, sort?: string, filter?: string, initOverrides?: RequestInit): Promise<MsaQueryResponse> {
     ...
     */
    async updateAWSAccountsRaw(requestParameters: UpdateAWSAccountsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelsAWSAccountsV1>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * Update AWS Accounts by specifying the ID of the account and details to update
     */
    async updateAWSAccounts(body: ModelsUpdateAWSAccountsV1, initOverrides?: RequestInit): Promise<ModelsAWSAccountsV1> {
     ...
     */
    async verifyAWSAccountAccessRaw(requestParameters: VerifyAWSAccountAccessRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelsVerifyAccessResponseV1>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Performs an Access Verification check on the specified AWS Account IDs
     */
    async verifyAWSAccountAccess(ids: Array<string>, initOverrides?: RequestInit): Promise<ModelsVerifyAccessResponseV1> {
