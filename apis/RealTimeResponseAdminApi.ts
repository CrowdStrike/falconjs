...
export class RealTimeResponseAdminApi extends runtime.BaseAPI {
     ...
     * Upload a new custom-script to use for the RTR `runscript` command.
     */
    async rTRCreateScripts(description: string, permissionType: string, file?: Blob, name?: string, commentsForAuditLog?: string, content?: string, platform?: Array<string>, initOverrides?: RequestInit): Promise<MsaReplyMetaOnly> {
     ...
     * Upload a new scripts to replace an existing one.
     */
    async rTRUpdateScripts(id: string, file?: Blob, description?: string, name?: string, commentsForAuditLog?: string, permissionType?: string, content?: string, platform?: Array<string>, initOverrides?: RequestInit): Promise<MsaReplyMetaOnly> {
