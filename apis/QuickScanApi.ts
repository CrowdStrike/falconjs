...
export class QuickScanApi extends runtime.BaseAPI {
     ...
     */
    async getScansRaw(requestParameters: GetScansRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MlscannerScanV1Response>> {
     ...
     * Check the status of a volume scan. Time required for analysis increases with the number of samples in a volume but usually it should take less than 1 minute
     */
    async getScans(ids: Array<string>, initOverrides?: RequestInit): Promise<MlscannerScanV1Response> {
     ...
     */
    async getScansAggregatesRaw(requestParameters: GetScansAggregatesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Get scans aggregations as specified via json in request body.
     */
    async getScansAggregates(body: MsaAggregateQueryRequest, initOverrides?: RequestInit): Promise<void> {
     ...
     */
    async querySubmissionsMixin0Raw(requestParameters: QuerySubmissionsMixin0Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MlscannerQueryResponse>> {
        const queryParameters: any = {};
     ...
     * Find IDs for submitted scans by providing an FQL filter and paging details. Returns a set of volume IDs that match your criteria.
     */
    async querySubmissionsMixin0(filter?: string, offset?: string, limit?: number, sort?: string, initOverrides?: RequestInit): Promise<MlscannerQueryResponse> {
     ...
     */
    async scanSamplesRaw(requestParameters: ScanSamplesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MlscannerQueryResponse>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * Submit a volume of files for ml scanning. Time required for analysis increases with the number of samples in a volume but usually it should take less than 1 minute
     */
    async scanSamples(body: MlscannerSamplesScanParameters, initOverrides?: RequestInit): Promise<MlscannerQueryResponse> {
